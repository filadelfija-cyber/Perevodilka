var app = function() {
	...
	function mount_component(e, t, n, r) {
		...
		o && o.m(t, n), r || add_render_callback((() => {
			const t = i.map(run).filter(is_function);
	...
	function make_dirty(e, t) {
		-1 === e.$$.dirty[0] && (dirty_components.push(e), schedule_update(), e.$$.dirty.fill(0)), e.$$.dirty[t / 31 | 0] |= 1 << t % 31
	}

	function init(e, t, n, r, o, i, a, s = [-1]) {
		...
		a && a(c.root);
		let l = !1;
		if (c.ctx = n ? n(e, t.props || {}, ((t, n, ...r) => {
				const i = r.length ? r[0] : n;
				return c.ctx && o(c.ctx[t], c.ctx[t] = i) && (!c.skip_bound && c.bound[t] && c.bound[t](i), l && make_dirty(e, t)), n
			})) : [], c.update(), l = !0, run_all(c.before_update), c.fragment = !!r && r(c.ctx), t.target) {
			if (t.hydrate) {
	...
	const backends = {},
		...
		registerBackend = (e, t, n) => {
			if (!t || "function" != typeof t.init || "function" != typeof t.createSessionHandler) throw new TypeError("not a valid backend");
			{
				...
				for (let t = 0; t < backendsSortedByPriority.length; t++)
					if (backends[backendsSortedByPriority[t]].priority <= n) return void backendsSortedByPriority.splice(t, 0, e);
				backendsSortedByPriority.push(e)
			}
		},
		resolveBackend = async e => {
			const t = 0 === e.length ? backendsSortedByPriority : e,
				n = [];
			for (const e of t) {
				const t = backends[e];
				if (t) {
					if (t.initialized) return t.backend;
					if (t.initializing) throw new Error(`backend "${e}" is being initialized; cannot initialize multiple times.`);
					if (t.aborted) continue;
					try {
						return t.initializing = !0, await t.backend.init(), t.initialized = !0, t.backend
					} catch (r) {
						n.push({
							name: e,
							err: r
	...
	const env = new EnvImpl,
		isBigInt64ArrayAvailable = "undefined" != typeof BigInt64Array && "function" == typeof BigInt64Array.from,
		isBigUint64ArrayAvailable = "undefined" != typeof BigUint64Array && "function" == typeof BigUint64Array.from,
	...
	isBigInt64ArrayAvailable && (NUMERIC_TENSOR_TYPE_TO_TYPEDARRAY_MAP.set("int64", BigInt64Array), NUMERIC_TENSOR_TYPEDARRAY_TO_TYPE_MAP.set(BigInt64Array, "int64")), isBigUint64ArrayAvailable && (NUMERIC_TENSOR_TYPE_TO_TYPEDARRAY_MAP.set("uint64", BigUint64Array), NUMERIC_TENSOR_TYPEDARRAY_TO_TYPE_MAP.set(BigUint64Array, "uint64"));
		...
		constructor(e, t, n) {
			...
			if ("string" == typeof e)
				if (r = e, i = n, "string" === e) {
					...
					const n = NUMERIC_TENSOR_TYPE_TO_TYPEDARRAY_MAP.get(e);
					if (void 0 === n) throw new TypeError(`Unsupported tensor type: ${e}.`);
					if (Array.isArray(t)) o = n.from(t);
					else {
						if (!(t instanceof n)) throw new TypeError(`A ${r} tensor's data must be type of ${n}`);
						o = t
					}
				}
			else if (i = t, Array.isArray(e)) {
				if (0 === e.length) throw new TypeError("Tensor type cannot be inferred from an empty array.");
				const t = typeof e[0];
				if ("string" === t) r = "string", o = e;
				else {
					if ("boolean" !== t) throw new TypeError(`Invalid element type of data array: ${t}.`);
					r = "bool", o = Uint8Array.from(e)
				}
			} else {
				const t = NUMERIC_TENSOR_TYPEDARRAY_TO_TYPE_MAP.get(e.constructor);
				if (void 0 === t) throw new TypeError(`Unsupported type for tensor data: ${e.constructor}.`);
				r = t, o = e
			}
			if (void 0 === i) i = [o.length];
			else if (!Array.isArray(i)) throw new TypeError("A tensor's dims must be a number array");
			const a = calculateSize(i);
			if (a !== o.length) throw new Error(`Tensor's size(${a}) does not match data length(${o.length}).`);
			this.dims = i, this.type = r, this.data = o, this.size = a
		}
		reshape(e) {
			return new Tensor$1(this.type, this.data, e)
		}
	}
	...
	class InferenceSession$1 {
		...
		async run(e, t, n) {
			const r = {};
			let o = {};
			if ("object" != typeof e || null === e || e instanceof Tensor || Array.isArray(e)) throw new TypeError("'feeds' must be an object that use input names as keys and OnnxValue as corresponding values.");
			let i = !0;
			if ("object" == typeof t) {
				if (null === t) throw new TypeError("Unexpected argument[1]: cannot be null.");
				if (t instanceof Tensor) throw new TypeError("'fetches' cannot be a Tensor");
				if (Array.isArray(t)) {
					...
					else if (void 0 !== n) throw new TypeError("'options' must be an object.")
				} else {
					let e = !1;
					...
					for (const n of this.outputNames)
						if (-1 !== a.indexOf(n)) {
							const o = t[n];
							(null === o || o instanceof Tensor) && (e = !0, i = !1, r[n] = o)
						} if (e) {
						if ("object" == typeof n && null !== n) o = n;
						else if (void 0 !== n) throw new TypeError("'options' must be an object.")
					} else o = t
			...
			for (const t of this.inputNames)
				if (void 0 === e[t]) throw new Error(`input '${t}' is missing in 'feeds'.`);
			if (i)
				for (const e of this.outputNames) r[e] = null;
			const a = await this.handler.run(e, r, o),
				s = {};
			for (const e in a) Object.hasOwnProperty.call(a, e) && (s[e] = new Tensor(a[e].type, a[e].data, a[e].dims));
			return s
		}
		static async create(e, t, n, r) {
			let o, i = {};
			if ("string" == typeof e) {
				if (o = e, "object" == typeof t && null !== t) i = t;
				...
				if (!(e instanceof ArrayBuffer || "undefined" != typeof SharedArrayBuffer && e instanceof SharedArrayBuffer)) throw new TypeError("Unexpected argument[0]: must be 'path' or 'buffer'.");
				{
					...
					let s = 0,
						u = e.byteLength;
					if ("object" == typeof t && null !== t) i = t;
					else if ("number" == typeof t) {
						if (s = t, !Number.isSafeInteger(s)) throw new RangeError("'byteOffset' must be an integer.");
						if (s < 0 || s >= a.byteLength) throw new RangeError(`'byteOffset' is out of range [0, ${a.byteLength}).`);
						if (u = e.byteLength - s, "number" == typeof n) {
							if (u = n, !Number.isSafeInteger(u)) throw new RangeError("'byteLength' must be an integer.");
							if (u <= 0 || s + u > a.byteLength) throw new RangeError(`'byteLength' is out of range (0, ${a.byteLength-s}].`);
							if ("object" == typeof r && null !== r) i = r;
							else if (void 0 !== r) throw new TypeError("'options' must be an object.")
						} else if (void 0 !== n) throw new TypeError("'byteLength' must be a number.")
					} else if (void 0 !== t) throw new TypeError("'options' must be an object.");
					o = new Uint8Array(a, s, u)
				}
			}
			const a = (i.executionProviders || []).map((e => "string" == typeof e ? e : e.name)),
				s = await resolveBackend(a),
				u = await s.createSessionHandler(o, i);
			return new InferenceSession$1(u)
		}
		startProfiling() {
	...
	var lib = Object.freeze({
		...
		ortWeb_min = createCommonjsModule((function(module, exports) {
			var t;
			self, t = function(__WEBPACK_EXTERNAL_MODULE__2174__) {
				return function() {
					var __webpack_modules__ = {
							3474: function(e, t, n) {
								var r, o = (r = (r = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0) || "/index.js", function(e) {
									function t() {
										return N.buffer != j && Z(N.buffer), U
									}

									function o() {
										return N.buffer != j && Z(N.buffer), B
									}

									function i() {
										return N.buffer != j && Z(N.buffer), V
									}

									function a() {
										return N.buffer != j && Z(N.buffer), z
									}

									function s() {
										return N.buffer != j && Z(N.buffer), G
									}
									var u, c, l;
									e = e || {}, u || (u = void 0 !== e ? e : {}), u.ready = new Promise((function(e, t) {
										c = e, l = t
									}));
									var f, p = {};
									for (f in u) u.hasOwnProperty(f) && (p[f] = u[f]);
									var d = "./this.program";

									function h(e, t) {
										throw t
									}
									var g, b, y, m, v, _ = "object" == typeof window,
										...
										T = u.ENVIRONMENT_IS_PTHREAD || !1,
										S = "";

									function O(e) {
										return u.locateFile ? u.locateFile(e, S) : S + e
									}
									if (x) {
										var A;
										S = w ? n(908).dirname(S) + "/" : "//", g = function(e, t) {
											return m || (m = n(1384)), v || (v = n(908)), e = v.normalize(e), m.readFileSync(e, t ? null : "utf8")
										}, y = function(e) {
											return (e = g(e, !0)).buffer || (e = new Uint8Array(e)), L(e.buffer), e
										}, b = function(e, t, r) {
											m || (m = n(1384)), v || (v = n(908)), e = v.normalize(e), m.readFile(e, (function(e, n) {
												e ? r(e) : t(n.buffer)
											}))
										}, 1 < process.argv.length && (d = process.argv[1].replace(/\\/g, "/")), process.argv.slice(2), process.on("uncaughtException", (function(e) {
											if (!(e instanceof Gt)) throw e
										})), process.on("unhandledRejection", le), h = function(e, t) {
											if (ie()) throw process.exitCode = e, t;
											process.exit(e)
										}, u.inspect = function() {
										...
										n.g.Worker = A.Worker
									} else(_ || w) && (w ? S = self.location.href : "undefined" != typeof document && document.currentScript && (S = document.currentScript.src), r && (S = r), S = 0 !== S.indexOf("blob:") ? S.substr(0, S.lastIndexOf("/") + 1) : "", x ? (g = function(e, t) {
										return m || (m = n(1384)), v || (v = n(908)), e = v.normalize(e), m.readFileSync(e, t ? null : "utf8")
									}, y = function(e) {
										return (e = g(e, !0)).buffer || (e = new Uint8Array(e)), L(e.buffer), e
									}, b = function(e, t, r) {
									...
									x && "undefined" == typeof performance && (n.g.performance = n(6953).performance);
									var E, I, P = u.print || console.log.bind(console),
										D = u.printErr || console.warn.bind(console);
									for (f in p) p.hasOwnProperty(f) && (u[f] = p[f]);
									p = null, u.thisProgram && (d = u.thisProgram), u.quit && (h = u.quit), u.wasmBinary && (I = u.wasmBinary);
									var k = u.noExitRuntime || !1;
									"object" != typeof WebAssembly && le("no native wasm support detected");
									var N, C, R, F = !1;

									function L(e, t) {
										e || le("Assertion failed: " + t)
									}
									...
									var j, U, B, V, z, G, H = "undefined" != typeof TextDecoder ? new M("utf8") : void 0;

									function W(e, t, n) {
										var r = t + n;
										for (n = t; e[n] && !(n >= r);) ++n;
										if (16 < n - t && e.subarray && H) return H.decode(e.subarray(t, n));
										for (r = ""; t < n;) {
											var o = e[t++];
											if (128 & o) {
												var i = 63 & e[t++];
												if (192 == (224 & o)) r += String.fromCharCode((31 & o) << 6 | i);
												else {
													var a = 63 & e[t++];
									...
									function $(e) {
										var n = K(e) + 1,
											r = yt(n);
										return r && Y(e, t(), r, n), r
									}

									function Z(e) {
										j = e, u.HEAP8 = U = new Int8Array(e), u.HEAP16 = new Int16Array(e), u.HEAP32 = V = new Int32Array(e), u.HEAPU8 = B = new Uint8Array(e), u.HEAPU16 = new Uint16Array(e), u.HEAPU32 = z = new Uint32Array(e), u.HEAPF32 = new Float32Array(e), u.HEAPF64 = G = new Float64Array(e)
									}
									"undefined" != typeof TextDecoder && new M("utf-16le"), T && (j = u.buffer);
									var J = u.INITIAL_MEMORY || 16777216;
									if (T) N = u.wasmMemory, j = u.buffer;
									else if (u.wasmMemory) N = u.wasmMemory;
									...
									N && (j = N.buffer), J = j.byteLength, Z(j);
									var Q, ee = [],
										te = [],
										ne = [],
										re = [],
									...
									function le(e) {
										throw u.onAbort && u.onAbort(e), L(!T), D(e), F = !0, R = 1, e = new WebAssembly.RuntimeError("abort(" + e + "). Build with -s ASSERTIONS=1 for more info."), l(e), e
									}
									...
									function pe() {
										var e = se;
										try {
											if (e == se && I) return new Uint8Array(I);
											if (y) return y(e);
									...
									u.preloadedImages = {}, u.preloadedAudios = {}, se = "ort-wasm-threaded.wasm", fe() || (se = O(se));
									var de = {
										973748: function() {
											throw "Canceled!"
										}
									...
									function he(e) {
										for (; 0 < e.length;) {
											var t = e.shift();
											if ("function" == typeof t) t(u);
											else {
												var n = t.Nb;
												"number" == typeof n ? void 0 === t.ib ? Q.get(n)() : Q.get(n)(t.ib) : n(void 0 === t.ib ? null : t.ib)
											}
										}
									}

									function ge(e, n) {
										if (0 >= e || e > t().length || 1 & e || 0 > n) return -28;
										if (0 == n) return 0;
										2147483647 <= n && (n = 1 / 0);
										var r = Atomics.load(i(), zt >> 2),
											o = 0;
										if (r == e && Atomics.compareExchange(i(), zt >> 2, r, 0) == r && (o = 1, 0 >= --n)) return 1;
										if (0 <= (e = Atomics.notify(i(), e >> 2, n))) return e + o;
										throw "Atomics.notify returned an unexpected value " + e
									}

									function be(e) {
										if (T) throw "Internal Error! cleanupThread() can only ever be called from main application thread!";
										if (!e) throw "Internal Error! Null pthread_ptr in cleanupThread!";
										var t = me.cb[e];
										t && (i()[e + 12 >> 2] = 0, me.sb(t.worker))
									}
									u._emscripten_futex_wake = ge;
									var ye, me = {
										gb: [],
										fb: [],
										zb: [],
										xc: function() {},
										Rb: function() {
											for (var e = yt(228), t = 0; 57 > t; ++t) a()[e / 4 + t] = 0;
											i()[e + 12 >> 2] = e, t = e + 152, i()[t >> 2] = t;
											var n = yt(512);
											for (t = 0; 128 > t; ++t) a()[n / 4 + t] = 0;
											Atomics.store(a(), e + 100 >> 2, n), Atomics.store(a(), e + 40 >> 2, e), Dt(e, !w, 1), xt(e)
										},
										Sb: function() {
											me.receiveObjectTransfer = me.Xb, me.threadInit = me.hc, me.threadCancel = me.fc, me.threadExit = me.Hb, me.setExitStatus = me.Zb
										},
										cb: {},
										yb: [],
										Eb: function() {
											for (; 0 < me.yb.length;) me.yb.pop()();
											Nt()
										},
										Fb: function(e, t) {
											Atomics.store(a(), e + 56 >> 2, 1), Atomics.store(a(), e + 60 >> 2, 0), me.Eb(), Atomics.store(a(), e + 4 >> 2, t), Atomics.store(a(), e + 0 >> 2, 1), ge(e + 0, 2147483647), Dt(0, 0, 0)
										},
										Zb: function(e) {
											R = e
										},
										Hb: function(e) {
											var t = _t();
											t && (me.Fb(t, e), T && postMessage({
												cmd: "exit"
											}))
										},
										fc: function() {
											me.Fb(_t(), -1), postMessage({
												cmd: "cancelDone"
											})
										},
										Gb: function() {
											for (var e in me.cb) {
												var t = me.cb[e];
												t && t.worker && me.sb(t.worker)
											}
											for (me.cb = {}, e = 0; e < me.gb.length; ++e) {
												var n = me.gb[e];
												n.terminate()
											}
											for (me.gb = [], e = 0; e < me.fb.length; ++e) t = (n = me.fb[e]).bb, me.xb(t), n.terminate();
											me.fb = []
										},
										xb: function(e) {
											if (e) {
												if (e.eb) {
													var t = i()[e.eb + 100 >> 2];
													i()[e.eb + 100 >> 2] = 0, vt(t), vt(e.eb)
												}
												e.eb = 0, e.wb && e.hb && vt(e.hb), e.hb = 0, e.worker && (e.worker.bb = null)
											}
										},
										sb: function(e) {
											me.Yb((function() {
												delete me.cb[e.bb.eb], me.gb.push(e), me.fb.splice(me.fb.indexOf(e), 1), me.xb(e.bb), e.bb = void 0
											}))
										},
										Yb: function(e) {
											i()[Vt >> 2] = 0;
										...
										Xb: function() {},
										hc: function() {
											for (var e in me.zb) me.zb[e]()
										},
										Ub: function(e, t) {
											e.onmessage = function(n) {
												var r = n.data,
													o = r.cmd;
												if (e.bb && (me.Lb = e.bb.eb), r.targetThread && r.targetThread != _t()) {
													var s = me.cb[r.Dc];
													s ? s.worker.postMessage(n.data, r.transferList) : D('Internal error! Worker sent a message "' + o + '" to target pthread ' + r.targetThread + ", but that thread no longer exists!")
												} else if ("processQueuedMainThreadWork" === o) Ot();
												else if ("spawnThread" === o) xe(n.data);
												else if ("cleanupThread" === o) be(r.thread);
												else if ("killThread" === o) {
													if (n = r.thread, T) throw "Internal Error! killThread() can only ever be called from main application thread!";
													if (!n) throw "Internal Error! Null pthread_ptr in killThread!";
													i()[n + 12 >> 2] = 0, r = me.cb[n], delete me.cb[n], r.worker.terminate(), me.xb(r), me.fb.splice(me.fb.indexOf(r.worker), 1), r.worker.bb = void 0
												} else if ("cancelThread" === o) {
													if (n = r.thread, T) throw "Internal Error! cancelThread() can only ever be called from main application thread!";
													if (!n) throw "Internal Error! Null pthread_ptr in cancelThread!";
													me.cb[n].worker.postMessage({
														cmd: "cancel"
													})
												} else if ("loaded" === o) e.loaded = !0, t && t(e), e.mb && (e.mb(), delete e.mb);
												else if ("print" === o) P("Thread " + r.threadId + ": " + r.text);
												else if ("printErr" === o) D("Thread " + r.threadId + ": " + r.text);
												else if ("alert" === o) alert("Thread " + r.threadId + ": " + r.text);
												else if ("exit" === o) e.bb && Atomics.load(a(), e.bb.eb + 64 >> 2) && me.sb(e);
												else if ("exitProcess" === o) try {
													Wt(r.returnCode)
												} catch (e) {
													if (e instanceof Gt) return;
													throw e
												} else "cancelDone" === o ? me.sb(e) : "objectTransfer" !== o && ("setimmediate" === n.data.target ? e.postMessage(n.data) : D("worker sent an unknown command " + o));
												me.Lb = void 0
											}, e.onerror = function(e) {
												D("pthread sent an error! " + e.filename + ":" + e.lineno + ": " + e.message)
											}, x && (e.on("message", (function(t) {
												e.onmessage({
													data: t
												})
										...
										Ib: function() {
											...
											me.gb.push(new Worker(e))
										},
										Ob: function() {
											return 0 == me.gb.length && (me.Ib(), me.Ub(me.gb[0])), me.gb.pop()
										},
										nc: function(e) {
									...
									function we(e) {
										this.lb = e - 16, this.dc = function(e) {
											i()[this.lb + 4 >> 2] = e
										}, this.ac = function(e) {
											i()[this.lb + 8 >> 2] = e
										}, this.bc = function() {
											...
											this.dc(e), this.ac(t), this.bc(), this.$b(), this.cc()
										}
									}

									function xe(e) {
										if (T) throw "Internal Error! spawnThread() can only ever be called from main application thread!";
										var t = me.Ob();
										if (!t) return 6;
										if (void 0 !== t.bb) throw "Internal error!";
										if (!e.rb) throw "Internal error, no pthread ptr!";
										me.fb.push(t);
										for (var n = yt(512), r = 0; 128 > r; ++r) i()[n + 4 * r >> 2] = 0;
										var o = e.hb + e.jb,
											s = (r = me.cb[e.rb] = {
												worker: t,
												hb: e.hb,
										...
										Atomics.store(a(), s + 16, e.detached), Atomics.store(a(), s + 25, n), Atomics.store(a(), s + 10, r.eb), Atomics.store(a(), s + 20, e.jb), Atomics.store(a(), s + 19, o), Atomics.store(a(), s + 26, e.jb), Atomics.store(a(), s + 28, o), Atomics.store(a(), s + 29, e.detached), n = kt() + 40, Atomics.store(a(), s + 43, n), t.bb = r;
										var u = {
											cmd: "run",
											start_routine: e.ec,
											arg: e.ib,
											threadInfoStruct: e.rb,
											stackBase: e.hb,
											stackSize: e.jb
										};
										return t.mb = function() {
											u.time = performance.now(), t.postMessage(u, e.mc)
										}, t.loaded && (t.mb(), delete t.mb), 0
									}

									function Te(e, n, r) {
										if (0 >= e || e > t().length || 1 & e) return -28;
										if (_) {
											if (Atomics.load(i(), e >> 2) != n) return -6;
											var o = performance.now();
											for (r = o + r, Atomics.exchange(i(), zt >> 2, e);;) {
												if ((o = performance.now()) > r) return Atomics.exchange(i(), zt >> 2, 0), -73;
												if (0 == (o = Atomics.exchange(i(), zt >> 2, 0))) break;
												if (Ot(), Atomics.load(i(), e >> 2) != n) return -6;
												Atomics.exchange(i(), zt >> 2, e)
											}
											return 0
										}
										if ("timed-out" === (e = Atomics.wait(i(), e >> 2, n, r))) return -73;
									...
									function Se() {
										x || w || (E || (E = {}), E["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] || (E["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] = 1, D("Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread")))
									}
									...
									function Ee(e, t) {
										var n = Ae[e];
										0 === t || 10 === t ? ((1 === e ? P : D)(W(n, 0)), n.length = 0) : n.push(t)
									}
									var Ie = {};

									function Pe(e, t) {
										return T ? We(2, 1, e, t) : (e = q(e), Ie.rc(e, t))
									}

									function De(e, t, n) {
										return T ? We(3, 1, e, t, n) : 0
									}

									function ke(e, t) {
										if (T) return We(4, 1, e, t)
									}

									function Ne(e, t, n) {
										if (T) return We(5, 1, e, t, n)
									}

									function Ce(e, t, n) {
										return T ? We(6, 1, e, t, n) : 0
									}

									function Re(e, t) {
										if (T) return We(7, 1, e, t)
									}

									function Fe(e, t) {
										return T ? We(8, 1, e, t) : (e = q(e), Ie.sc(e, t))
									}

									function Le(e, t, n, r, i, a) {
										if (T) t = We(9, 1, e, t, n, r, i, a);
										else if (a <<= 12, 0 != (16 & r) && 0 != e % 65536) t = -28;
										else if (0 != (32 & r)) {
											var s = 65536 * Math.ceil(t / 65536);
											(e = Bt(65536, s)) ? o().fill(0, e, e + s): e = 0, e ? (Oe[e] = {
												Wb: e,
												Tb: t,
												Jb: !0,
												fd: i,
									...
									function Me(e, t) {
										if (T) e = We(10, 1, e, t);
											...
											var n = Oe[e];
											0 !== t && n ? (t === n.Tb && (Oe[e] = null, n.Jb && vt(n.Wb)), e = 0) : e = -28
										}
										return e
									}

									function je(e, t, n) {
										if (T) return We(11, 1, e, t, n)
									}

									function Ue(e, t, n) {
										return T ? We(12, 1, e, t, n) : (e = q(e), Ie.tc(e, t, n))
									}

									function Be(e) {
										if (T) return We(13, 1, e)
									}

									function Ve(e, t) {
										if (T) return We(14, 1, e, t)
									}

									function ze(e) {
										if (T) return We(15, 1, e)
									}
									...
									function We(e, t) {
										for (var n = arguments.length - 2, r = Lt(), o = jt(8 * n), i = o >> 3, a = 0; a < n; a++) {
											var u = arguments[2 + a];
											s()[i + a] = u
										}
										return n = At(e, n, o, t), Mt(r), n
									}
									var qe = [],
										Ye = [0, "undefined" != typeof document ? document : 0, "undefined" != typeof window ? window : 0];

									function Xe(e) {
										return e = 2 < e ? q(e) : e, Ye[e] || ("undefined" != typeof document ? document.querySelector(e) : void 0)
									}

									function Ke(e, t, n) {
										var r = Xe(e);
										if (!r) return -4;
										if (r.qb && (i()[r.qb >> 2] = t, i()[r.qb + 4 >> 2] = n), !r.Db && r.pc) {
											if (r.qb) {
												r = i()[r.qb + 8 >> 2], e = e ? q(e) : "";
												var o = Lt(),
													a = jt(12),
													s = 0;
												if (e) {
												...
												return i()[a >> 2] = s, i()[a + 4 >> 2] = t, i()[a + 8 >> 2] = n, Et(0, r, 657457152, 0, s, a), Mt(o), 1
											}
											return -4
										}
										return r.Db && (r = r.Db), e = !1, r.pb && r.pb.ob && (e = 0 === (e = r.pb.ob.getParameter(2978))[0] && 0 === e[1] && e[2] === r.width && e[3] === r.height), r.width = t, r.height = n, e && r.pb.ob.viewport(0, 0, t, n), 0
									}

									function $e(e, t, n) {
										return T ? We(17, 1, e, t, n) : Ke(e, t, n)
									}
									var Ze, Je = ["default", "low-power", "high-performance"],
										Qe = {};
									...
									function et() {
										if (!Ze) {
											...
											for (e in Qe) void 0 === Qe[e] ? delete t[e] : t[e] = Qe[e];
											var n = [];
									...
									function tt(e, n) {
										if (T) return We(18, 1, e, n);
										var r = 0;
										return et().forEach((function(o, a) {
											var s = n + r;
											for (a = i()[e + 4 * a >> 2] = s, s = 0; s < o.length; ++s) t()[a++ >> 0] = o.charCodeAt(s);
											t()[a >> 0] = 0, r += o.length + 1
										})), 0
									}

									function nt(e, t) {
										if (T) return We(19, 1, e, t);
										var n = et();
										i()[e >> 2] = n.length;
										var r = 0;
									...
									function rt(e) {
										return T ? We(20, 1, e) : 0
									}

									function ot(e, n) {
										return T ? We(21, 1, e, n) : (e = 1 == e || 2 == e ? 2 : le(), t()[n >> 0] = e, 0)
									}

									function it(e, t, n, r) {
										return T ? We(22, 1, e, t, n, r) : (e = Ie.vc(e), t = Ie.uc(e, t, n), i()[r >> 2] = t, 0)
									}

									function at(e, t, n, r, o) {
										if (T) return We(23, 1, e, t, n, r, o)
									}

									function st(e, t, n, r) {
										if (T) return We(24, 1, e, t, n, r);
										for (var a = 0, s = 0; s < n; s++) {
											for (var u = i()[t + 8 * s >> 2], c = i()[t + (8 * s + 4) >> 2], l = 0; l < c; l++) Ee(e, o()[u + l]);
											a += c
										}
										return i()[r >> 2] = a, 0
									}
									...
									function ut() {
										...
										if (!ut.Kb) {
											...
											var o = r.getTimezoneOffset(),
												a = Math.max(t, o);
											i()[Ft() >> 2] = 60 * a, i()[Rt() >> 2] = Number(t != o), n = e(n), r = e(r), n = $(n), r = $(r), o < t ? (i()[Ct() >> 2] = n, i()[Ct() + 4 >> 2] = r) : (i()[Ct() >> 2] = r, i()[Ct() + 4 >> 2] = n)
										}
									}
									...
									var ft = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
										pt = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];

									function dt(e, t) {
										for (e = new Date(e.getTime()); 0 < t;) {
											var n = e.getMonth(),
												r = (ct(e.getFullYear()) ? ft : pt)[n];
											if (!(t > r - e.getDate())) {
									...
									function ht(e, n, r, o) {
										...
										function l(e) {
											e = dt(new Date(e.ab + 1900, 0, 1), e.vb);
											var t = new Date(e.getFullYear() + 1, 0, 4),
												n = c(new Date(e.getFullYear(), 0, 4));
											return t = c(t), 0 >= u(n, e) ? 0 >= u(t, e) ? e.getFullYear() + 1 : e.getFullYear() : e.getFullYear() - 1
										}
										var f = i()[o + 40 >> 2];
										for (var p in o = {
												kc: i()[o >> 2],
										...
										for (p in f = {
												...
												"%I": function(e) {
													return 0 == (e = e.tb) ? e = 12 : 12 < e && (e -= 12), s(e, 2)
												},
												"%j": function(e) {
													return s(e.nb + lt(ct(e.ab + 1900) ? ft : pt, e.kb - 1), 3)
												},
												"%m": function(e) {
													return s(e.kb + 1, 2)
												},
												...
												"%U": function(e) {
													var t = new Date(e.ab + 1900, 0, 1),
														n = 0 === t.getDay() ? t : dt(t, 7 - t.getDay());
													return 0 > u(n, e = new Date(e.ab + 1900, e.kb, e.nb)) ? s(Math.ceil((31 - n.getDate() + (lt(ct(e.getFullYear()) ? ft : pt, e.getMonth() - 1) - 31) + e.getDate()) / 7), 2) : 0 === u(n, t) ? "01" : "00"
												},
												"%V": function(e) {
													var t = new Date(e.ab + 1901, 0, 4),
														n = c(new Date(e.ab + 1900, 0, 4));
													t = c(t);
													var r = dt(new Date(e.ab + 1900, 0, 1), e.vb);
													return 0 > u(r, n) ? "53" : 0 >= u(t, r) ? "01" : s(Math.ceil((n.getFullYear() < e.ab + 1900 ? e.vb + 32 - n.getDate() : e.vb + 1 - n.getDate()) / 7), 2)
												},
												"%w": function(e) {
													return e.ub
												},
												"%W": function(e) {
													var t = new Date(e.ab, 0, 1),
														n = 1 === t.getDay() ? t : dt(t, 0 === t.getDay() ? 1 : 7 - t.getDay() + 1);
													return 0 > u(n, e = new Date(e.ab + 1900, e.kb, e.nb)) ? s(Math.ceil((31 - n.getDate() + (lt(ct(e.getFullYear()) ? ft : pt, e.getMonth() - 1) - 31) + e.getDate()) / 7), 2) : 0 === u(n, t) ? "01" : "00"
												},
												"%y": function(e) {
													return (e.ab + 1900).toString().substring(2)
												},
												"%Y": function(e) {
													return e.ab + 1900
												},
											...
											}) r.includes(p) && (r = r.replace(new RegExp(p, "g"), f[p](o)));
										return (p = function(e) {
											var t = Array(K(e) + 1);
											return Y(e, t, 0, t.length), t
										}(r)).length > n ? 0 : (function(e, n) {
											t().set(e, n)
										}(p, e), p.length - 1)
									}
									var gt = [null, _e, Pe, De, ke, Ne, Ce, Re, Fe, Le, Me, je, Ue, Be, Ve, ze, Ge, $e, tt, nt, rt, ot, it, at, st, ut],
										bt = {
											h: function(e, t, n, r) {
												le("Assertion failed: " + q(e) + ", at: " + [t ? q(t) : "unknown filename", n, r ? q(r) : "unknown function"])
											},
											M: function(e, t) {
												return ve(e, t)
											},
											...
											Z: function(e, t, n, r) {
												...
												var o = [];
												if (T && 0 === o.length) return St(687865856, e, t, n, r);
												var s = 0,
													u = 0;
												if (t && -1 != t) {
													var c = i()[t >> 2];
													c += 81920, s = i()[t + 8 >> 2], u = 0 !== i()[t + 12 >> 2]
												} else c = 2097152;
												(t = 0 == s) ? s = Bt(16, c): L(0 < (s -= c));
												for (var l = yt(228), f = 0; 57 > f; ++f) a()[(l >> 2) + f] = 0;
												return i()[e >> 2] = l, i()[l + 12 >> 2] = l, e = l + 152, i()[e >> 2] = e, n = {
													hb: s,
													jb: c,
													wb: t,
													detached: u,
													...
													ib: r,
													mc: o
												}, T ? (n.oc = "spawnThread", postMessage(n, o), 0) : xe(n)
											},
											X: function(e) {
												throw T ? me.Hb(e) : (me.Eb(), Wt(e)), "unwind"
											},
											Y: function(e, t) {
												return function(e, t) {
													if (!e) return D("pthread_join attempted on a null thread pointer!"), 71;
													if (T && _t() == e) return D("PThread " + e + " is attempting to join to itself!"), 16;
													if (!T && Tt() == e) return D("Main thread " + e + " is attempting to join to itself!"), 16;
													if (i()[e + 12 >> 2] !== e) return D("pthread_join attempted on thread " + e + ", which does not point to a valid thread, or does not exist anymore!"), 71;
													if (Atomics.load(a(), e + 64 >> 2)) return D("Attempted to join thread " + e + ", which was already detached!"), 28;
													for (Se();;) {
														var n = Atomics.load(a(), e + 0 >> 2);
														if (1 == n) return n = Atomics.load(a(), e + 4 >> 2), t && (i()[t >> 2] = n), Atomics.store(a(), e + 64 >> 2, 1), T ? postMessage({
															cmd: "cleanupThread",
															thread: e
														}) : be(e), 0;
														It(), T || Ot(), Te(e + 0, n, T ? 100 : 1)
													}
												}(e, t)
											},
											L: Pe,
											...
											da: function(e, t) {
												if (e == t) postMessage({
													...
													if (!(e = (e = me.cb[e]) && e.worker)) return;
													e.postMessage({
														cmd: "processThreadQueue"
													})
												}
											...
											A: function() {
												le("To use dlopen, you need to use Emscripten's linking support, see https://github.com/emscripten-core/emscripten/wiki/Linking")
											},
											l: function() {
												le("To use dlopen, you need to use Emscripten's linking support, see https://github.com/emscripten-core/emscripten/wiki/Linking")
											},
											...
											ea: function(e, t, n) {
												var r;
												for (He.length = 0, n >>= 2; r = o()[t++];)(r = 105 > r) && 1 & n && n++, He.push(r ? s()[n++ >> 1] : i()[n]), ++n;
												return de[e].apply(null, He)
											},
											G: Se,
											n: function() {},
											k: Te,
											...
											o: function() {
												return x ? n(3993).cpus().length : navigator.hardwareConcurrency
											},
											aa: function(e, t, n) {
												qe.length = t, n >>= 3;
												for (var r = 0; r < t; r++) qe[r] = s()[n + r];
												return (0 > e ? de[-e - 1] : gt[e]).apply(null, qe)
											},
											E: function(e) {
												var t = o().length;
												...
												for (var n = 1; 4 >= n; n *= 2) {
													...
													e: {
														try {
															N.grow(Math.min(2147483648, r) - j.byteLength + 65535 >>> 16), Z(N.buffer);
															var i = 1;
															break e
														} catch (e) {}
														i = void 0
											...
											ba: function(e, t, n) {
												return Xe(e) ? Ke(e, t, n) : $e(e, t, n)
											},
											x: function() {},
											$: function(e, t, n) {
												return oe += 1, setTimeout((function() {
													--oe,
													function(e) {
														if (!F) {
															try {
																...
																if (e instanceof Gt) return;
																if ("unwind" !== e) throw e && "object" == typeof e && e.stack && D("exception thrown: " + [e, e.stack]), e
															}
															if (!ie()) try {
																T ? Pt(R) : Wt(R)
															} catch (e) {
											...
											ca: function(e, t) {
												...
												return t = {
													...
													Bc: i()[t + 12],
													Cc: i()[t + 13]
												}, !(e = Xe(e)) || t.Mb ? 0 : function(e, t) {
													e.Cb || (e.Cb = e.getContext, e.getContext = function(t, n) {
														return "webgl" == t == (n = e.Cb(t, n)) instanceof WebGLRenderingContext ? n : null
													});
													...
													return n ? function(e, t) {
														...
														return e.canvas && (e.canvas.pb = r), (void 0 === t.Bb || t.Bb) && function(e) {
															if (e || (e = void 0), !e.Qb) {
																e.Qb = !0;
																var t = e.ob;
																! function(e) {
																	...
																	}, e.drawElementsInstanced = function(e, n, r, o, i) {
																		t.drawElementsInstancedANGLE(e, n, r, o, i)
																	})
																}(t),
																function(e) {
																...
																}(t), t.qc = t.getExtension("EXT_disjoint_timer_query"), t.zc = t.getExtension("WEBGL_multi_draw"), (t.getSupportedExtensions() || []).forEach((function(e) {
											...
											ha: function e(t, n) {
												return t = new Date(1e3 * i()[t >> 2]), i()[n >> 2] = t.getUTCSeconds(), i()[n + 4 >> 2] = t.getUTCMinutes(), i()[n + 8 >> 2] = t.getUTCHours(), i()[n + 12 >> 2] = t.getUTCDate(), i()[n + 16 >> 2] = t.getUTCMonth(), i()[n + 20 >> 2] = t.getUTCFullYear() - 1900, i()[n + 24 >> 2] = t.getUTCDay(), i()[n + 36 >> 2] = 0, i()[n + 32 >> 2] = 0, t = (t.getTime() - Date.UTC(t.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5 | 0, i()[n + 28 >> 2] = t, e.Ab || (e.Ab = $("GMT")), i()[n + 40 >> 2] = e.Ab, n
											},
											_: function() {
												me.Rb()
											},
											r: function(e, t) {
												ut(), e = new Date(1e3 * i()[e >> 2]), i()[t >> 2] = e.getSeconds(), i()[t + 4 >> 2] = e.getMinutes(), i()[t + 8 >> 2] = e.getHours(), i()[t + 12 >> 2] = e.getDate(), i()[t + 16 >> 2] = e.getMonth(), i()[t + 20 >> 2] = e.getFullYear() - 1900, i()[t + 24 >> 2] = e.getDay();
												var n = new Date(e.getFullYear(), 0, 1),
													r = (e.getTime() - n.getTime()) / 864e5 | 0;
												return i()[t + 28 >> 2] = r, i()[t + 36 >> 2] = -60 * e.getTimezoneOffset(), r = new Date(e.getFullYear(), 6, 1).getTimezoneOffset(), e = 0 | (r != (n = n.getTimezoneOffset()) && e.getTimezoneOffset() == Math.min(n, r)), i()[t + 32 >> 2] = e, e = i()[Ct() + (e ? 4 : 0) >> 2], i()[t + 40 >> 2] = e, t
											},
											a: N || u.wasmMemory,
											y: function(e) {
												ut();
												var t = new Date(i()[e + 20 >> 2] + 1900, i()[e + 16 >> 2], i()[e + 12 >> 2], i()[e + 8 >> 2], i()[e + 4 >> 2], i()[e >> 2], 0),
													...
													u = Math.min(s, a);
												return 0 > n ? i()[e + 32 >> 2] = Number(a != s && u == r) : 0 < n != (u == r) && (a = Math.max(s, a), t.setTime(t.getTime() + 6e4 * ((0 < n ? u : a) - r))), i()[e + 24 >> 2] = t.getDay(), n = (t.getTime() - o.getTime()) / 864e5 | 0, i()[e + 28 >> 2] = n, i()[e >> 2] = t.getSeconds(), i()[e + 4 >> 2] = t.getMinutes(), i()[e + 8 >> 2] = t.getHours(), i()[e + 12 >> 2] = t.getDate(), i()[e + 16 >> 2] = t.getMonth(), t.getTime() / 1e3 | 0
											},
											fa: ht,
											g: function(e, t, n, r) {
												return ht(e, t, n, r)
									...
									! function() {
										function e(e, t) {
											u.asm = e.exports, Q = u.asm.Ca, te.unshift(u.asm.ia), me.zb.push(u.asm.Ha), C = t, T || (ue--, u.monitorRunDependencies && u.monitorRunDependencies(ue), 0 == ue && ce && (e = ce, ce = null, e()))
										}
										...
										function n(e) {
											return function() {
												if (!I && (_ || w)) {
													if ("function" == typeof fetch && !se.startsWith("file://")) return fetch(se, {
													...
													if (b) return new Promise((function(e, t) {
														b(se, (function(t) {
															e(new Uint8Array(t))
														}), t)
													}))
												...
												D("failed to asynchronously prepare wasm: " + e), le(e)
											}))
										}
										var r = {
											a: bt
										};
										if (T || (ue++, u.monitorRunDependencies && u.monitorRunDependencies(ue)), u.instantiateWasm) try {
											return u.instantiateWasm(r, e)
										} catch (e) {
											return D("Module.instantiateWasm callback failed with error: " + e), !1
										}(I || "function" != typeof WebAssembly.instantiateStreaming || fe() || "function" != typeof fetch ? n(t) : fetch(se, {
											credentials: "same-origin"
										}).then((function(e) {
											return WebAssembly.instantiateStreaming(e, r).then(t, (function(e) {
												return D("wasm streaming compile failed: " + e), D("falling back to ArrayBuffer instantiation"), n(t)
											}))
										}))).catch(l)
									}(), u.___wasm_call_ctors = function() {
										return (u.___wasm_call_ctors = u.asm.ia).apply(null, arguments)
									}, u._OrtInit = function() {
										return (u._OrtInit = u.asm.ja).apply(null, arguments)
									}, u._OrtCreateSessionOptions = function() {
										return (u._OrtCreateSessionOptions = u.asm.ka).apply(null, arguments)
									}, u._OrtAddSessionConfigEntry = function() {
										return (u._OrtAddSessionConfigEntry = u.asm.la).apply(null, arguments)
									}, u._OrtReleaseSessionOptions = function() {
										return (u._OrtReleaseSessionOptions = u.asm.ma).apply(null, arguments)
									}, u._OrtCreateSession = function() {
										return (u._OrtCreateSession = u.asm.na).apply(null, arguments)
									}, u._OrtReleaseSession = function() {
										return (u._OrtReleaseSession = u.asm.oa).apply(null, arguments)
									}, u._OrtGetInputCount = function() {
										return (u._OrtGetInputCount = u.asm.pa).apply(null, arguments)
									}, u._OrtGetOutputCount = function() {
										return (u._OrtGetOutputCount = u.asm.qa).apply(null, arguments)
									}, u._OrtGetInputName = function() {
										return (u._OrtGetInputName = u.asm.ra).apply(null, arguments)
									}, u._OrtGetOutputName = function() {
										return (u._OrtGetOutputName = u.asm.sa).apply(null, arguments)
									}, u._OrtFree = function() {
										return (u._OrtFree = u.asm.ta).apply(null, arguments)
									}, u._OrtCreateTensor = function() {
										return (u._OrtCreateTensor = u.asm.ua).apply(null, arguments)
									}, u._OrtGetTensorData = function() {
										return (u._OrtGetTensorData = u.asm.va).apply(null, arguments)
									}, u._OrtReleaseTensor = function() {
										return (u._OrtReleaseTensor = u.asm.wa).apply(null, arguments)
									}, u._OrtCreateRunOptions = function() {
										return (u._OrtCreateRunOptions = u.asm.xa).apply(null, arguments)
									}, u._OrtAddRunConfigEntry = function() {
										return (u._OrtAddRunConfigEntry = u.asm.ya).apply(null, arguments)
									}, u._OrtReleaseRunOptions = function() {
										return (u._OrtReleaseRunOptions = u.asm.za).apply(null, arguments)
									}, u._OrtRun = function() {
										return (u._OrtRun = u.asm.Aa).apply(null, arguments)
									}, u._OrtEndProfiling = function() {
										return (u._OrtEndProfiling = u.asm.Ba).apply(null, arguments)
									};
									var yt = u._malloc = function() {
											return (yt = u._malloc = u.asm.Da).apply(null, arguments)
										},
										mt = u.___errno_location = function() {
											return (mt = u.___errno_location = u.asm.Ea).apply(null, arguments)
										},
										vt = u._free = function() {
											return (vt = u._free = u.asm.Fa).apply(null, arguments)
										},
										_t = u._pthread_self = function() {
											return (_t = u._pthread_self = u.asm.Ga).apply(null, arguments)
										};
									u._emscripten_tls_init = function() {
										return (u._emscripten_tls_init = u.asm.Ha).apply(null, arguments)
									}, u._emscripten_current_thread_process_queued_calls = function() {
										return (u._emscripten_current_thread_process_queued_calls = u.asm.Ia).apply(null, arguments)
									};
									var wt, xt = u._emscripten_register_main_browser_thread_id = function() {
											return (xt = u._emscripten_register_main_browser_thread_id = u.asm.Ja).apply(null, arguments)
										},
										Tt = u._emscripten_main_browser_thread_id = function() {
											return (Tt = u._emscripten_main_browser_thread_id = u.asm.Ka).apply(null, arguments)
										},
										St = u._emscripten_sync_run_in_main_thread_4 = function() {
											return (St = u._emscripten_sync_run_in_main_thread_4 = u.asm.La).apply(null, arguments)
										},
										Ot = u._emscripten_main_thread_process_queued_calls = function() {
											return (Ot = u._emscripten_main_thread_process_queued_calls = u.asm.Ma).apply(null, arguments)
										},
										At = u._emscripten_run_in_main_runtime_thread_js = function() {
											return (At = u._emscripten_run_in_main_runtime_thread_js = u.asm.Na).apply(null, arguments)
										},
										Et = u.__emscripten_call_on_thread = function() {
											return (Et = u.__emscripten_call_on_thread = u.asm.Oa).apply(null, arguments)
										},
										It = u._pthread_testcancel = function() {
											return (It = u._pthread_testcancel = u.asm.Pa).apply(null, arguments)
										},
										Pt = u._pthread_exit = function() {
											return (Pt = u._pthread_exit = u.asm.Qa).apply(null, arguments)
										},
										Dt = u.__emscripten_thread_init = function() {
											return (Dt = u.__emscripten_thread_init = u.asm.Ra).apply(null, arguments)
										},
										kt = u._emscripten_get_global_libc = function() {
											return (kt = u._emscripten_get_global_libc = u.asm.Sa).apply(null, arguments)
										},
										Nt = u.___pthread_tsd_run_dtors = function() {
											return (Nt = u.___pthread_tsd_run_dtors = u.asm.Ta).apply(null, arguments)
										},
										Ct = u.__get_tzname = function() {
											return (Ct = u.__get_tzname = u.asm.Ua).apply(null, arguments)
										},
										Rt = u.__get_daylight = function() {
											return (Rt = u.__get_daylight = u.asm.Va).apply(null, arguments)
										},
										Ft = u.__get_timezone = function() {
											return (Ft = u.__get_timezone = u.asm.Wa).apply(null, arguments)
										},
										Lt = u.stackSave = function() {
											return (Lt = u.stackSave = u.asm.Xa).apply(null, arguments)
										},
										Mt = u.stackRestore = function() {
											return (Mt = u.stackRestore = u.asm.Ya).apply(null, arguments)
										},
										jt = u.stackAlloc = function() {
											return (jt = u.stackAlloc = u.asm.Za).apply(null, arguments)
										},
										Ut = u._emscripten_stack_set_limits = function() {
											return (Ut = u._emscripten_stack_set_limits = u.asm._a).apply(null, arguments)
										},
										Bt = u._memalign = function() {
											return (Bt = u._memalign = u.asm.$a).apply(null, arguments)
										},
										Vt = u.__emscripten_allow_main_runtime_queued_calls = 973296,
										zt = u.__emscripten_main_thread_futex = 977204;
									...
									function Ht() {
										function e() {
											if (!wt && (wt = !0, u.calledRun = !0, !F) && (T || he(te), c(u), u.onRuntimeInitialized && u.onRuntimeInitialized(), !T)) {
												if (u.postRun)
										...
										if (!(0 < ue))
											if (T) c(u), T || he(te), postMessage({
												cmd: "loaded"
											});
											else {
												if (!T) {
													if (u.preRun)
														for ("function" == typeof u.preRun && (u.preRun = [u.preRun]); u.preRun.length;) ae();
													he(ee)
												}
												0 < ue || (u.setStatus ? (u.setStatus("Running..."), setTimeout((function() {
													setTimeout((function() {
														u.setStatus("")
													}), 1), e()
												}), 1)) : e())
							...
							932: function(e, t, n) {
								var r, o = (r = (r = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0) || "/index.js", function(e) {
									...
									var u, c, l, f, p, d = "./this.program",
										...
										y = "";
									b ? (y = g ? n(908).dirname(y) + "/" : "//", u = function(e, t) {
										return f || (f = n(1384)), p || (p = n(908)), e = p.normalize(e), f.readFileSync(e, t ? null : "utf8")
									}, l = function(e) {
										return (e = u(e, !0)).buffer || (e = new Uint8Array(e)), e.buffer || z("Assertion failed: undefined"), e
									}, c = function(e, t, r) {
										f || (f = n(1384)), p || (p = n(908)), e = p.normalize(e), f.readFile(e, (function(e, n) {
											e ? r(e) : t(n.buffer)
										}))
									}, 1 < process.argv.length && (d = process.argv[1].replace(/\\/g, "/")), process.argv.slice(2), process.on("uncaughtException", (function(e) {
										throw e
									})), process.on("unhandledRejection", z), t.inspect = function() {
										return "[Emscripten Module object]"
									}) : (h || g) && (g ? y = self.location.href : "undefined" != typeof document && document.currentScript && (y = document.currentScript.src), r && (y = r), y = 0 !== y.indexOf("blob:") ? y.substr(0, y.lastIndexOf("/") + 1) : "", u = function(e) {
										var t = new XMLHttpRequest;
										return t.open("GET", e, !1), t.send(null), t.responseText
									}, g && (l = function(e) {
										var t = new XMLHttpRequest;
									...
									var m, v = t.print || console.log.bind(console),
										_ = t.printErr || console.warn.bind(console);
									for (a in s) s.hasOwnProperty(a) && (t[a] = s[a]);
									s = null, t.thisProgram && (d = t.thisProgram), t.wasmBinary && (m = t.wasmBinary), t.noExitRuntime, "object" != typeof WebAssembly && z("no native wasm support detected");
									var w, x, T, S, O, A = !1,
									...
									function N(e) {
										var t = k(e) + 1,
											n = fe(t);
										return n && D(e, T, n, t), n
									}

									function C() {
										var e = w.buffer;
										x = e, t.HEAP8 = T = new Int8Array(e), t.HEAP16 = new Int16Array(e), t.HEAP32 = O = new Int32Array(e), t.HEAPU8 = S = new Uint8Array(e), t.HEAPU16 = new Uint16Array(e), t.HEAPU32 = new Uint32Array(e), t.HEAPF32 = new Float32Array(e), t.HEAPF64 = new Float64Array(e)
									}
									var R, F = [],
										L = [],
										M = [];
									...
									function z(e) {
										throw t.onAbort && t.onAbort(e), _(e), A = !0, e = new WebAssembly.RuntimeError("abort(" + e + "). Build with -s ASSERTIONS=1 for more info."), i(e), e
									}

									function G() {
										return U.startsWith("data:application/octet-stream;base64,")
									}
									if (t.preloadedImages = {}, t.preloadedAudios = {}, U = "ort-wasm.wasm", !G()) {
										var H = U;
										U = t.locateFile ? t.locateFile(H, y) : y + H
									}

									function W() {
										var e = U;
										try {
											if (e == U && m) return new Uint8Array(m);
											if (l) return l(e);
											throw "both async and sync fetching of the wasm failed"
										} catch (e) {
											z(e)
									...
									function q(e) {
										for (; 0 < e.length;) {
											...
											if ("function" == typeof n) n(t);
												...
												var r = n.Ea;
												"number" == typeof r ? void 0 === n.xa ? R.get(r)() : R.get(r)(n.xa) : r(void 0 === n.xa ? null : n.xa)
											}
										}
									}

									function Y(e) {
										this.ya = e - 16, this.Na = function(e) {
											O[this.ya + 4 >> 2] = e
										}, this.Ka = function(e) {
											O[this.ya + 8 >> 2] = e
										}, this.La = function() {
											...
											this.Na(e), this.Ka(t), this.La(), this.Ja(), this.Ma()
										}
									}
									var X, K = {},
										$ = [null, [],
									...
									function te() {
										if (!J) {
											...
											for (e in ee) void 0 === ee[e] ? delete t[e] : t[e] = ee[e];
											var n = [];
											for (e in t) n.push(e + "=" + t[e]);
											J = n
										}
									...
									function ne() {
										...
										if (!Q) {
											...
											var o = r.getTimezoneOffset(),
												i = Math.max(t, o);
											O[be() >> 2] = 60 * i, O[ge() >> 2] = Number(t != o), n = e(n), r = e(r), n = N(n), r = N(r), o < t ? (O[he() >> 2] = n, O[he() + 4 >> 2] = r) : (O[he() >> 2] = r, O[he() + 4 >> 2] = n)
										}
									}
									...
									var ie = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
										ae = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];

									function se(e, t) {
										for (e = new Date(e.getTime()); 0 < t;) {
											var n = e.getMonth(),
												r = (re(e.getFullYear()) ? ie : ae)[n];
											if (!(t > r - e.getDate())) {
												e.setDate(e.getDate() + t);
												break
											}
									...
									function ue(e, t, n, r) {
										...
										function u(e) {
											e = se(new Date(e.va + 1900, 0, 1), e.Ca);
											var t = new Date(e.getFullYear() + 1, 0, 4),
												n = s(new Date(e.getFullYear(), 0, 4));
											return t = s(t), 0 >= a(n, e) ? 0 >= a(t, e) ? e.getFullYear() + 1 : e.getFullYear() : e.getFullYear() - 1
										}
										var c = O[r + 40 >> 2];
										for (var l in r = {
												Qa: O[r >> 2],
										...
										var f = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),
											p = "January February March April May June July August September October November December".split(" ");
										for (l in c = {
												"%a": function(e) {
													return f[e.Ba].substring(0, 3)
												},
												"%A": function(e) {
													return f[e.Ba]
												},
												"%b": function(e) {
													return p[e.wa].substring(0, 3)
												},
												"%B": function(e) {
													return p[e.wa]
												},
												"%C": function(e) {
													return i((e.va + 1900) / 100 | 0, 2)
												},
												"%d": function(e) {
													return i(e.za, 2)
												},
												...
												"%I": function(e) {
													return 0 == (e = e.Aa) ? e = 12 : 12 < e && (e -= 12), i(e, 2)
												},
												"%j": function(e) {
													return i(e.za + oe(re(e.va + 1900) ? ie : ae, e.wa - 1), 3)
												},
												"%m": function(e) {
													return i(e.wa + 1, 2)
												},
												...
												"%U": function(e) {
													var t = new Date(e.va + 1900, 0, 1),
														n = 0 === t.getDay() ? t : se(t, 7 - t.getDay());
													return 0 > a(n, e = new Date(e.va + 1900, e.wa, e.za)) ? i(Math.ceil((31 - n.getDate() + (oe(re(e.getFullYear()) ? ie : ae, e.getMonth() - 1) - 31) + e.getDate()) / 7), 2) : 0 === a(n, t) ? "01" : "00"
												},
												"%V": function(e) {
													var t = new Date(e.va + 1901, 0, 4),
														n = s(new Date(e.va + 1900, 0, 4));
													t = s(t);
													var r = se(new Date(e.va + 1900, 0, 1), e.Ca);
													return 0 > a(r, n) ? "53" : 0 >= a(t, r) ? "01" : i(Math.ceil((n.getFullYear() < e.va + 1900 ? e.Ca + 32 - n.getDate() : e.Ca + 1 - n.getDate()) / 7), 2)
												},
												"%w": function(e) {
													return e.Ba
												},
												"%W": function(e) {
													var t = new Date(e.va, 0, 1),
														n = 1 === t.getDay() ? t : se(t, 0 === t.getDay() ? 1 : 7 - t.getDay() + 1);
													return 0 > a(n, e = new Date(e.va + 1900, e.wa, e.za)) ? i(Math.ceil((31 - n.getDate() + (oe(re(e.getFullYear()) ? ie : ae, e.getMonth() - 1) - 31) + e.getDate()) / 7), 2) : 0 === a(n, t) ? "01" : "00"
												},
												"%y": function(e) {
													return (e.va + 1900).toString().substring(2)
												},
												"%Y": function(e) {
													return e.va + 1900
												},
											...
											}) n.includes(l) && (n = n.replace(new RegExp(l, "g"), c[l](r)));
										return (l = function(e) {
											var t = Array(k(e) + 1);
											return D(e, t, 0, t.length), t
										}(n)).length > t ? 0 : (T.set(l, e), l.length - 1)
									}
									var ce = {
										a: function(e) {
											return fe(e + 16) + 16
										...
										d: function(e, t) {},
										b: function(e, t, n) {
											throw new Y(e).Ga(t, n), e
										},
										D: function(e, t) {
											return e = P(e), Z.Sa(e, t)
										},
										m: function() {
											return 0
										},
										...
										H: function() {},
										G: function(e, t) {
											return e = P(e), Z.Ta(e, t)
										},
										K: function(e, t, n, r, o, i) {
											if (i <<= 12, 0 != (16 & r) && 0 != e % 65536) t = -28;
											else if (0 != (32 & r)) {
												e = 65536 * Math.ceil(t / 65536);
												var a = _e(65536, e);
												a ? (S.fill(0, a, a + e), e = a) : e = 0, e ? (K[e] = {
													Ia: e,
													Ha: t,
													Fa: !0,
													fd: o,
										...
										J: function(e, t) {
											var n = K[e];
											return 0 !== t && n ? (t === n.Ha && (K[e] = null, n.Fa && de(n.Ia)), e = 0) : e = -28, e
										},
										j: function() {},
										C: function(e, t, n) {
											return e = P(e), Z.Ua(e, t, n)
										},
										E: function() {},
										r: function() {},
										F: function() {},
										...
										p: function(e, t) {
											if (0 === e) e = Date.now();
												...
												if (1 !== e && 4 !== e) return O[pe() >> 2] = 28, -1;
												e = X()
											}
											return O[t >> 2] = e / 1e3 | 0, O[t + 4 >> 2] = e % 1e3 * 1e6 | 0, 0
										},
										s: function(e, t) {
											return e - t
										},
										...
										i: function(e) {
											...
											for (var n = 1; 4 >= n; n *= 2) {
												...
												e: {
													try {
														w.grow(Math.min(2147483648, r) - x.byteLength + 65535 >>> 16), C();
														var o = 1;
														break e
													} catch (e) {}
													o = void 0
										...
										z: function(e, t) {
											var n = 0;
											return te().forEach((function(r, o) {
												var i = t + n;
												for (o = O[e + 4 * o >> 2] = i, i = 0; i < r.length; ++i) T[o++ >> 0] = r.charCodeAt(i);
												T[o >> 0] = 0, n += r.length + 1
											})), 0
										},
										A: function(e, t) {
											var n = te();
										...
										y: function(e, t) {
											return e = 1 == e || 2 == e ? 2 : z(), T[t >> 0] = e, 0
										},
										n: function(e, t, n, r) {
											return e = Z.Wa(e), t = Z.Va(e, t, n), O[r >> 2] = t, 0
										},
										u: function() {},
										q: function(e, t, n, r) {
											for (var o = 0, i = 0; i < n; i++) {
												for (var a = O[t + 8 * i >> 2], s = O[t + (8 * i + 4) >> 2], u = 0; u < s; u++) {
													var c = S[a + u],
														l = $[e];
													0 === c || 10 === c ? ((1 === e ? v : _)(I(l, 0)), l.length = 0) : l.push(c)
												}
												o += s
											}
											return O[r >> 2] = o, 0
										...
										w: function(e) {
											var t = Date.now();
											return O[e >> 2] = t / 1e3 | 0, O[e + 4 >> 2] = t % 1e3 * 1e3 | 0, 0
										},
										t: function e(t, n) {
											return t = new Date(1e3 * O[t >> 2]), O[n >> 2] = t.getUTCSeconds(), O[n + 4 >> 2] = t.getUTCMinutes(), O[n + 8 >> 2] = t.getUTCHours(), O[n + 12 >> 2] = t.getUTCDate(), O[n + 16 >> 2] = t.getUTCMonth(), O[n + 20 >> 2] = t.getUTCFullYear() - 1900, O[n + 24 >> 2] = t.getUTCDay(), O[n + 36 >> 2] = 0, O[n + 32 >> 2] = 0, O[n + 28 >> 2] = (t.getTime() - Date.UTC(t.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5 | 0, e.Da || (e.Da = N("GMT")), O[n + 40 >> 2] = e.Da, n
										},
										l: function(e, t) {
											ne(), e = new Date(1e3 * O[e >> 2]), O[t >> 2] = e.getSeconds(), O[t + 4 >> 2] = e.getMinutes(), O[t + 8 >> 2] = e.getHours(), O[t + 12 >> 2] = e.getDate(), O[t + 16 >> 2] = e.getMonth(), O[t + 20 >> 2] = e.getFullYear() - 1900, O[t + 24 >> 2] = e.getDay();
											var n = new Date(e.getFullYear(), 0, 1);
											O[t + 28 >> 2] = (e.getTime() - n.getTime()) / 864e5 | 0, O[t + 36 >> 2] = -60 * e.getTimezoneOffset();
											var r = new Date(e.getFullYear(), 6, 1).getTimezoneOffset();
											return e = 0 | (r != (n = n.getTimezoneOffset()) && e.getTimezoneOffset() == Math.min(n, r)), O[t + 32 >> 2] = e, e = O[he() + (e ? 4 : 0) >> 2], O[t + 40 >> 2] = e, t
										},
										k: function(e) {
											ne();
											var t = new Date(O[e + 20 >> 2] + 1900, O[e + 16 >> 2], O[e + 12 >> 2], O[e + 8 >> 2], O[e + 4 >> 2], O[e >> 2], 0),
												n = O[e + 32 >> 2],
												r = t.getTimezoneOffset(),
												o = new Date(t.getFullYear(), 0, 1),
												...
												s = Math.min(a, i);
											return 0 > n ? O[e + 32 >> 2] = Number(i != a && s == r) : 0 < n != (s == r) && (i = Math.max(a, i), t.setTime(t.getTime() + 6e4 * ((0 < n ? s : i) - r))), O[e + 24 >> 2] = t.getDay(), O[e + 28 >> 2] = (t.getTime() - o.getTime()) / 864e5 | 0, O[e >> 2] = t.getSeconds(), O[e + 4 >> 2] = t.getMinutes(), O[e + 8 >> 2] = t.getHours(), O[e + 12 >> 2] = t.getDate(), O[e + 16 >> 2] = t.getMonth(), t.getTime() / 1e3 | 0
										},
										N: ue,
										e: function(e, t, n, r) {
											return ue(e, t, n, r)
									...
									! function() {
										function e(e) {
											t.asm = e.exports, w = t.asm.R, C(), R = t.asm.ua, L.unshift(t.asm.S), B--, t.monitorRunDependencies && t.monitorRunDependencies(B), 0 == B && V && (e = V, V = null, e())
										}
										...
										function r(e) {
											return function() {
												if (!m && (h || g)) {
													if ("function" == typeof fetch) return fetch(U, {
														credentials: "same-origin"
													}).then((function(e) {
												...
												_("failed to asynchronously prepare wasm: " + e), z(e)
											}))
										}
										var o = {
											a: ce
										...
										}(m || "function" != typeof WebAssembly.instantiateStreaming || G() || false || "function" != typeof fetch ? r(n) : fetch(U, {
											credentials: "same-origin"
										}).then((function(e) {
											return WebAssembly.instantiateStreaming(e, o).then(n, (function(e) {
												return _("wasm streaming compile failed: " + e), _("falling back to ArrayBuffer instantiation"), r(n)
											}))
										}))).catch(i)
									}(), t.___wasm_call_ctors = function() {
										return (t.___wasm_call_ctors = t.asm.S).apply(null, arguments)
									}, t._OrtInit = function() {
										return (t._OrtInit = t.asm.T).apply(null, arguments)
									}, t._OrtCreateSessionOptions = function() {
										return (t._OrtCreateSessionOptions = t.asm.U).apply(null, arguments)
									}, t._OrtAddSessionConfigEntry = function() {
										return (t._OrtAddSessionConfigEntry = t.asm.V).apply(null, arguments)
									}, t._OrtReleaseSessionOptions = function() {
										return (t._OrtReleaseSessionOptions = t.asm.W).apply(null, arguments)
									}, t._OrtCreateSession = function() {
										return (t._OrtCreateSession = t.asm.X).apply(null, arguments)
									}, t._OrtReleaseSession = function() {
										return (t._OrtReleaseSession = t.asm.Y).apply(null, arguments)
									}, t._OrtGetInputCount = function() {
										return (t._OrtGetInputCount = t.asm.Z).apply(null, arguments)
									}, t._OrtGetOutputCount = function() {
										return (t._OrtGetOutputCount = t.asm._).apply(null, arguments)
									}, t._OrtGetInputName = function() {
										return (t._OrtGetInputName = t.asm.$).apply(null, arguments)
									}, t._OrtGetOutputName = function() {
										return (t._OrtGetOutputName = t.asm.aa).apply(null, arguments)
									}, t._OrtFree = function() {
										return (t._OrtFree = t.asm.ba).apply(null, arguments)
									}, t._OrtCreateTensor = function() {
										return (t._OrtCreateTensor = t.asm.ca).apply(null, arguments)
									}, t._OrtGetTensorData = function() {
										return (t._OrtGetTensorData = t.asm.da).apply(null, arguments)
									}, t._OrtReleaseTensor = function() {
										return (t._OrtReleaseTensor = t.asm.ea).apply(null, arguments)
									}, t._OrtCreateRunOptions = function() {
										return (t._OrtCreateRunOptions = t.asm.fa).apply(null, arguments)
									}, t._OrtAddRunConfigEntry = function() {
										return (t._OrtAddRunConfigEntry = t.asm.ga).apply(null, arguments)
									}, t._OrtReleaseRunOptions = function() {
										return (t._OrtReleaseRunOptions = t.asm.ha).apply(null, arguments)
									}, t._OrtRun = function() {
										return (t._OrtRun = t.asm.ia).apply(null, arguments)
									}, t._OrtEndProfiling = function() {
										return (t._OrtEndProfiling = t.asm.ja).apply(null, arguments)
									};
									var le, fe = t._malloc = function() {
											return (fe = t._malloc = t.asm.ka).apply(null, arguments)
										},
										pe = t.___errno_location = function() {
											return (pe = t.___errno_location = t.asm.la).apply(null, arguments)
										},
										de = t._free = function() {
											return (de = t._free = t.asm.ma).apply(null, arguments)
										},
										he = t.__get_tzname = function() {
											return (he = t.__get_tzname = t.asm.na).apply(null, arguments)
										},
										ge = t.__get_daylight = function() {
											return (ge = t.__get_daylight = t.asm.oa).apply(null, arguments)
										},
										be = t.__get_timezone = function() {
											return (be = t.__get_timezone = t.asm.pa).apply(null, arguments)
										},
										ye = t.stackSave = function() {
											return (ye = t.stackSave = t.asm.qa).apply(null, arguments)
										},
										me = t.stackRestore = function() {
											return (me = t.stackRestore = t.asm.ra).apply(null, arguments)
										},
										ve = t.stackAlloc = function() {
											return (ve = t.stackAlloc = t.asm.sa).apply(null, arguments)
										},
										_e = t._memalign = function() {
											return (_e = t._memalign = t.asm.ta).apply(null, arguments)
										};

									function we() {
										function e() {
											if (!le && (le = !0, t.calledRun = !0, !A)) {
												if (q(L), o(t), t.onRuntimeInitialized && t.onRuntimeInitialized(), t.postRun)
										...
										if (!(0 < B)) {
											if (t.preRun)
												for ("function" == typeof t.preRun && (t.preRun = [t.preRun]); t.preRun.length;) j();
											q(F), 0 < B || (t.setStatus ? (t.setStatus("Running..."), setTimeout((function() {
												setTimeout((function() {
													t.setStatus("")
												}), 1), e()
											}), 1)) : e())
									...
									if (t.UTF8ToString = P, t.stringToUTF8 = function(e, t, n) {
											return D(e, S, t, n)
										}, t.lengthBytesUTF8 = k, t.stackSave = ye, t.stackRestore = me, t.stackAlloc = ve, V = function e() {
											le || we(), le || (V = e)
										}, t.run = we, t.preInit)
							...
							4819: function(e, t, n) {
								...
								r.Offset, r.Table, r.SIZEOF_SHORT = 2, r.SIZEOF_INT = 4, r.FILE_IDENTIFIER_LENGTH = 4, r.SIZE_PREFIX_LENGTH = 4, r.Encoding = {
									...
									e: for (t = 0; t < this.vtables.length; t++) {
										...
										if (o == this.bb.readInt16(s)) {
											for (var u = r.SIZEOF_SHORT; u < o; u += r.SIZEOF_SHORT)
												if (this.bb.readInt16(a + u) != this.bb.readInt16(s + u)) continue e;
											i = this.vtables[t];
											break
										}
									}
									...
									for (; i < n;) {
										var a, s = this.readUint8(e + i++);
										if (s < 192) a = s;
										else {
											var u = this.readUint8(e + i++);
											if (s < 224) a = (31 & s) << 6 | 63 & u;
											else {
												var c = this.readUint8(e + i++);
												a = s < 240 ? (15 & s) << 12 | (63 & u) << 6 | 63 & c : (7 & s) << 18 | (63 & u) << 12 | (63 & c) << 6 | 63 & this.readUint8(e + i++)
											}
										}
									...
									for (var t = 0; t < r.FILE_IDENTIFIER_LENGTH; t++)
										if (e.charCodeAt(t) != this.readInt8(this.position_ + r.SIZEOF_INT + t)) return !1;
									return !0
							...
							3720: function(e) {
								...
								function a(e, t) {
									var n, r, a;
									return t ? (a = 0 <= (e >>>= 0) && e < 256) && (r = i[e]) ? r : (n = u(e, (0 | e) < 0 ? -1 : 0, !0), a && (i[e] = n), n) : (a = -128 <= (e |= 0) && e < 128) && (r = o[e]) ? r : (n = u(e, e < 0 ? -1 : 0, !1), a && (o[e] = n), n)
								}

								function s(e, t) {
									if (isNaN(e)) return t ? y : b;
									if (t) {
										if (e < 0) return y;
										if (e >= d) return x
									} else {
								...
								function l(e, t, n) {
									...
									for (var o = s(c(n, 8)), i = b, a = 0; a < e.length; a += 8) {
										var u = Math.min(8, e.length - a),
											f = parseInt(e.substring(a, a + u), n);
										if (u < 8) {
											var p = s(c(n, u));
											i = i.mul(p).add(s(f))
										} else i = (i = i.mul(o)).add(s(f))
									}
								...
								S.toInt = function() {
									...
									for (var o = s(c(e, 6), this.unsigned), i = this, a = "";;) {
										var u = i.div(o),
											l = (i.sub(u.mul(o)).toInt() >>> 0).toString(e);
									...
									return r(e) || (e = f(e)), (this.unsigned === e.unsigned || this.high >>> 31 != 1 || e.high >>> 31 != 1) && this.high === e.high && this.low === e.low
									...
									var t = this.high >>> 16,
										...
										d = 0,
										h = 0;
									return d += (h += i + (65535 & e.low)) >>> 16, p += (d += o + c) >>> 16, l += (p += n + s) >>> 16, l += t + a, u((d &= 65535) << 16 | (h &= 65535), (l &= 65535) << 16 | (p &= 65535), this.unsigned)
								}, S.subtract = function(e) {
									return r(e) || (e = f(e)), this.add(e.neg())
								}, S.sub = S.subtract, S.multiply = function(e) {
									if (this.isZero()) return b;
									if (r(e) || (e = f(e)), t) return u(t.mul(this.low, this.high, e.low, e.high), t.get_high(), this.unsigned);
									if (e.isZero()) return b;
									if (this.eq(T)) return e.isOdd() ? T : b;
									if (e.eq(T)) return this.isOdd() ? T : b;
									...
									var n = this.high >>> 16,
										...
										m = 0,
										v = 0;
									return m += (v += a * d) >>> 16, y += (m += i * d) >>> 16, m &= 65535, y += (m += a * p) >>> 16, h += (y += o * d) >>> 16, y &= 65535, h += (y += i * p) >>> 16, y &= 65535, h += (y += a * l) >>> 16, h += n * d + o * p + i * l + a * c, u((m &= 65535) << 16 | (v &= 65535), (h &= 65535) << 16 | (y &= 65535), this.unsigned)
									...
									if (this.isZero()) return this.unsigned ? y : b;
									if (this.unsigned) {
										if (e.unsigned || (e = e.toUnsigned()), e.gt(this)) return y;
										if (e.gt(this.shru(1))) return v;
										i = y
									} else {
										if (this.eq(T)) return e.eq(m) || e.eq(_) ? T : e.eq(T) ? m : (n = this.shr(1).div(e).shl(1)).eq(b) ? e.isNegative() ? m : _ : (o = this.sub(e.mul(n)), i = n.add(o.div(e)));
										if (e.eq(T)) return this.unsigned ? y : b;
									...
									for (o = this; o.gte(e);) {
										...
										for (var a = Math.ceil(Math.log(n) / Math.LN2), l = a <= 48 ? 1 : c(2, a - 48), p = s(n), d = p.mul(e); d.isNegative() || d.gt(o);) d = (p = s(n -= l, this.unsigned)).mul(e);
										p.isZero() && (p = m), i = i.add(p), o = o.sub(d)
									}
									return i
								}, S.div = S.divide, S.modulo = function(e) {
									return r(e) || (e = f(e)), t ? u((this.unsigned ? t.rem_u : t.rem_s)(this.low, this.high, e.low, e.high), t.get_high(), this.unsigned) : this.sub(this.div(e).mul(e))
								}, S.mod = S.modulo, S.rem = S.modulo, S.not = function() {
									return u(~this.low, ~this.high, this.unsigned)
								}, S.and = function(e) {
									return r(e) || (e = f(e)), u(this.low & e.low, this.high & e.high, this.unsigned)
								}, S.or = function(e) {
									return r(e) || (e = f(e)), u(this.low | e.low, this.high | e.high, this.unsigned)
								}, S.xor = function(e) {
									return r(e) || (e = f(e)), u(this.low ^ e.low, this.high ^ e.high, this.unsigned)
							...
							1446: function(e, t, n) {
								...
								l.onnx = ((i = {}).Version = (r = {}, (o = Object.create(r))[r[0] = "_START_VERSION"] = 0, o[r[1] = "IR_VERSION_2017_10_10"] = 1, o[r[2] = "IR_VERSION_2017_10_30"] = 2, o[r[3] = "IR_VERSION_2017_11_3"] = 3, o[r[4] = "IR_VERSION_2019_1_22"] = 4, o[r[5] = "IR_VERSION"] = 5, o), i.AttributeProto = function() {
									function e(e) {
									...
									return e.prototype.name = "", e.prototype.refAttrName = "", e.prototype.docString = "", e.prototype.type = 0, e.prototype.f = 0, e.prototype.i = c.Long ? c.Long.fromBits(0, 0, !1) : 0, e.prototype.s = c.newBuffer([]), e.prototype.t = null, e.prototype.g = null, e.prototype.floats = c.emptyArray, e.prototype.ints = c.emptyArray, e.prototype.strings = c.emptyArray, e.prototype.tensors = c.emptyArray, e.prototype.graphs = c.emptyArray, e.create = function(t) {
										return new e(t)
										...
										if (null != e.tensors && e.tensors.length)
											for (n = 0; n < e.tensors.length; ++n) l.onnx.TensorProto.encode(e.tensors[n], t.uint32(82).fork()).ldelim();
										if (null != e.graphs && e.graphs.length)
											for (n = 0; n < e.graphs.length; ++n) l.onnx.GraphProto.encode(e.graphs[n], t.uint32(90).fork()).ldelim();
										...
										for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.AttributeProto; e.pos < n;) {
											var o = e.uint32();
											switch (o >>> 3) {
												case 1:
													r.name = e.string();
												...
												case 9:
													...
													break;
												case 10:
													r.tensors && r.tensors.length || (r.tensors = []), r.tensors.push(l.onnx.TensorProto.decode(e, e.uint32()));
													break;
												case 11:
													r.graphs && r.graphs.length || (r.graphs = []), r.graphs.push(l.onnx.GraphProto.decode(e, e.uint32()));
													break;
												default:
													e.skipType(7 & o)
											}
										...
										if (null != e.name && e.hasOwnProperty("name") && !c.isString(e.name)) return "name: string expected";
										if (null != e.refAttrName && e.hasOwnProperty("refAttrName") && !c.isString(e.refAttrName)) return "refAttrName: string expected";
										if (null != e.docString && e.hasOwnProperty("docString") && !c.isString(e.docString)) return "docString: string expected";
										...
										if (null != e.i && e.hasOwnProperty("i") && !(c.isInteger(e.i) || e.i && c.isInteger(e.i.low) && c.isInteger(e.i.high))) return "i: integer|Long expected";
										if (null != e.s && e.hasOwnProperty("s") && !(e.s && "number" == typeof e.s.length || c.isString(e.s))) return "s: buffer expected";
										if (null != e.t && e.hasOwnProperty("t") && (n = l.onnx.TensorProto.verify(e.t))) return "t." + n;
										if (null != e.g && e.hasOwnProperty("g") && (n = l.onnx.GraphProto.verify(e.g))) return "g." + n;
										...
										if (null != e.ints && e.hasOwnProperty("ints")) {
											...
											for (t = 0; t < e.ints.length; ++t)
												if (!(c.isInteger(e.ints[t]) || e.ints[t] && c.isInteger(e.ints[t].low) && c.isInteger(e.ints[t].high))) return "ints: integer|Long[] expected"
										}
										if (null != e.strings && e.hasOwnProperty("strings")) {
											...
											for (t = 0; t < e.strings.length; ++t)
												if (!(e.strings[t] && "number" == typeof e.strings[t].length || c.isString(e.strings[t]))) return "strings: buffer[] expected"
										}
										...
										if (e.ints) {
											...
											for (t.ints = [], n = 0; n < e.ints.length; ++n) c.Long ? (t.ints[n] = c.Long.fromValue(e.ints[n])).unsigned = !1 : "string" == typeof e.ints[n] ? t.ints[n] = parseInt(e.ints[n], 10) : "number" == typeof e.ints[n] ? t.ints[n] = e.ints[n] : "object" == typeof e.ints[n] && (t.ints[n] = new c.LongBits(e.ints[n].low >>> 0, e.ints[n].high >>> 0).toNumber())
										}
										if (e.strings) {
											if (!Array.isArray(e.strings)) throw TypeError(".onnx.AttributeProto.strings: array expected");
											for (t.strings = [], n = 0; n < e.strings.length; ++n) "string" == typeof e.strings[n] ? c.base64.decode(e.strings[n], t.strings[n] = c.newBuffer(c.base64.length(e.strings[n])), 0) : e.strings[n].length && (t.strings[n] = e.strings[n])
										}
										if (e.tensors) {
										...
										if (e.ints && e.ints.length)
											for (n.ints = [], o = 0; o < e.ints.length; ++o) "number" == typeof e.ints[o] ? n.ints[o] = t.longs === String ? String(e.ints[o]) : e.ints[o] : n.ints[o] = t.longs === String ? c.Long.prototype.toString.call(e.ints[o]) : t.longs === Number ? new c.LongBits(e.ints[o].low >>> 0, e.ints[o].high >>> 0).toNumber() : e.ints[o];
										if (e.strings && e.strings.length)
											for (n.strings = [], o = 0; o < e.strings.length; ++o) n.strings[o] = t.bytes === String ? c.base64.encode(e.strings[o], 0, e.strings[o].length) : t.bytes === Array ? Array.prototype.slice.call(e.strings[o]) : e.strings[o];
										if (e.tensors && e.tensors.length)
											for (n.tensors = [], o = 0; o < e.tensors.length; ++o) n.tensors[o] = l.onnx.TensorProto.toObject(e.tensors[o], t);
										if (e.graphs && e.graphs.length)
											for (n.graphs = [], o = 0; o < e.graphs.length; ++o) n.graphs[o] = l.onnx.GraphProto.toObject(e.graphs[o], t);
										return null != e.docString && e.hasOwnProperty("docString") && (n.docString = e.docString), null != e.type && e.hasOwnProperty("type") && (n.type = t.enums === String ? l.onnx.AttributeProto.AttributeType[e.type] : e.type), null != e.refAttrName && e.hasOwnProperty("refAttrName") && (n.refAttrName = e.refAttrName), n
									}, e.prototype.toJSON = function() {
									...
									return e.prototype.name = "", e.prototype.type = null, e.prototype.docString = "", e.create = function(t) {
										...
										return t || (t = u.create()), null != e.name && e.hasOwnProperty("name") && t.uint32(10).string(e.name), null != e.type && e.hasOwnProperty("type") && l.onnx.TypeProto.encode(e.type, t.uint32(18).fork()).ldelim(), null != e.docString && e.hasOwnProperty("docString") && t.uint32(26).string(e.docString), t
									}, e.encodeDelimited = function(e, t) {
										return this.encode(e, t).ldelim()
									}, e.decode = function(e, t) {
										e instanceof s || (e = s.create(e));
										for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.ValueInfoProto; e.pos < n;) {
											var o = e.uint32();
											switch (o >>> 3) {
												case 1:
													r.name = e.string();
										...
										return null != e.docString && e.hasOwnProperty("docString") && !c.isString(e.docString) ? "docString: string expected" : null
									}, e.fromObject = function(e) {
										...
										t || (t = {});
										var n = {};
										return t.defaults && (n.name = "", n.type = null, n.docString = ""), null != e.name && e.hasOwnProperty("name") && (n.name = e.name), null != e.type && e.hasOwnProperty("type") && (n.type = l.onnx.TypeProto.toObject(e.type, t)), null != e.docString && e.hasOwnProperty("docString") && (n.docString = e.docString), n
									}, e.prototype.toJSON = function() {
										return this.constructor.toObject(this, a.util.toJSONOptions)
									}, e
									...
									return e.prototype.input = c.emptyArray, e.prototype.output = c.emptyArray, e.prototype.name = "", e.prototype.opType = "", e.prototype.domain = "", e.prototype.attribute = c.emptyArray, e.prototype.docString = "", e.create = function(t) {
										return new e(t)
									}, e.encode = function(e, t) {
										if (t || (t = u.create()), null != e.input && e.input.length)
										...
										if (null != e.name && e.hasOwnProperty("name") && t.uint32(26).string(e.name), null != e.opType && e.hasOwnProperty("opType") && t.uint32(34).string(e.opType), null != e.attribute && e.attribute.length)
											for (n = 0; n < e.attribute.length; ++n) l.onnx.AttributeProto.encode(e.attribute[n], t.uint32(42).fork()).ldelim();
										...
										e instanceof s || (e = s.create(e));
										for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.NodeProto; e.pos < n;) {
											var o = e.uint32();
											switch (o >>> 3) {
												case 1:
												...
												case 7:
													...
													break;
												case 5:
													r.attribute && r.attribute.length || (r.attribute = []), r.attribute.push(l.onnx.AttributeProto.decode(e, e.uint32()));
													break;
												case 6:
													r.docString = e.string();
													break;
										...
										if (null != e.input && e.hasOwnProperty("input")) {
											...
											for (var t = 0; t < e.input.length; ++t)
												if (!c.isString(e.input[t])) return "input: string[] expected"
										}
										if (null != e.output && e.hasOwnProperty("output")) {
											...
											for (t = 0; t < e.output.length; ++t)
												if (!c.isString(e.output[t])) return "output: string[] expected"
										}
										if (null != e.name && e.hasOwnProperty("name") && !c.isString(e.name)) return "name: string expected";
										if (null != e.opType && e.hasOwnProperty("opType") && !c.isString(e.opType)) return "opType: string expected";
										if (null != e.domain && e.hasOwnProperty("domain") && !c.isString(e.domain)) return "domain: string expected";
										...
										if (null != e.name && e.hasOwnProperty("name") && (n.name = e.name), null != e.opType && e.hasOwnProperty("opType") && (n.opType = e.opType), e.attribute && e.attribute.length)
											for (n.attribute = [], r = 0; r < e.attribute.length; ++r) n.attribute[r] = l.onnx.AttributeProto.toObject(e.attribute[r], t);
									...
									return e.prototype.irVersion = c.Long ? c.Long.fromBits(0, 0, !1) : 0, e.prototype.opsetImport = c.emptyArray, e.prototype.producerName = "", e.prototype.producerVersion = "", e.prototype.domain = "", e.prototype.modelVersion = c.Long ? c.Long.fromBits(0, 0, !1) : 0, e.prototype.docString = "", e.prototype.graph = null, e.prototype.metadataProps = c.emptyArray, e.create = function(t) {
										...
										if (t || (t = u.create()), null != e.irVersion && e.hasOwnProperty("irVersion") && t.uint32(8).int64(e.irVersion), null != e.producerName && e.hasOwnProperty("producerName") && t.uint32(18).string(e.producerName), null != e.producerVersion && e.hasOwnProperty("producerVersion") && t.uint32(26).string(e.producerVersion), null != e.domain && e.hasOwnProperty("domain") && t.uint32(34).string(e.domain), null != e.modelVersion && e.hasOwnProperty("modelVersion") && t.uint32(40).int64(e.modelVersion), null != e.docString && e.hasOwnProperty("docString") && t.uint32(50).string(e.docString), null != e.graph && e.hasOwnProperty("graph") && l.onnx.GraphProto.encode(e.graph, t.uint32(58).fork()).ldelim(), null != e.opsetImport && e.opsetImport.length)
											for (var n = 0; n < e.opsetImport.length; ++n) l.onnx.OperatorSetIdProto.encode(e.opsetImport[n], t.uint32(66).fork()).ldelim();
										if (null != e.metadataProps && e.metadataProps.length)
											for (n = 0; n < e.metadataProps.length; ++n) l.onnx.StringStringEntryProto.encode(e.metadataProps[n], t.uint32(114).fork()).ldelim();
										return t
									}, e.encodeDelimited = function(e, t) {
										return this.encode(e, t).ldelim()
									}, e.decode = function(e, t) {
										e instanceof s || (e = s.create(e));
										for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.ModelProto; e.pos < n;) {
											var o = e.uint32();
											switch (o >>> 3) {
												case 1:
													r.irVersion = e.int64();
													break;
												case 8:
													r.opsetImport && r.opsetImport.length || (r.opsetImport = []), r.opsetImport.push(l.onnx.OperatorSetIdProto.decode(e, e.uint32()));
													break;
												case 2:
												...
												case 7:
													...
													break;
												case 14:
													r.metadataProps && r.metadataProps.length || (r.metadataProps = []), r.metadataProps.push(l.onnx.StringStringEntryProto.decode(e, e.uint32()));
													break;
												default:
													e.skipType(7 & o)
											}
										...
										if ("object" != typeof e || null === e) return "object expected";
										if (null != e.irVersion && e.hasOwnProperty("irVersion") && !(c.isInteger(e.irVersion) || e.irVersion && c.isInteger(e.irVersion.low) && c.isInteger(e.irVersion.high))) return "irVersion: integer|Long expected";
										if (null != e.opsetImport && e.hasOwnProperty("opsetImport")) {
											...
											for (var t = 0; t < e.opsetImport.length; ++t)
												if (n = l.onnx.OperatorSetIdProto.verify(e.opsetImport[t])) return "opsetImport." + n
										}
										if (null != e.producerName && e.hasOwnProperty("producerName") && !c.isString(e.producerName)) return "producerName: string expected";
										if (null != e.producerVersion && e.hasOwnProperty("producerVersion") && !c.isString(e.producerVersion)) return "producerVersion: string expected";
										if (null != e.domain && e.hasOwnProperty("domain") && !c.isString(e.domain)) return "domain: string expected";
										if (null != e.modelVersion && e.hasOwnProperty("modelVersion") && !(c.isInteger(e.modelVersion) || e.modelVersion && c.isInteger(e.modelVersion.low) && c.isInteger(e.modelVersion.high))) return "modelVersion: integer|Long expected";
										if (null != e.docString && e.hasOwnProperty("docString") && !c.isString(e.docString)) return "docString: string expected";
										if (null != e.graph && e.hasOwnProperty("graph") && (n = l.onnx.GraphProto.verify(e.graph))) return "graph." + n;
										if (null != e.metadataProps && e.hasOwnProperty("metadataProps")) {
											...
											for (t = 0; t < e.metadataProps.length; ++t) {
												var n;
												if (n = l.onnx.StringStringEntryProto.verify(e.metadataProps[t])) return "metadataProps." + n
											}
										}
										return null
									}, e.fromObject = function(e) {
										...
										if (null != e.irVersion && (c.Long ? (t.irVersion = c.Long.fromValue(e.irVersion)).unsigned = !1 : "string" == typeof e.irVersion ? t.irVersion = parseInt(e.irVersion, 10) : "number" == typeof e.irVersion ? t.irVersion = e.irVersion : "object" == typeof e.irVersion && (t.irVersion = new c.LongBits(e.irVersion.low >>> 0, e.irVersion.high >>> 0).toNumber())), e.opsetImport) {
										...
										if ((t.arrays || t.defaults) && (n.opsetImport = [], n.metadataProps = []), t.defaults) {
											...
											n.producerName = "", n.producerVersion = "", n.domain = "", c.Long ? (r = new c.Long(0, 0, !1), n.modelVersion = t.longs === String ? r.toString() : t.longs === Number ? r.toNumber() : r) : n.modelVersion = t.longs === String ? "0" : 0, n.docString = "", n.graph = null
										}
										if (null != e.irVersion && e.hasOwnProperty("irVersion") && ("number" == typeof e.irVersion ? n.irVersion = t.longs === String ? String(e.irVersion) : e.irVersion : n.irVersion = t.longs === String ? c.Long.prototype.toString.call(e.irVersion) : t.longs === Number ? new c.LongBits(e.irVersion.low >>> 0, e.irVersion.high >>> 0).toNumber() : e.irVersion), null != e.producerName && e.hasOwnProperty("producerName") && (n.producerName = e.producerName), null != e.producerVersion && e.hasOwnProperty("producerVersion") && (n.producerVersion = e.producerVersion), null != e.domain && e.hasOwnProperty("domain") && (n.domain = e.domain), null != e.modelVersion && e.hasOwnProperty("modelVersion") && ("number" == typeof e.modelVersion ? n.modelVersion = t.longs === String ? String(e.modelVersion) : e.modelVersion : n.modelVersion = t.longs === String ? c.Long.prototype.toString.call(e.modelVersion) : t.longs === Number ? new c.LongBits(e.modelVersion.low >>> 0, e.modelVersion.high >>> 0).toNumber() : e.modelVersion), null != e.docString && e.hasOwnProperty("docString") && (n.docString = e.docString), null != e.graph && e.hasOwnProperty("graph") && (n.graph = l.onnx.GraphProto.toObject(e.graph, t)), e.opsetImport && e.opsetImport.length) {
											n.opsetImport = [];
											for (var o = 0; o < e.opsetImport.length; ++o) n.opsetImport[o] = l.onnx.OperatorSetIdProto.toObject(e.opsetImport[o], t)
										}
										if (e.metadataProps && e.metadataProps.length)
											for (n.metadataProps = [], o = 0; o < e.metadataProps.length; ++o) n.metadataProps[o] = l.onnx.StringStringEntryProto.toObject(e.metadataProps[o], t);
										return n
									}, e.prototype.toJSON = function() {
										return this.constructor.toObject(this, a.util.toJSONOptions)
									}, e
									...
									return e.prototype.key = "", e.prototype.value = "", e.create = function(t) {
										...
										e instanceof s || (e = s.create(e));
										for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.StringStringEntryProto; e.pos < n;) {
											var o = e.uint32();
											switch (o >>> 3) {
												case 1:
													r.key = e.string();
										...
										return "object" != typeof e || null === e ? "object expected" : null != e.key && e.hasOwnProperty("key") && !c.isString(e.key) ? "key: string expected" : null != e.value && e.hasOwnProperty("value") && !c.isString(e.value) ? "value: string expected" : null
									}, e.fromObject = function(e) {
									...
									return e.prototype.tensorName = "", e.prototype.quantParameterTensorNames = c.emptyArray, e.create = function(t) {
										return new e(t)
									}, e.encode = function(e, t) {
										if (t || (t = u.create()), null != e.tensorName && e.hasOwnProperty("tensorName") && t.uint32(10).string(e.tensorName), null != e.quantParameterTensorNames && e.quantParameterTensorNames.length)
											for (var n = 0; n < e.quantParameterTensorNames.length; ++n) l.onnx.StringStringEntryProto.encode(e.quantParameterTensorNames[n], t.uint32(18).fork()).ldelim();
										return t
									}, e.encodeDelimited = function(e, t) {
										return this.encode(e, t).ldelim()
									}, e.decode = function(e, t) {
										e instanceof s || (e = s.create(e));
										for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.TensorAnnotation; e.pos < n;) {
											var o = e.uint32();
											switch (o >>> 3) {
												case 1:
													...
													break;
												case 2:
													r.quantParameterTensorNames && r.quantParameterTensorNames.length || (r.quantParameterTensorNames = []), r.quantParameterTensorNames.push(l.onnx.StringStringEntryProto.decode(e, e.uint32()));
													break;
												default:
													e.skipType(7 & o)
											}
										...
										if ("object" != typeof e || null === e) return "object expected";
										if (null != e.tensorName && e.hasOwnProperty("tensorName") && !c.isString(e.tensorName)) return "tensorName: string expected";
										...
										if ((t.arrays || t.defaults) && (n.quantParameterTensorNames = []), t.defaults && (n.tensorName = ""), null != e.tensorName && e.hasOwnProperty("tensorName") && (n.tensorName = e.tensorName), e.quantParameterTensorNames && e.quantParameterTensorNames.length) {
											...
											for (var r = 0; r < e.quantParameterTensorNames.length; ++r) n.quantParameterTensorNames[r] = l.onnx.StringStringEntryProto.toObject(e.quantParameterTensorNames[r], t)
										}
										return n
									}, e.prototype.toJSON = function() {
										return this.constructor.toObject(this, a.util.toJSONOptions)
									...
									return e.prototype.node = c.emptyArray, e.prototype.name = "", e.prototype.initializer = c.emptyArray, e.prototype.docString = "", e.prototype.input = c.emptyArray, e.prototype.output = c.emptyArray, e.prototype.valueInfo = c.emptyArray, e.prototype.quantizationAnnotation = c.emptyArray, e.create = function(t) {
										return new e(t)
									}, e.encode = function(e, t) {
										if (t || (t = u.create()), null != e.node && e.node.length)
											for (var n = 0; n < e.node.length; ++n) l.onnx.NodeProto.encode(e.node[n], t.uint32(10).fork()).ldelim();
										if (null != e.name && e.hasOwnProperty("name") && t.uint32(18).string(e.name), null != e.initializer && e.initializer.length)
											for (n = 0; n < e.initializer.length; ++n) l.onnx.TensorProto.encode(e.initializer[n], t.uint32(42).fork()).ldelim();
										if (null != e.docString && e.hasOwnProperty("docString") && t.uint32(82).string(e.docString), null != e.input && e.input.length)
											for (n = 0; n < e.input.length; ++n) l.onnx.ValueInfoProto.encode(e.input[n], t.uint32(90).fork()).ldelim();
										if (null != e.output && e.output.length)
											for (n = 0; n < e.output.length; ++n) l.onnx.ValueInfoProto.encode(e.output[n], t.uint32(98).fork()).ldelim();
										if (null != e.valueInfo && e.valueInfo.length)
											for (n = 0; n < e.valueInfo.length; ++n) l.onnx.ValueInfoProto.encode(e.valueInfo[n], t.uint32(106).fork()).ldelim();
										if (null != e.quantizationAnnotation && e.quantizationAnnotation.length)
											for (n = 0; n < e.quantizationAnnotation.length; ++n) l.onnx.TensorAnnotation.encode(e.quantizationAnnotation[n], t.uint32(114).fork()).ldelim();
										return t
									}, e.encodeDelimited = function(e, t) {
										return this.encode(e, t).ldelim()
									}, e.decode = function(e, t) {
										e instanceof s || (e = s.create(e));
										for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.GraphProto; e.pos < n;) {
											var o = e.uint32();
											switch (o >>> 3) {
												case 1:
													r.node && r.node.length || (r.node = []), r.node.push(l.onnx.NodeProto.decode(e, e.uint32()));
													break;
												case 2:
													r.name = e.string();
													break;
												case 5:
													r.initializer && r.initializer.length || (r.initializer = []), r.initializer.push(l.onnx.TensorProto.decode(e, e.uint32()));
													break;
												case 10:
													r.docString = e.string();
													break;
												case 11:
													r.input && r.input.length || (r.input = []), r.input.push(l.onnx.ValueInfoProto.decode(e, e.uint32()));
													break;
												case 12:
													r.output && r.output.length || (r.output = []), r.output.push(l.onnx.ValueInfoProto.decode(e, e.uint32()));
													break;
												case 13:
													r.valueInfo && r.valueInfo.length || (r.valueInfo = []), r.valueInfo.push(l.onnx.ValueInfoProto.decode(e, e.uint32()));
													break;
												case 14:
													r.quantizationAnnotation && r.quantizationAnnotation.length || (r.quantizationAnnotation = []), r.quantizationAnnotation.push(l.onnx.TensorAnnotation.decode(e, e.uint32()));
													break;
												default:
													e.skipType(7 & o)
											}
										...
										if (null != e.quantizationAnnotation && e.hasOwnProperty("quantizationAnnotation")) {
											...
											for (t = 0; t < e.quantizationAnnotation.length; ++t) {
												var n;
												if (n = l.onnx.TensorAnnotation.verify(e.quantizationAnnotation[t])) return "quantizationAnnotation." + n
											}
										}
										return null
									}, e.fromObject = function(e) {
										...
										if ((t.arrays || t.defaults) && (n.node = [], n.initializer = [], n.input = [], n.output = [], n.valueInfo = [], n.quantizationAnnotation = []), t.defaults && (n.name = "", n.docString = ""), e.node && e.node.length) {
											n.node = [];
											for (var r = 0; r < e.node.length; ++r) n.node[r] = l.onnx.NodeProto.toObject(e.node[r], t)
										}
										if (null != e.name && e.hasOwnProperty("name") && (n.name = e.name), e.initializer && e.initializer.length)
											for (n.initializer = [], r = 0; r < e.initializer.length; ++r) n.initializer[r] = l.onnx.TensorProto.toObject(e.initializer[r], t);
										if (null != e.docString && e.hasOwnProperty("docString") && (n.docString = e.docString), e.input && e.input.length)
											for (n.input = [], r = 0; r < e.input.length; ++r) n.input[r] = l.onnx.ValueInfoProto.toObject(e.input[r], t);
										if (e.output && e.output.length)
											for (n.output = [], r = 0; r < e.output.length; ++r) n.output[r] = l.onnx.ValueInfoProto.toObject(e.output[r], t);
										if (e.valueInfo && e.valueInfo.length)
											for (n.valueInfo = [], r = 0; r < e.valueInfo.length; ++r) n.valueInfo[r] = l.onnx.ValueInfoProto.toObject(e.valueInfo[r], t);
										if (e.quantizationAnnotation && e.quantizationAnnotation.length)
											for (n.quantizationAnnotation = [], r = 0; r < e.quantizationAnnotation.length; ++r) n.quantizationAnnotation[r] = l.onnx.TensorAnnotation.toObject(e.quantizationAnnotation[r], t);
										return n
									}, e.prototype.toJSON = function() {
										return this.constructor.toObject(this, a.util.toJSONOptions)
									}, e
									...
									return e.prototype.dims = c.emptyArray, e.prototype.dataType = 0, e.prototype.segment = null, e.prototype.floatData = c.emptyArray, e.prototype.int32Data = c.emptyArray, e.prototype.stringData = c.emptyArray, e.prototype.int64Data = c.emptyArray, e.prototype.name = "", e.prototype.docString = "", e.prototype.rawData = c.newBuffer([]), e.prototype.externalData = c.emptyArray, e.prototype.dataLocation = 0, e.prototype.doubleData = c.emptyArray, e.prototype.uint64Data = c.emptyArray, e.create = function(t) {
										return new e(t)
									}, e.encode = function(e, t) {
										...
										if (null != e.dataType && e.hasOwnProperty("dataType") && t.uint32(16).int32(e.dataType), null != e.segment && e.hasOwnProperty("segment") && l.onnx.TensorProto.Segment.encode(e.segment, t.uint32(26).fork()).ldelim(), null != e.floatData && e.floatData.length) {
										...
										if (null != e.docString && e.hasOwnProperty("docString") && t.uint32(98).string(e.docString), null != e.externalData && e.externalData.length)
											for (n = 0; n < e.externalData.length; ++n) l.onnx.StringStringEntryProto.encode(e.externalData[n], t.uint32(106).fork()).ldelim();
										return null != e.dataLocation && e.hasOwnProperty("dataLocation") && t.uint32(112).int32(e.dataLocation), t
									}, e.encodeDelimited = function(e, t) {
										return this.encode(e, t).ldelim()
									}, e.decode = function(e, t) {
										e instanceof s || (e = s.create(e));
										for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.TensorProto; e.pos < n;) {
											var o = e.uint32();
											switch (o >>> 3) {
												case 1:
												...
												case 9:
													...
													break;
												case 13:
													r.externalData && r.externalData.length || (r.externalData = []), r.externalData.push(l.onnx.StringStringEntryProto.decode(e, e.uint32()));
													break;
												case 14:
													r.dataLocation = e.int32();
													break;
												case 10:
													if (r.doubleData && r.doubleData.length || (r.doubleData = []), 2 == (7 & o))
														for (i = e.uint32() + e.pos; e.pos < i;) r.doubleData.push(e.double());
													else r.doubleData.push(e.double());
													break;
												case 11:
													if (r.uint64Data && r.uint64Data.length || (r.uint64Data = []), 2 == (7 & o))
										...
										if (null != e.dims && e.hasOwnProperty("dims")) {
											...
											for (var t = 0; t < e.dims.length; ++t)
												if (!(c.isInteger(e.dims[t]) || e.dims[t] && c.isInteger(e.dims[t].low) && c.isInteger(e.dims[t].high))) return "dims: integer|Long[] expected"
										}
										if (null != e.dataType && e.hasOwnProperty("dataType") && !c.isInteger(e.dataType)) return "dataType: integer expected";
										if (null != e.segment && e.hasOwnProperty("segment") && (n = l.onnx.TensorProto.Segment.verify(e.segment))) return "segment." + n;
										...
										if (null != e.int32Data && e.hasOwnProperty("int32Data")) {
											...
											for (t = 0; t < e.int32Data.length; ++t)
												if (!c.isInteger(e.int32Data[t])) return "int32Data: integer[] expected"
										}
										if (null != e.stringData && e.hasOwnProperty("stringData")) {
											...
											for (t = 0; t < e.stringData.length; ++t)
												if (!(e.stringData[t] && "number" == typeof e.stringData[t].length || c.isString(e.stringData[t]))) return "stringData: buffer[] expected"
										}
										if (null != e.int64Data && e.hasOwnProperty("int64Data")) {
											...
											for (t = 0; t < e.int64Data.length; ++t)
												if (!(c.isInteger(e.int64Data[t]) || e.int64Data[t] && c.isInteger(e.int64Data[t].low) && c.isInteger(e.int64Data[t].high))) return "int64Data: integer|Long[] expected"
										}
										if (null != e.name && e.hasOwnProperty("name") && !c.isString(e.name)) return "name: string expected";
										if (null != e.docString && e.hasOwnProperty("docString") && !c.isString(e.docString)) return "docString: string expected";
										if (null != e.rawData && e.hasOwnProperty("rawData") && !(e.rawData && "number" == typeof e.rawData.length || c.isString(e.rawData))) return "rawData: buffer expected";
										if (null != e.externalData && e.hasOwnProperty("externalData")) {
											...
											for (t = 0; t < e.externalData.length; ++t) {
												var n;
												if (n = l.onnx.StringStringEntryProto.verify(e.externalData[t])) return "externalData." + n
											}
										}
										...
										if (null != e.uint64Data && e.hasOwnProperty("uint64Data")) {
											...
											for (t = 0; t < e.uint64Data.length; ++t)
												if (!(c.isInteger(e.uint64Data[t]) || e.uint64Data[t] && c.isInteger(e.uint64Data[t].low) && c.isInteger(e.uint64Data[t].high))) return "uint64Data: integer|Long[] expected"
										}
										return null
									}, e.fromObject = function(e) {
										...
										if (e.dims) {
											...
											t.dims = [];
											for (var n = 0; n < e.dims.length; ++n) c.Long ? (t.dims[n] = c.Long.fromValue(e.dims[n])).unsigned = !1 : "string" == typeof e.dims[n] ? t.dims[n] = parseInt(e.dims[n], 10) : "number" == typeof e.dims[n] ? t.dims[n] = e.dims[n] : "object" == typeof e.dims[n] && (t.dims[n] = new c.LongBits(e.dims[n].low >>> 0, e.dims[n].high >>> 0).toNumber())
										}
										...
										if (e.stringData) {
											...
											for (t.stringData = [], n = 0; n < e.stringData.length; ++n) "string" == typeof e.stringData[n] ? c.base64.decode(e.stringData[n], t.stringData[n] = c.newBuffer(c.base64.length(e.stringData[n])), 0) : e.stringData[n].length && (t.stringData[n] = e.stringData[n])
										}
										if (e.int64Data) {
											if (!Array.isArray(e.int64Data)) throw TypeError(".onnx.TensorProto.int64Data: array expected");
											for (t.int64Data = [], n = 0; n < e.int64Data.length; ++n) c.Long ? (t.int64Data[n] = c.Long.fromValue(e.int64Data[n])).unsigned = !1 : "string" == typeof e.int64Data[n] ? t.int64Data[n] = parseInt(e.int64Data[n], 10) : "number" == typeof e.int64Data[n] ? t.int64Data[n] = e.int64Data[n] : "object" == typeof e.int64Data[n] && (t.int64Data[n] = new c.LongBits(e.int64Data[n].low >>> 0, e.int64Data[n].high >>> 0).toNumber())
										}
										if (null != e.name && (t.name = String(e.name)), null != e.docString && (t.docString = String(e.docString)), null != e.rawData && ("string" == typeof e.rawData ? c.base64.decode(e.rawData, t.rawData = c.newBuffer(c.base64.length(e.rawData)), 0) : e.rawData.length && (t.rawData = e.rawData)), e.externalData) {
										...
										if ((t.arrays || t.defaults) && (n.dims = [], n.floatData = [], n.int32Data = [], n.stringData = [], n.int64Data = [], n.doubleData = [], n.uint64Data = [], n.externalData = []), t.defaults && (n.dataType = 0, n.segment = null, n.name = "", t.bytes === String ? n.rawData = "" : (n.rawData = [], t.bytes !== Array && (n.rawData = c.newBuffer(n.rawData))), n.docString = "", n.dataLocation = t.enums === String ? "DEFAULT" : 0), e.dims && e.dims.length) {
											n.dims = [];
											for (var r = 0; r < e.dims.length; ++r) "number" == typeof e.dims[r] ? n.dims[r] = t.longs === String ? String(e.dims[r]) : e.dims[r] : n.dims[r] = t.longs === String ? c.Long.prototype.toString.call(e.dims[r]) : t.longs === Number ? new c.LongBits(e.dims[r].low >>> 0, e.dims[r].high >>> 0).toNumber() : e.dims[r]
										}
										if (null != e.dataType && e.hasOwnProperty("dataType") && (n.dataType = e.dataType), null != e.segment && e.hasOwnProperty("segment") && (n.segment = l.onnx.TensorProto.Segment.toObject(e.segment, t)), e.floatData && e.floatData.length)
											for (n.floatData = [], r = 0; r < e.floatData.length; ++r) n.floatData[r] = t.json && !isFinite(e.floatData[r]) ? String(e.floatData[r]) : e.floatData[r];
										if (e.int32Data && e.int32Data.length)
											for (n.int32Data = [], r = 0; r < e.int32Data.length; ++r) n.int32Data[r] = e.int32Data[r];
										if (e.stringData && e.stringData.length)
											for (n.stringData = [], r = 0; r < e.stringData.length; ++r) n.stringData[r] = t.bytes === String ? c.base64.encode(e.stringData[r], 0, e.stringData[r].length) : t.bytes === Array ? Array.prototype.slice.call(e.stringData[r]) : e.stringData[r];
										if (e.int64Data && e.int64Data.length)
											for (n.int64Data = [], r = 0; r < e.int64Data.length; ++r) "number" == typeof e.int64Data[r] ? n.int64Data[r] = t.longs === String ? String(e.int64Data[r]) : e.int64Data[r] : n.int64Data[r] = t.longs === String ? c.Long.prototype.toString.call(e.int64Data[r]) : t.longs === Number ? new c.LongBits(e.int64Data[r].low >>> 0, e.int64Data[r].high >>> 0).toNumber() : e.int64Data[r];
										if (null != e.name && e.hasOwnProperty("name") && (n.name = e.name), null != e.rawData && e.hasOwnProperty("rawData") && (n.rawData = t.bytes === String ? c.base64.encode(e.rawData, 0, e.rawData.length) : t.bytes === Array ? Array.prototype.slice.call(e.rawData) : e.rawData), e.doubleData && e.doubleData.length)
											for (n.doubleData = [], r = 0; r < e.doubleData.length; ++r) n.doubleData[r] = t.json && !isFinite(e.doubleData[r]) ? String(e.doubleData[r]) : e.doubleData[r];
										if (e.uint64Data && e.uint64Data.length)
											for (n.uint64Data = [], r = 0; r < e.uint64Data.length; ++r) "number" == typeof e.uint64Data[r] ? n.uint64Data[r] = t.longs === String ? String(e.uint64Data[r]) : e.uint64Data[r] : n.uint64Data[r] = t.longs === String ? c.Long.prototype.toString.call(e.uint64Data[r]) : t.longs === Number ? new c.LongBits(e.uint64Data[r].low >>> 0, e.uint64Data[r].high >>> 0).toNumber(!0) : e.uint64Data[r];
										if (null != e.docString && e.hasOwnProperty("docString") && (n.docString = e.docString), e.externalData && e.externalData.length)
											for (n.externalData = [], r = 0; r < e.externalData.length; ++r) n.externalData[r] = l.onnx.StringStringEntryProto.toObject(e.externalData[r], t);
										return null != e.dataLocation && e.hasOwnProperty("dataLocation") && (n.dataLocation = t.enums === String ? l.onnx.TensorProto.DataLocation[e.dataLocation] : e.dataLocation), n
									}, e.prototype.toJSON = function() {
										return this.constructor.toObject(this, a.util.toJSONOptions)
									}, e.DataType = function() {
										var e = {},
										...
										return e.prototype.begin = c.Long ? c.Long.fromBits(0, 0, !1) : 0, e.prototype.end = c.Long ? c.Long.fromBits(0, 0, !1) : 0, e.create = function(t) {
											return new e(t)
										}, e.encode = function(e, t) {
											...
											e instanceof s || (e = s.create(e));
											for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.TensorProto.Segment; e.pos < n;) {
												var o = e.uint32();
												switch (o >>> 3) {
													case 1:
														r.begin = e.int64();
											...
											return "object" != typeof e || null === e ? "object expected" : null != e.begin && e.hasOwnProperty("begin") && !(c.isInteger(e.begin) || e.begin && c.isInteger(e.begin.low) && c.isInteger(e.begin.high)) ? "begin: integer|Long expected" : null != e.end && e.hasOwnProperty("end") && !(c.isInteger(e.end) || e.end && c.isInteger(e.end.low) && c.isInteger(e.end.high)) ? "end: integer|Long expected" : null
										}, e.fromObject = function(e) {
											if (e instanceof l.onnx.TensorProto.Segment) return e;
											var t = new l.onnx.TensorProto.Segment;
											return null != e.begin && (c.Long ? (t.begin = c.Long.fromValue(e.begin)).unsigned = !1 : "string" == typeof e.begin ? t.begin = parseInt(e.begin, 10) : "number" == typeof e.begin ? t.begin = e.begin : "object" == typeof e.begin && (t.begin = new c.LongBits(e.begin.low >>> 0, e.begin.high >>> 0).toNumber())), null != e.end && (c.Long ? (t.end = c.Long.fromValue(e.end)).unsigned = !1 : "string" == typeof e.end ? t.end = parseInt(e.end, 10) : "number" == typeof e.end ? t.end = e.end : "object" == typeof e.end && (t.end = new c.LongBits(e.end.low >>> 0, e.end.high >>> 0).toNumber())), t
										}, e.toObject = function(e, t) {
											t || (t = {});
											var n = {};
											if (t.defaults) {
												...
												c.Long ? (r = new c.Long(0, 0, !1), n.end = t.longs === String ? r.toString() : t.longs === Number ? r.toNumber() : r) : n.end = t.longs === String ? "0" : 0
											}
											return null != e.begin && e.hasOwnProperty("begin") && ("number" == typeof e.begin ? n.begin = t.longs === String ? String(e.begin) : e.begin : n.begin = t.longs === String ? c.Long.prototype.toString.call(e.begin) : t.longs === Number ? new c.LongBits(e.begin.low >>> 0, e.begin.high >>> 0).toNumber() : e.begin), null != e.end && e.hasOwnProperty("end") && ("number" == typeof e.end ? n.end = t.longs === String ? String(e.end) : e.end : n.end = t.longs === String ? c.Long.prototype.toString.call(e.end) : t.longs === Number ? new c.LongBits(e.end.low >>> 0, e.end.high >>> 0).toNumber() : e.end), n
										}, e.prototype.toJSON = function() {
											return this.constructor.toObject(this, a.util.toJSONOptions)
										}, e
									...
									return e.prototype.dim = c.emptyArray, e.create = function(t) {
										return new e(t)
									}, e.encode = function(e, t) {
										if (t || (t = u.create()), null != e.dim && e.dim.length)
											for (var n = 0; n < e.dim.length; ++n) l.onnx.TensorShapeProto.Dimension.encode(e.dim[n], t.uint32(10).fork()).ldelim();
										return t
									}, e.encodeDelimited = function(e, t) {
										return this.encode(e, t).ldelim()
									}, e.decode = function(e, t) {
										e instanceof s || (e = s.create(e));
										for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.TensorShapeProto; e.pos < n;) {
											var o = e.uint32();
											o >>> 3 == 1 ? (r.dim && r.dim.length || (r.dim = []), r.dim.push(l.onnx.TensorShapeProto.Dimension.decode(e, e.uint32()))) : e.skipType(7 & o)
										}
										return r
									}, e.decodeDelimited = function(e) {
										return e instanceof s || (e = new s(e)), this.decode(e, e.uint32())
										...
										if ((t.arrays || t.defaults) && (n.dim = []), e.dim && e.dim.length) {
											n.dim = [];
											for (var r = 0; r < e.dim.length; ++r) n.dim[r] = l.onnx.TensorShapeProto.Dimension.toObject(e.dim[r], t)
										}
										return n
									}, e.prototype.toJSON = function() {
										return this.constructor.toObject(this, a.util.toJSONOptions)
										...
										var t;
										return e.prototype.dimValue = c.Long ? c.Long.fromBits(0, 0, !1) : 0, e.prototype.dimParam = "", e.prototype.denotation = "", Object.defineProperty(e.prototype, "value", {
											get: c.oneOfGetter(t = ["dimValue", "dimParam"]),
											set: c.oneOfSetter(t)
										}), e.create = function(t) {
											return new e(t)
										}, e.encode = function(e, t) {
											...
											e instanceof s || (e = s.create(e));
											for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.TensorShapeProto.Dimension; e.pos < n;) {
												var o = e.uint32();
												switch (o >>> 3) {
													case 1:
														r.dimValue = e.int64();
											...
											if ("object" != typeof e || null === e) return "object expected";
											var t = {};
											if (null != e.dimValue && e.hasOwnProperty("dimValue") && (t.value = 1, !(c.isInteger(e.dimValue) || e.dimValue && c.isInteger(e.dimValue.low) && c.isInteger(e.dimValue.high)))) return "dimValue: integer|Long expected";
											if (null != e.dimParam && e.hasOwnProperty("dimParam")) {
												if (1 === t.value) return "value: multiple values";
												if (t.value = 1, !c.isString(e.dimParam)) return "dimParam: string expected"
											}
											return null != e.denotation && e.hasOwnProperty("denotation") && !c.isString(e.denotation) ? "denotation: string expected" : null
										}, e.fromObject = function(e) {
											if (e instanceof l.onnx.TensorShapeProto.Dimension) return e;
											var t = new l.onnx.TensorShapeProto.Dimension;
											return null != e.dimValue && (c.Long ? (t.dimValue = c.Long.fromValue(e.dimValue)).unsigned = !1 : "string" == typeof e.dimValue ? t.dimValue = parseInt(e.dimValue, 10) : "number" == typeof e.dimValue ? t.dimValue = e.dimValue : "object" == typeof e.dimValue && (t.dimValue = new c.LongBits(e.dimValue.low >>> 0, e.dimValue.high >>> 0).toNumber())), null != e.dimParam && (t.dimParam = String(e.dimParam)), null != e.denotation && (t.denotation = String(e.denotation)), t
										}, e.toObject = function(e, t) {
											t || (t = {});
											var n = {};
											return t.defaults && (n.denotation = ""), null != e.dimValue && e.hasOwnProperty("dimValue") && ("number" == typeof e.dimValue ? n.dimValue = t.longs === String ? String(e.dimValue) : e.dimValue : n.dimValue = t.longs === String ? c.Long.prototype.toString.call(e.dimValue) : t.longs === Number ? new c.LongBits(e.dimValue.low >>> 0, e.dimValue.high >>> 0).toNumber() : e.dimValue, t.oneofs && (n.value = "dimValue")), null != e.dimParam && e.hasOwnProperty("dimParam") && (n.dimParam = e.dimParam, t.oneofs && (n.value = "dimParam")), null != e.denotation && e.hasOwnProperty("denotation") && (n.denotation = e.denotation), n
										}, e.prototype.toJSON = function() {
											return this.constructor.toObject(this, a.util.toJSONOptions)
										}, e
									}(), e
									...
									return e.prototype.tensorType = null, e.prototype.denotation = "", Object.defineProperty(e.prototype, "value", {
										get: c.oneOfGetter(t = ["tensorType"]),
										set: c.oneOfSetter(t)
									}), e.create = function(t) {
										return new e(t)
									}, e.encode = function(e, t) {
										return t || (t = u.create()), null != e.tensorType && e.hasOwnProperty("tensorType") && l.onnx.TypeProto.Tensor.encode(e.tensorType, t.uint32(10).fork()).ldelim(), null != e.denotation && e.hasOwnProperty("denotation") && t.uint32(50).string(e.denotation), t
									}, e.encodeDelimited = function(e, t) {
										return this.encode(e, t).ldelim()
									}, e.decode = function(e, t) {
										e instanceof s || (e = s.create(e));
										for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.TypeProto; e.pos < n;) {
											var o = e.uint32();
											switch (o >>> 3) {
												case 1:
										...
										t || (t = {});
										var n = {};
										return t.defaults && (n.denotation = ""), null != e.tensorType && e.hasOwnProperty("tensorType") && (n.tensorType = l.onnx.TypeProto.Tensor.toObject(e.tensorType, t), t.oneofs && (n.value = "tensorType")), null != e.denotation && e.hasOwnProperty("denotation") && (n.denotation = e.denotation), n
									}, e.prototype.toJSON = function() {
										return this.constructor.toObject(this, a.util.toJSONOptions)
									}, e.Tensor = function() {
										function e(e) {
										...
										return e.prototype.elemType = 0, e.prototype.shape = null, e.create = function(t) {
											...
											return t || (t = u.create()), null != e.elemType && e.hasOwnProperty("elemType") && t.uint32(8).int32(e.elemType), null != e.shape && e.hasOwnProperty("shape") && l.onnx.TensorShapeProto.encode(e.shape, t.uint32(18).fork()).ldelim(), t
										}, e.encodeDelimited = function(e, t) {
											return this.encode(e, t).ldelim()
										}, e.decode = function(e, t) {
											e instanceof s || (e = s.create(e));
											for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.TypeProto.Tensor; e.pos < n;) {
												var o = e.uint32();
												switch (o >>> 3) {
													case 1:
														r.elemType = e.int32();
											...
											if ("object" != typeof e || null === e) return "object expected";
											if (null != e.elemType && e.hasOwnProperty("elemType") && !c.isInteger(e.elemType)) return "elemType: integer expected";
											...
											t || (t = {});
											var n = {};
											return t.defaults && (n.elemType = 0, n.shape = null), null != e.elemType && e.hasOwnProperty("elemType") && (n.elemType = e.elemType), null != e.shape && e.hasOwnProperty("shape") && (n.shape = l.onnx.TensorShapeProto.toObject(e.shape, t)), n
										}, e.prototype.toJSON = function() {
											return this.constructor.toObject(this, a.util.toJSONOptions)
										}, e
									}(), e
									...
									return e.prototype.domain = "", e.prototype.version = c.Long ? c.Long.fromBits(0, 0, !1) : 0, e.create = function(t) {
										return new e(t)
									}, e.encode = function(e, t) {
										...
										e instanceof s || (e = s.create(e));
										for (var n = void 0 === t ? e.len : e.pos + t, r = new l.onnx.OperatorSetIdProto; e.pos < n;) {
											var o = e.uint32();
											switch (o >>> 3) {
												case 1:
													r.domain = e.string();
										...
										return "object" != typeof e || null === e ? "object expected" : null != e.domain && e.hasOwnProperty("domain") && !c.isString(e.domain) ? "domain: string expected" : null != e.version && e.hasOwnProperty("version") && !(c.isInteger(e.version) || e.version && c.isInteger(e.version.low) && c.isInteger(e.version.high)) ? "version: integer|Long expected" : null
									}, e.fromObject = function(e) {
										if (e instanceof l.onnx.OperatorSetIdProto) return e;
										var t = new l.onnx.OperatorSetIdProto;
										return null != e.domain && (t.domain = String(e.domain)), null != e.version && (c.Long ? (t.version = c.Long.fromValue(e.version)).unsigned = !1 : "string" == typeof e.version ? t.version = parseInt(e.version, 10) : "number" == typeof e.version ? t.version = e.version : "object" == typeof e.version && (t.version = new c.LongBits(e.version.low >>> 0, e.version.high >>> 0).toNumber())), t
									}, e.toObject = function(e, t) {
										t || (t = {});
										var n = {};
										if (t.defaults)
										...
										return null != e.domain && e.hasOwnProperty("domain") && (n.domain = e.domain), null != e.version && e.hasOwnProperty("version") && ("number" == typeof e.version ? n.version = t.longs === String ? String(e.version) : e.version : n.version = t.longs === String ? c.Long.prototype.toString.call(e.version) : t.longs === Number ? new c.LongBits(e.version.low >>> 0, e.version.high >>> 0).toNumber() : e.version), n
									}, e.prototype.toJSON = function() {
										return this.constructor.toObject(this, a.util.toJSONOptions)
									}, e
								}(), i), e.exports = l
							...
							1408: function(e, t, n) {
								...
								u.create = f(), u.prototype._slice = o.Array.prototype.subarray || o.Array.prototype.slice, u.prototype.uint32 = (c = 4294967295, function() {
							...
							7714: function(e, t, n) {
								...
								var i = n(6919),
									...
									s = function() {
										...
										}, e.prototype.createSessionHandler = function(e, t) {
											return r(this, void 0, void 0, (function() {
												var n;
												return o(this, (function(r) {
													switch (r.label) {
														case 0:
															return n = new i.Session(t), "string" != typeof e ? [3, 2] : [4, n.loadModel(e)];
														case 1:
															return r.sent(), [3, 4];
														case 2:
															return [4, n.loadModel(e)];
														case 3:
															r.sent(), r.label = 4;
														case 4:
															return [2, new a.OnnxjsSessionHandler(n)]
													}
												}))
											}))
										}, e
									}();
								t.onnxjsBackend = new s
							},
							4200: function(e, t, n) {
								var r = this && this.__awaiter || function(e, t, n, r) {
										return new(n || (n = Promise))((function(o, i) {
								...
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.wasmBackend = t.initializeFlags = void 0;
								var i = n(2203),
									a = n(2174),
									s = n(5381),
									u = n(8022),
									c = n(2157),
									l = n(2306);
								t.initializeFlags = function() {
									if (("number" != typeof a.env.wasm.initTimeout || a.env.wasm.initTimeout < 0) && (a.env.wasm.initTimeout = 0), "boolean" != typeof a.env.wasm.simd && (a.env.wasm.simd = !0), "boolean" != typeof a.env.wasm.proxy && (a.env.wasm.proxy = !1), "number" != typeof a.env.wasm.numThreads || !Number.isInteger(a.env.wasm.numThreads) || a.env.wasm.numThreads <= 0) {
										var e = "undefined" == typeof navigator ? s.cpus().length : navigator.hardwareConcurrency;
										a.env.wasm.numThreads = 1
									}
								};
								var f = function() {
									function e() {}
									return e.prototype.init = function() {
										return r(this, void 0, void 0, (function() {
											return o(this, (function(e) {
												switch (e.label) {
													case 0:
														return t.initializeFlags(), [4, c.initWasm()];
													case 1:
														return e.sent(), [2]
												}
											}))
										...
										return r(this, void 0, void 0, (function() {
											...
											return o(this, (function(o) {
												switch (o.label) {
													case 0:
														return "string" != typeof e ? [3, 6] : "undefined" != typeof fetch ? [3, 2] : [4, u.promisify(i.readFile)(e)];
													case 1:
														return n = o.sent(), [3, 5];
													case 2:
														return [4, fetch(e)];
													...
													case 4:
														r = o.sent(), n = new Uint8Array(r), o.label = 5;
													case 5:
														return [3, 7];
													case 6:
														n = e, o.label = 7;
													case 7:
														return [4, (a = new l.OnnxruntimeWebAssemblySessionHandler).loadModel(n, t)];
													case 8:
														return o.sent(), [2, Promise.resolve(a)]
												}
											}))
										}))
									}, e
							...
							6018: function(e, t, n) {
								...
								var i = n(2174),
									a = n(7714),
									s = n(4200);
								i.registerBackend("webgl", a.onnxjsBackend, 1), i.registerBackend("wasm", s.wasmBackend, 2)
							},
							246: function(e, t) {
								Object.defineProperty(t, "__esModule", {
									value: !0
								...
								var n = function() {
									...
									return Object.defineProperty(e.prototype, "cacheKey", {
										get: function() {
											var e = this;
											return this._cacheKey || (this._cacheKey = Object.getOwnPropertyNames(this).sort().map((function(t) {
												return "" + e[t]
											})).join(";")), this._cacheKey
										},
										enumerable: !1,
								...
								t.createAttributeWithCacheKey = function(e) {
									return new n(e)
								}
							},
							7778: function(e, t, n) {
								...
								var o = n(1446),
									i = n(9395).onnxruntime.experimental.fbs,
									a = n(9162),
									s = n(2517),
									u = function() {
										function e(t) {
											...
											if (this._attributes = new Map, null != t) {
												try {
													for (var s = r(t), u = s.next(); !u.done; u = s.next()) {
														var c = u.value;
														c instanceof o.onnx.AttributeProto ? this._attributes.set(c.name, [e.getValue(c), e.getType(c)]) : c instanceof i.Attribute && this._attributes.set(c.name(), [e.getValue(c), e.getType(c)])
													}
												} catch (e) {
													n = {
														error: e
										...
										return e.prototype.set = function(e, t, n) {
										...
										}, e.prototype.getFloat = function(e, t) {
											return this.get(e, "float", t)
										}, e.prototype.getInt = function(e, t) {
											return this.get(e, "int", t)
										}, e.prototype.getString = function(e, t) {
											return this.get(e, "string", t)
										}, e.prototype.getTensor = function(e, t) {
											return this.get(e, "tensor", t)
										}, e.prototype.getFloats = function(e, t) {
											return this.get(e, "floats", t)
										}, e.prototype.getInts = function(e, t) {
											return this.get(e, "ints", t)
										}, e.prototype.getStrings = function(e, t) {
											return this.get(e, "strings", t)
										}, e.prototype.getTensors = function(e, t) {
											return this.get(e, "tensors", t)
										}, e.prototype.get = function(e, t, n) {
											var r = this._attributes.get(e);
											if (void 0 === r) {
											...
											var t = e instanceof o.onnx.AttributeProto ? e.type : e.type();
											switch (t) {
											...
											if (t === o.onnx.AttributeProto.AttributeType.INT && s.LongUtil.isLong(n)) return s.LongUtil.longToNumber(n);
											if (t === o.onnx.AttributeProto.AttributeType.INTS) {
												for (var r = n, u = new Array(r.length), c = 0; c < r.length; c++) {
													var l = r[c];
													u[c] = s.LongUtil.longToNumber(l)
												}
												return u
											}
											if (t === o.onnx.AttributeProto.AttributeType.TENSOR) return e instanceof o.onnx.AttributeProto ? a.Tensor.fromProto(n) : a.Tensor.fromOrtTensor(n);
											if (t === o.onnx.AttributeProto.AttributeType.TENSORS) {
												if (e instanceof o.onnx.AttributeProto) return n.map((function(e) {
													return a.Tensor.fromProto(e)
												}));
												if (e instanceof i.Attribute) return n.map((function(e) {
													return a.Tensor.fromOrtTensor(e)
												}))
											}
										...
										}, e.getValueNoCheckFromOrtFormat = function(e) {
											switch (e.type()) {
												...
												case i.AttributeType.INTS:
													for (var t = [], n = 0; n < e.intsLength(); n++) t.push(e.ints(n));
													return t;
												case i.AttributeType.STRINGS:
													var r = [];
													for (n = 0; n < e.stringsLength(); n++) r.push(e.strings(n));
													return r;
												case i.AttributeType.TENSORS:
													var o = [];
													for (n = 0; n < e.tensorsLength(); n++) o.push(e.tensors(n));
													return o;
												default:
							...
							7091: function(e, t, n) {
								...
								function u(e) {
									return r(this, void 0, void 0, (function() {
										...
										return o(this, (function(o) {
											switch (o.label) {
												case 0:
													return void 0 !== (n = t.backend)[e] && "initialize" in (a = n[e]) && "function" == typeof a.initialize && "createSessionHandler" in a && "function" == typeof a.createSessionHandler && "dispose" in a && "function" == typeof a.dispose ? (r = n[e], "object" == typeof(i = r.initialize()) && "then" in i ? [4, i] : [3, 2]) : [3, 3];
												case 1:
													i = o.sent(), o.label = 2;
												case 2:
													if (i) return s.set(e, r), [2, r];
													o.label = 3;
												case 3:
													return [2, void 0]
											}
								...
								}, t.resolveBackend = function e(t) {
									return r(this, void 0, void 0, (function() {
										var n, r, a, c, l, f, p, d, h;
										return o(this, (function(o) {
											switch (o.label) {
												case 0:
													return t ? [3, 1] : [2, e(["webgl"])];
												case 1:
													n = "string" == typeof t ? [t] : t, o.label = 2;
												case 2:
													o.trys.push([2, 7, 8, 9]), r = i(n), a = r.next(), o.label = 3;
												case 3:
													return a.done ? [3, 6] : (c = a.value, (l = s.get(c)) ? [2, l] : [4, u(c)]);
												case 4:
							...
							5038: function(e, t, n) {
								...
								var r = n(2174),
									...
									s = function() {
										function e() {}
										return Object.defineProperty(e.prototype, "contextId", {
											get: function() {
											...
											enumerable: !1,
											configurable: !0
										}), Object.defineProperty(e.prototype, "matmulMaxBatchSize", {
											get: function() {
											...
											enumerable: !1,
											configurable: !0
										}), Object.defineProperty(e.prototype, "textureCacheMode", {
											get: function() {
											...
											enumerable: !1,
											configurable: !0
										}), Object.defineProperty(e.prototype, "pack", {
											get: function() {
							...
							5107: function(e, t, n) {
								...
								var s = n(2517),
									...
									p = function(e) {
										...
										return o(t, e), t.prototype.getFunctions = function() {
											return i(i(i(i(i(i(i({}, this.offsetToCoords()), this.coordsToOffset()), this.toVec()), this.valueFrom()), this.getCommonUtilFuncs()), this.getInputsSamplingSnippets()), this.getOutputSamplingSnippet())
										}, t.prototype.getCustomTypes = function() {
											return {}
										}, t.prototype.offsetToCoords = function() {
											return {
												offsetToCoords: new u.GlslLibRoutine("\n      vec2 offsetToCoords(int offset, int width, int height) {\n        int t = offset / width;\n        int s = offset - t*width;\n        vec2 coords = (vec2(s,t) + vec2(0.5,0.5)) / vec2(width, height);\n        return coords;\n      }\n      ")
											}
										}, t.prototype.coordsToOffset = function() {
											return {
												coordsToOffset: new u.GlslLibRoutine("\n      int coordsToOffset(vec2 coords, int width, int height) {\n        float s = coords.s * float(width);\n        float t = coords.t * float(height);\n        int offset = int(t) * width + int(s);\n        return offset;\n      }\n      ")
											}
										}, t.prototype.getOutputSamplingSnippet = function() {
											var e = this.context.outputTextureLayout;
											return e.isPacked ? this.getPackedOutputSamplingSnippet(e) : this.getUnpackedOutputSamplingSnippet(e)
										}, t.prototype.getPackedOutputSamplingSnippet = function(e) {
											var t = e.unpackedShape,
												n = [e.width, e.height],
												r = {},
												o = "getOutputCoords";
											switch (t.length) {
												case 0:
													r[o] = this.getOutputScalarCoords();
													break;
												case 1:
													r[o] = this.getOutputPacked1DCoords(t, n);
													break;
												case 2:
													r[o] = this.getOutputPacked2DCoords(t, n);
													break;
												case 3:
													r[o] = this.getOutputPacked3DCoords(t, n);
													break;
												default:
													r[o] = this.getOutputPackedNDCoords(t, n)
											}
											var i = "\n      void setOutput(vec4 val) {\n        " + c.getGlsl(this.context.glContext.version).output + " = val;\n      }\n    ";
											return r.floatTextureSetRGBA = new u.GlslLibRoutine(i), r
										}, t.prototype.getUnpackedOutputSamplingSnippet = function(e) {
											var t = e.unpackedShape,
												n = [e.width, e.height],
												r = {},
												o = "getOutputCoords";
											switch (t.length) {
												case 0:
													...
													break;
												case 1:
													r[o] = this.getOutputUnpacked1DCoords(t, n);
													break;
												case 2:
													r[o] = this.getOutputUnpacked2DCoords(t, n);
													break;
												case 3:
													r[o] = this.getOutputUnpacked3DCoords(t, n);
													break;
												case 4:
													r[o] = this.getOutputUnpacked4DCoords(t, n);
													break;
												case 5:
													r[o] = this.getOutputUnpacked5DCoords(t, n);
													break;
												case 6:
													r[o] = this.getOutputUnpacked6DCoords(t, n);
													break;
												default:
											...
											return r.floatTextureSetR = new u.GlslLibRoutine(i), r
										}, t.prototype.getOutputScalarCoords = function() {
											return new u.GlslLibRoutine("\n      int getOutputCoords() {\n        return 0;\n      }\n    ")
										}, t.prototype.getOutputPacked1DCoords = function(e, t) {
											var n = t,
												r = "";
											return 1 === n[0] ? (r = "\n          int getOutputCoords() {\n            return 2 * int(TexCoords.y * " + n[1] + ".0);\n          }\n        ", new u.GlslLibRoutine(r)) : 1 === n[1] ? (r = "\n          int getOutputCoords() {\n            return 2 * int(TexCoords.x * " + n[0] + ".0);\n          }\n        ", new u.GlslLibRoutine(r)) : (r = "\n        int getOutputCoords() {\n          ivec2 resTexRC = ivec2(TexCoords.xy *\n                                 vec2(" + n[0] + ", " + n[1] + "));\n          return 2 * (resTexRC.y * " + n[0] + " + resTexRC.x);\n        }\n      ", new u.GlslLibRoutine(r))
										}, t.prototype.getOutputPacked2DCoords = function(e, t) {
											var n = "";
											if (s.ArrayUtil.arraysEqual(e, t)) return n = "\n        ivec2 getOutputCoords() {\n          return 2 * ivec2(TexCoords.xy * vec2(" + t[0] + ", " + t[1] + "));\n        }\n      ", new u.GlslLibRoutine(n);
											var r = t,
												o = Math.ceil(e[1] / 2);
											return n = "\n        ivec2 getOutputCoords() {\n          ivec2 resTexRC = ivec2(TexCoords.xy *\n                                vec2(" + r[0] + ", " + r[1] + "));\n\n          int index = resTexRC.y * " + r[0] + " + resTexRC.x;\n\n          // reverse r and c order for packed texture\n          int r = imod(index, " + o + ") * 2;\n          int c = 2 * (index / " + o + ");\n\n          return ivec2(r, c);\n        }\n      ", new u.GlslLibRoutine(n)
										}, t.prototype.getOutputPacked3DCoords = function(e, t) {
											var n = [t[0], t[1]],
												r = Math.ceil(e[2] / 2),
												o = r * Math.ceil(e[1] / 2),
												i = "\n        ivec3 getOutputCoords() {\n          ivec2 resTexRC = ivec2(TexCoords.xy *\n                                vec2(" + n[0] + ", " + n[1] + "));\n          int index = resTexRC.y * " + n[0] + " + resTexRC.x;\n\n          int b = index / " + o + ";\n          index -= b * " + o + ";\n\n          // reverse r and c order for packed texture\n          int r = imod(index, " + r + ") * 2;\n          int c = 2 * (index / " + r + ");\n\n          return ivec3(b, r, c);\n        }\n      ";
											return new u.GlslLibRoutine(i)
										}, t.prototype.getOutputPackedNDCoords = function(e, t) {
											for (var n = [t[0], t[1]], r = Math.ceil(e[e.length - 1] / 2), o = r * Math.ceil(e[e.length - 2] / 2), i = o, a = "", s = "b, r, c", c = 2; c < e.length - 1; c++) a = "\n      int b" + c + " = index / " + (i *= e[e.length - c - 1]) + ";\n      index -= b" + c + " * " + i + ";\n    " + a, s = "b" + c + ", " + s;
											var l = "\n      ivec" + e.length + " getOutputCoords() {\n        ivec2 resTexRC = ivec2(TexCoords.xy *\n                              vec2(" + n[0] + ", " + n[1] + "));\n        int index = resTexRC.y * " + n[0] + " + resTexRC.x;\n\n        " + a + "\n\n        int b = index / " + o + ";\n        index -= b * " + o + ";\n\n        // reverse r and c order for packed texture\n        int r = imod(index, " + r + ") * 2;\n        int c = 2 * (index / " + r + ");\n\n        return ivec" + e.length + "(" + s + ");\n      }\n    ";
											return new u.GlslLibRoutine(l)
										}, t.prototype.getOutputUnpacked1DCoords = function(e, t) {
											var n = "\n        int getOutputCoords() {\n          ivec2 resTexRC = ivec2(TexCoords.xy *\n                                vec2(" + t[0] + ", " + t[1] + "));\n          return resTexRC.y * " + t[0] + " + resTexRC.x;\n        }\n      ";
											return new u.GlslLibRoutine(n)
										}, t.prototype.getOutputUnpacked2DCoords = function(e, t) {
											var n = "\n        ivec2 getOutputCoords() {\n          ivec2 resTexRC = ivec2(TexCoords.xy *\n                                vec2(" + t[0] + ", " + t[1] + "));\n          int index = resTexRC.y * " + t[0] + " + resTexRC.x;\n          int r = index / " + e[1] + ";\n          int c = index - r * " + e[1] + ";\n          return ivec2(r, c);\n        }\n      ";
											return new u.GlslLibRoutine(n)
										}, t.prototype.getOutputUnpacked3DCoords = function(e, t) {
											var n, r = e.length,
												o = null;
											r < 2 && (o = []), (o = new Array(r - 1))[r - 2] = e[r - 1];
											for (var i = r - 3; i >= 0; --i) o[i] = o[i + 1] * e[i + 1];
											var a = ["r", "c", "d"],
												s = o.map((function(e, t) {
													return "int " + a[t] + " = index / " + e + "; " + (t === o.length - 1 ? "int " + a[t + 1] + " = index - " + a[t] + " * " + e : "index -= " + a[t] + " * " + e) + ";"
												})).join("");
											return n = "\n        ivec3 getOutputCoords() {\n          ivec2 resTexRC = ivec2(TexCoords.xy *\n                                vec2(" + t[0] + ", " + t[1] + "));\n          int index = resTexRC.y * " + t[0] + " + resTexRC.x;\n          " + s + "\n          return ivec3(r, c, d);\n        }\n      ", new u.GlslLibRoutine(n)
										}, t.prototype.getOutputUnpacked4DCoords = function(e, t) {
											var n, r = e.length,
												o = null;
											r < 2 && (o = []), (o = new Array(r - 1))[r - 2] = e[r - 1];
											for (var i = r - 3; i >= 0; --i) o[i] = o[i + 1] * e[i + 1];
										...
										}, t.prototype.getOutputUnpacked5DCoords = function(e, t) {
											var n, r = e.length,
												o = null;
											r < 2 && (o = []), (o = new Array(r - 1))[r - 2] = e[r - 1];
											for (var i = r - 3; i >= 0; --i) o[i] = o[i + 1] * e[i + 1];
										...
										}, t.prototype.getOutputUnpacked6DCoords = function(e, t) {
											var n, r = e.length,
												o = null;
											r < 2 && (o = []), (o = new Array(r - 1))[r - 2] = e[r - 1];
											for (var i = r - 3; i >= 0; --i) o[i] = o[i + 1] * e[i + 1];
											var a = ["r", "c", "d", "d2", "d3", "d4"],
												s = o.map((function(e, t) {
													return "int " + a[t] + " = index / " + e + "; " + (t === o.length - 1 ? "int " + a[t + 1] + " = index - " + a[t] + " * " + e : "index -= " + a[t] + " * " + e) + ";"
												})).join("");
											return n = "\n     ivec6 getOutputCoords() {\n         ivec2 resTexRC = ivec2(TexCoords.xy *\n                               vec2(" + t[0] + ", " + t[1] + "));\n         int index = resTexRC.y * " + t[0] + " + resTexRC.x;\n         " + s + "\n         return ivec6(r, c, d, d2, d3, d4);\n       }\n     ", new u.GlslLibRoutine(n)
										}, t.prototype.getCommonUtilFuncs = function() {
											var e = {},
												t = "uvFromFlat";
											e[t] = new u.GlslLibRoutine("\n    vec2 uvFromFlat(int texNumR, int texNumC, int index) {\n      int texC = index / texNumR;\n      int texR = index - texC * texNumR;\n      // TODO: swap texR, texC order in following function so row is corresponding to u and column is corresponding to\n      //       v.\n      return (vec2(texR, texC) + halfCR) / vec2(texNumR, texNumC);\n    }\n    "), e[t = "packedUVfrom1D"] = new u.GlslLibRoutine("\n      vec2 packedUVfrom1D(int texNumR, int texNumC, int index) {\n        int texelIndex = index / 2;\n        int texR = texelIndex / texNumC;\n        int texC = texelIndex - texR * texNumC;\n        return (vec2(texC, texR) + halfCR) / vec2(texNumC, texNumR);\n      }\n      "), e[t = "packedUVfrom2D"] = new u.GlslLibRoutine("\n      vec2 packedUVfrom2D(int texNumR, int texNumC, int texelsInLogicalRow, int row, int col) {\n        int texelIndex = (row / 2) * texelsInLogicalRow + (col / 2);\n        int texR = texelIndex / texNumC;\n        int texC = texelIndex - texR * texNumC;\n        return (vec2(texC, texR) + halfCR) / vec2(texNumC, texNumR);\n      }\n      "), e[t = "packedUVfrom3D"] = new u.GlslLibRoutine("\n      vec2 packedUVfrom3D(int texNumR, int texNumC,\n          int texelsInBatch, int texelsInLogicalRow, int b,\n          int row, int col) {\n        int index = b * texelsInBatch + (row / 2) * texelsInLogicalRow + (col / 2);\n        int texR = index / texNumC;\n        int texC = index - texR * texNumC;\n        return (vec2(texC, texR) + halfCR) / vec2(texNumC, texNumR);\n      }\n      "), t = "sampleTexture";
											var n = c.getGlsl(this.context.glContext.version);
											return e[t] = new u.GlslLibRoutine("\n        float sampleTexture(sampler2D textureSampler, vec2 uv) {\n            return " + n.texture2D + "(textureSampler, uv).r;\n        }"), e
										}, t.prototype.getInputsSamplingSnippets = function() {
											var e = this,
												t = {},
												n = this.context.outputTextureLayout;
											return this.context.programInfo.inputNames.forEach((function(r, o) {
												var i = e.context.inputTextureLayouts[o],
													a = f.generateShaderFuncNameFromInputSamplerName(r);
												i.isPacked ? t[a] = e.getPackedSamplerFromInput(a, r, i) : t[a] = e.getUnpackedSamplerFromInput(a, r, i);
												var s = f.generateShaderFuncNameFromInputSamplerNameAtOutCoords(r);
												i.unpackedShape.length <= n.unpackedShape.length && (i.isPacked ? t[s] = e.getPackedSamplerAtOutputCoords(s, i, n, r) : t[s] = e.getUnpackedSamplerAtOutputCoords(s, i, n, r))
											})), t
										}, t.prototype.getPackedSamplerAtOutputCoords = function(e, t, n, r) {
											var o, i, a = t.unpackedShape,
												c = n.unpackedShape,
												l = r,
												p = f.generateShaderFuncNameFromInputSamplerName(l),
												d = a.length,
												h = c.length,
												g = s.BroadcastUtil.getBroadcastDims(a, c),
												b = f.getCoordsDataType(h),
												y = h - d,
												m = f.getGlChannels();
											o = 0 === d ? "" : h < 2 && g.length >= 1 ? "coords = 0;" : g.map((function(e) {
												return "coords." + m[e + y] + " = 0;"
											})).join("\n"), i = h < 2 && d > 0 ? "coords" : a.map((function(e, t) {
												return "coords." + m[t + y]
											})).join(", ");
											var v = "return outputValue;",
												_ = 1 === s.ShapeUtil.size(a),
												w = 1 === s.ShapeUtil.size(c);
											if (1 !== d || _ || w) {
												if (_ && !w) v = 1 === h ? "\n          return vec4(outputValue.x, outputValue.x, 0., 0.);\n        " : "\n          return vec4(outputValue.x);\n        ";
												else if (g.length) {
													var x = d - 2,
														T = d - 1;
													g.indexOf(x) > -1 && g.indexOf(T) > -1 ? v = "return vec4(outputValue.x);" : g.indexOf(x) > -1 ? v = "return vec4(outputValue.x, outputValue.y, outputValue.x, outputValue.y);" : g.indexOf(T) > -1 && (v = "return vec4(outputValue.xx, outputValue.zz);")
												}
											} else v = "\n        return vec4(outputValue.xy, outputValue.xy);\n      ";
											var S = "\n      vec4 " + e + "() {\n        " + b + " coords = getOutputCoords();\n        \n        int lastDim = coords." + m[h - 1] + ";\n        coords." + m[h - 1] + " = coords." + m[h - 2] + ";\n        coords." + m[h - 2] + " = lastDim;\n      \n        " + o + "\n        vec4 outputValue = " + p + "(" + i + ");\n        " + v + "\n      }\n    ";
											return new u.GlslLibRoutine(S, ["coordinates.getOutputCoords"])
										}, t.prototype.getUnpackedSamplerAtOutputCoords = function(e, t, n, r) {
											var o = [n.width, n.height],
												i = [t.width, t.height],
												a = t.unpackedShape.length,
												c = n.unpackedShape.length,
												l = t.unpackedShape,
												p = n.unpackedShape,
												d = f.generateShaderFuncNameFromInputSamplerName(r);
											if (a === c && s.ArrayUtil.arraysEqual(i, o)) {
												var h = "\n          float " + e + "() {\n            return sampleTexture(" + r + ", TexCoords);\n          }\n        ";
												return new u.GlslLibRoutine(h, ["coordinates.sampleTexture"])
											}
											var g = f.getCoordsDataType(c),
												b = s.BroadcastUtil.getBroadcastDims(l, p),
												y = c - a,
												m = f.getGlChannels(),
												v = "\n        float " + e + "() {\n          " + g + " coords = getOutputCoords();\n          " + (0 === a ? "" : c < 2 && b.length >= 1 ? "coords = 0;" : b.map((function(e) {
													return "coords." + m[e + y] + " = 0;"
												})).join("\n")) + "\n          return " + d + "(" + (c < 2 && a > 0 ? "coords" : t.unpackedShape.map((function(e, t) {
													return "coords." + m[t + y]
												})).join(", ")) + ");\n        }\n      ";
											return new u.GlslLibRoutine(v, ["coordinates.getOutputCoords"])
										}, t.prototype.getPackedSamplerFromInput = function(e, t, n) {
										...
										}, t.prototype.getUnpackedSamplerFromInput = function(e, t, n) {
											var r = n.unpackedShape;
											switch (r.length) {
												case 0:
										...
										}, t.prototype.getPackedSamplerScalar = function(e, t) {
											var n = "\n          vec4 " + e + "() {\n            return " + c.getGlsl(this.context.glContext.version).texture2D + "(" + t + ", halfCR);\n          }\n        ";
											return new u.GlslLibRoutine(n)
										}, t.prototype.getPackedSampler1D = function(e, t, n) {
											var r = [n.width, n.height],
												o = [r[1], r[0]],
												i = c.getGlsl(this.context.glContext.version),
												a = "vec4 " + e + "(int index) {\n      vec2 uv = packedUVfrom1D(\n      " + o[0] + ", " + o[1] + ", index);\n      return " + i.texture2D + "(" + t + ", uv);\n    }";
											return new u.GlslLibRoutine(a, ["coordinates.packedUVfrom1D"])
										}, t.prototype.getPackedSampler2D = function(e, t, n) {
											var r = n.unpackedShape,
												o = [n.width, n.height],
												i = c.getGlsl(this.context.glContext.version),
												a = o[0],
												l = o[1];
											if (null != o && s.ArrayUtil.arraysEqual(r, o)) {
												var f = "vec4 " + e + "(int row, int col) {\n        vec2 uv = (vec2(col, row) + halfCR) / vec2(" + l + ".0, " + a + ".0);\n        return " + i.texture2D + "(" + t + ", uv);\n      }";
												return new u.GlslLibRoutine(f)
											}
											var p = o,
												d = Math.ceil(r[1] / 2),
												h = "vec4 " + e + "(int row, int col) {\n      vec2 uv = packedUVfrom2D(" + p[1] + ", " + p[0] + ", " + d + ", row, col);\n      return " + i.texture2D + "(" + t + ", uv);\n    }";
											return new u.GlslLibRoutine(h, ["coordinates.packedUVfrom2D"])
										}, t.prototype.getPackedSampler3D = function(e, t, n) {
											var r = n.unpackedShape,
												o = [n.width, n.height],
												i = [o[0], o[1]],
												a = c.getGlsl(this.context.glContext.version);
											if (1 === r[0]) {
												var s = r.slice(1),
													l = f.squeezeInputShape(r, s),
													p = JSON.parse(JSON.stringify(n));
												p.unpackedShape = l;
												var d = this.getPackedSamplerFromInput(e, t, p),
													h = d.routineBody + "\n      vec4 " + e + "(int b, int row, int col) {\n        return " + e + "(" + f.getSqueezedParams(["b", "row", "col"], [1, 2]) + ");\n      } ";
												return new u.GlslLibRoutine(h, d.dependencies)
											}
											var g = i[0],
												b = i[1],
												y = Math.ceil(r[2] / 2),
												m = "vec4 " + e + "(int b, int row, int col) {\n      vec2 uv = packedUVfrom3D(\n        " + b + ", " + g + ", " + y * Math.ceil(r[1] / 2) + ", " + y + ", b, row, col);\n      return " + a.texture2D + "(" + t + ", uv);}";
											return new u.GlslLibRoutine(m, ["coordinates.packedUVfrom3D"])
										}, t.prototype.getPackedSamplerND = function(e, t, n) {
											for (var r = n.unpackedShape, o = r.length, i = [n.width, n.height], a = c.getGlsl(this.context.glContext.version), s = [i[0], i[1]], l = s[1], f = s[0], p = Math.ceil(r[o - 1] / 2), d = p * Math.ceil(r[o - 2] / 2), h = "int b, int row, int col", g = "b * " + d + " + (row / 2) * " + p + " + (col / 2)", b = 2; b < o - 1; b++) h = "int b" + b + ", " + h, g = "b" + b + " * " + (d *= r[o - b - 1]) + " + " + g;
											var y = "vec4 " + e + "(" + h + ") {\n      int index = " + g + ";\n      int texR = index / " + f + ";\n      int texC = index - texR * " + f + ";\n      vec2 uv = (vec2(texC, texR) + halfCR) / vec2(" + f + ", " + l + ");\n      return " + a.texture2D + "(" + t + ", uv);\n    }";
											return new u.GlslLibRoutine(y)
										}, t.prototype.getUnpackedSamplerScalar = function(e, t, n) {
											var r = a([n.width, n.height], 2),
												o = r[0],
												i = r[1];
											if (1 === o && 1 === i) {
												var s = "\n          float " + e + "() {\n            return sampleTexture(" + t + ", halfCR);\n          }\n        ";
												return new u.GlslLibRoutine(s, ["coordinates.sampleTexture"])
											}
											var c = "\n        float " + e + "() {\n          int offset_" + t + " = coordsToOffset(TexCoords, " + o + ", " + i + ");\n          vec2 uv = uvFromFlat(" + o + ", " + i + ", offset_" + t + ");\n          return sampleTexture(" + t + ", uv);\n        }\n      ";
											return new u.GlslLibRoutine(c, ["coordinates.uvFromFlat", "coordinates.sampleTexture", "coordinates.coordsToOffset"])
										}, t.prototype.getUnpackedSampler1D = function(e, t, n) {
											var r = n.width,
												o = n.height;
											if (1 === o && 1 === r) {
												var i = "\n        float " + e + "(int index) {\n          return sampleTexture(" + t + ", halfCR);\n        }\n      ";
												return new u.GlslLibRoutine(i, ["coordinates.sampleTexture"])
											}
											if (1 === o) {
												var a = "\n          float " + e + "(int index) {\n            vec2 uv = vec2((float(index) + 0.5) / " + r + ".0, 0.5);\n            return sampleTexture(" + t + ", uv);\n          }\n        ";
												return new u.GlslLibRoutine(a, ["coordinates.sampleTexture"])
											}
											if (1 === r) {
											...
											return new u.GlslLibRoutine(c, ["coordinates.uvFromFlat", "coordinates.sampleTexture"])
										}, t.prototype.getUnpackedSampler2D = function(e, t, n) {
											var r = n.unpackedShape,
												o = [n.height, n.width];
											if (null != o && s.ArrayUtil.arraysEqual(r, o)) {
											...
											var a = l.squeezeShape(r),
												c = a.newShape,
												p = a.keptDims,
												d = c;
											if (d.length < r.length) {
												var h = f.squeezeInputShape(r, d),
													g = JSON.parse(JSON.stringify(n));
												g.unpackedShape = h;
												var b = "\n          " + this.getUnpackedSamplerFromInput(e, t, g).routineBody + "\n          float " + e + "(int row, int col) {\n            return " + e + "(" + f.getSqueezedParams(["col", "row"], p) + ");\n          }\n        ";
												return new u.GlslLibRoutine(b, ["coordinates.sampleTexture"])
											}
											var y = o[1],
												m = o[0];
											if (1 === m) {
												...
												return new u.GlslLibRoutine(v, ["coordinates.sampleTexture", "coordinates.coordsToOffset"])
											}
											if (1 === y) {
												var _ = "\n          float " + e + "(int row, int col) {\n            int offset_" + t + " = coordsToOffset(TexCoords, " + y + ", " + m + ");\n            float index = dot(vec3(row, col, offset_" + t + "), vec3(" + r[1] + ", 1, 1));\n            vec2 uv = vec2((index + 0.5) / " + m + ".0, 0.5);\n            return sampleTexture(" + t + ", uv);\n          }\n        ";
												return new u.GlslLibRoutine(_, ["coordinates.sampleTexture", "coordinates.coordsToOffset"])
											}
											var w = "\n        float " + e + "(int row, int col) {\n          int index = col * " + r[1] + " + row;\n          vec2 uv = uvFromFlat(" + y + ", " + m + ", index);\n          return sampleTexture(" + t + ", uv);\n        }\n      ";
											return new u.GlslLibRoutine(w, ["coordinates.uvFromFlat", "coordinates.sampleTexture", "coordinates.coordsToOffset"])
										}, t.prototype.getUnpackedSampler3D = function(e, t, n) {
											var r = n.unpackedShape,
												o = r[1] * r[2],
												i = r[2],
												a = l.squeezeShape(r),
											...
											if (p.length < r.length) {
												var d = f.squeezeInputShape(r, p),
													h = JSON.parse(JSON.stringify(n));
												h.unpackedShape = d;
												var g = this.getUnpackedSamplerFromInput(e, t, h),
													b = c.reverse(),
													y = "\n          " + g.routineBody + "\n          float " + e + "(int batch, int row, int col) {\n            return " + e + "(" + f.getSqueezedParams(["batch", "col", "row"], b) + ");\n          }\n        ";
												return new u.GlslLibRoutine(y, g.dependencies)
											}
											var m = "\n          float " + e + "(int depth, int row, int col) {\n            // Explicitly use integer operations as dot() only works on floats.\n            int index = depth * " + o + " + col * " + i + " + row;\n            vec2 uv = uvFromFlat(" + n.width + ", " + n.height + ", index);\n            return sampleTexture(" + t + ", uv);\n          }\n      ";
											return new u.GlslLibRoutine(m, ["coordinates.uvFromFlat", "coordinates.sampleTexture", "coordinates.coordsToOffset"])
										}, t.prototype.getUnpackedSampler4D = function(e, t, n) {
											var r = n.unpackedShape,
												o = r[3],
												i = r[2] * o,
												a = "\n        float " + e + "(int row, int col, int depth, int depth2) {\n          int index = row * " + r[1] * i + " + col * " + i + " +\n              depth2 * " + o + " + depth;\n          vec2 uv = uvFromFlat(" + n.width + ", " + n.height + ", index);\n          return sampleTexture(" + t + ", uv);\n        }\n      ";
											return new u.GlslLibRoutine(a, ["coordinates.uvFromFlat", "coordinates.sampleTexture"])
										}, t.prototype.getUnpackedSampler5D = function(e, t, n) {
											var r = n.unpackedShape,
												o = r[4],
												i = r[3] * o,
												a = r[2] * i,
												...
												d = c.keptDims;
											if (p.length < r.length) {
												var h = f.squeezeInputShape(r, p),
													g = JSON.parse(JSON.stringify(n));
												g.unpackedShape = h;
												var b = "\n          " + this.getUnpackedSamplerFromInput(e, t, g).routineBody + "\n          float " + e + "(int row, int col, int depth, int depth2, int depth3) {\n            return " + e + "(" + f.getSqueezedParams(["row", "col", "depth", "depth2", "depth3"], d) + ");\n          }\n        ";
												return new u.GlslLibRoutine(b, ["coordinates.sampleTexture", "coordinates.uvFromFlat"])
											}
											var y = "\n        float " + e + "(int row, int col, int depth, int depth2, int depth3) {\n          int index = row * " + s + " + col * " + a + " + depth * " + i + " +\n          depth3 * " + o + " + depth2;\n          vec2 uv = uvFromFlat(" + n.width + ", " + n.height + ", index);\n          return sampleTexture(" + t + ", uv);\n        }\n      ";
											return new u.GlslLibRoutine(y, ["coordinates.sampleTexture", "coordinates.uvFromFlat"])
										}, t.prototype.getUnpackedSampler6D = function(e, t, n) {
											var r = n.unpackedShape,
												o = r[5],
												i = r[4] * o,
												a = r[3] * i,
											...
											return new u.GlslLibRoutine(m, ["coordinates.uvFromFlat", "coordinates.sampleTexture", "coordinates.coordsToOffset"])
										}, t.prototype.toVec = function() {
											for (var e = this.context.outputTextureLayout, t = e.shape.length, n = e.strides, r = e.width, o = e.height, i = [], a = 0; a < t - 1; ++a) i.push("\n        c[" + a + "] = offset / " + n[a] + ";"), i.push("\n        offset -= c[" + a + "] * " + n[a] + ";");
											i.push("\n        c[" + (t - 1) + "] = offset;");
											var s = "\n      void toVec(vec2 texCoords, out int c[" + t + "]) {\n        int offset = coordsToOffset(texCoords, " + r + ", " + o + ");\n        " + i.join("") + "\n      }\n      void toVec(int offset, out int c[" + t + "]) {\n        " + i.join("") + "\n      }\n    ";
											return {
												toVec: new u.GlslLibRoutine(s, ["coordinates.coordsToOffset"])
											}
										}, t.prototype.valueFrom = function() {
											var e = this,
												t = {};
											return this.context.programInfo.inputNames.forEach((function(n, r) {
												var o = e.context.inputTextureLayouts[r],
													i = (o.unpackedShape.length > 0 ? o.unpackedShape : o.shape).length,
													a = "_" + n;
												t[a] = new u.GlslLibRoutine(e.getValueFromSingle(n, i, o.width, o.height, !1), ["shapeUtils.indicesToOffset" + a, "coordinates.offsetToCoords", "fragcolor.getColorAsFloat"]), t[a += "_T"] = new u.GlslLibRoutine(e.getValueFromSingle(n, i, o.width, o.height, !0), ["shapeUtils.indicesToOffset" + a, "coordinates.offsetToCoords", "fragcolor.getColorAsFloat"])
											})), t
										}, t.prototype.getValueFromSingle = function(e, t, n, r, o) {
											var i = "_" + e;
										...
										}, t.prototype.getPackedValueFrom = function(e, t, n, r, o) {
											var i = "_" + e + "_Pack";
							...
							8520: function(e, t) {
								...
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.TopologicalSortGlslRoutines = t.GlslLibRoutineNode = t.GlslLibRoutine = t.GlslLib = t.GlslContext = t.FunctionType = void 0, (n = t.FunctionType || (t.FunctionType = {}))[n.ValueBased = 0] = "ValueBased", n[n.Positional = 1] = "Positional", t.GlslContext = function(e, t, n, r) {
									this.glContext = e, this.programInfo = t, this.inputTextureLayouts = n, this.outputTextureLayout = r
								}, t.GlslLib = function(e) {
									this.context = e
								}, t.GlslLibRoutine = function(e, t) {
								...
								t.GlslLibRoutineNode = r;
								var o = function() {
									function e() {}
									return e.returnOrderedNodes = function(e) {
									...
									}, e.createOrderedNodes = function(e, t, n, r) {
										for (var o = 0; o < e.length; ++o) this.dfsTraverse(e[o], t, n, r)
									}, e.dfsTraverse = function(e, t, n, r) {
										if (e && !n.has(e.name)) {
											...
											if (o && o.length > 0)
												for (var i = 0; i < o.length; ++i) this.dfsTraverse(o[i], t, n, r);
											r.push(e), n.add(e.name), t.delete(e.name)
										}
									}, e
								}();
								t.TopologicalSortGlslRoutines = o
							},
							7341: function(e, t, n) {
								var r, o = this && this.__extends || (r = function(e, t) {
										return (r = Object.setPrototypeOf || {
							...
							9894: function(e, t, n) {
								...
								var a = n(8520),
									...
									u = function(e) {
										...
										return o(t, e), t.prototype.getFunctions = function() {
											return i(i({}, this.setFragColor()), this.getColorAsFloat())
										}, t.prototype.getCustomTypes = function() {
											return {}
										}, t.prototype.setFragColor = function() {
											var e = s.getGlsl(this.context.glContext.version);
											return {
												setFragColor: new a.GlslLibRoutine("\n        void setFragColor(float value) {\n            " + e.output + " = encode(value);\n        }\n        ", ["encoding.encode"])
											}
										}, t.prototype.getColorAsFloat = function() {
											return {
												getColorAsFloat: new a.GlslLibRoutine("\n        float getColorAsFloat(vec4 color) {\n            return decode(color);\n        }\n        ", ["encoding.decode"])
											}
										}, t
									}(a.GlslLib);
								t.FragColorGlslLib = u
							},
							2848: function(e, t) {
								Object.defineProperty(t, "__esModule", {
									value: !0
								...
								t.replaceInlines = function(e) {
									for (var t, r = {}; null !== (t = n.exec(e));) {
										var o = t[3].split(",").map((function(e) {
											var t = e.trim().split(" ");
											return t && 2 === t.length ? {
												type: t[0],
												name: t[1]
									...
									for (var i in r)
										for (var a = "(\\w+)?\\s+([_0-9a-zA-Z]+)\\s+=\\s+__FUNC__\\((.*)\\)\\s*;".replace("__FUNC__", i), s = new RegExp(a, "gm"), u = function() {
												var n = t[1],
													o = t[2],
													a = t[3].split(","),
													s = n ? n + " " + o + ";" : "",
													u = r[i].body,
													c = "";
												r[i].params.forEach((function(e, t) {
													e && (c += e.type + " " + e.name + " = " + a[t] + ";\n")
												}));
												var l = "\n      " + s + "\n      {\n        " + (u = (u = c + "\n " + u).replace("return", o + " = ")) + "\n      }\n      ";
												e = e.replace(t[0], l)
											}; null !== (t = s.exec(e));) u();
							...
							8879: function(e, t, n) {
								...
								var o = n(8520),
									...
									u = function() {
										function e(e, t, n, r) {
											var i = this;
											this.libs = {}, this.glslLibRoutineDependencyGraph = {}, this.context = new o.GlslContext(e, t, n, r), Object.keys(a.glslRegistry).forEach((function(e) {
												var t = new a.glslRegistry[e](i.context);
												i.libs[e] = t
											}));
											var s = this.glslLibRoutineDependencyGraph;
											for (var u in this.libs) {
												var c = this.libs[u].getFunctions();
												for (var l in c) {
													var f = u + "." + l,
														p = void 0;
													s[f] ? (p = s[f]).routineBody = c[l].routineBody : (p = new o.GlslLibRoutineNode(f, c[l].routineBody), s[f] = p);
													var d = c[l].dependencies;
													if (d)
														for (var h = 0; h < d.length; ++h)
															if (s[d[h]]) p.addDependency(s[d[h]]);
															else {
																var g = new o.GlslLibRoutineNode(d[h]);
																s[d[h]] = g, p.addDependency(g)
															}
												}
											}
										}
										return e.prototype.preprocess = function() {
											var e = this.context.programInfo,
												t = e.shaderSource;
										...
										}, e.prototype.getImports = function(e) {
											var t = this.selectGlslLibRoutinesToBeIncluded(e);
											if (0 === t.length) return "";
											for (var n = "", r = 0; r < t.length; ++r) {
												if (!t[r].routineBody) throw new Error("Missing body for the Glsl Library routine: " + t[r].name);
												n += t[r].routineBody + "\n"
											}
											return n
										}, e.prototype.selectGlslLibRoutinesToBeIncluded = function(e) {
											var t = this,
												n = [];
											return Object.keys(this.glslLibRoutineDependencyGraph).forEach((function(r) {
												var o = r.split(".")[1]; - 1 !== e.indexOf(o) && n.push(t.glslLibRoutineDependencyGraph[r])
											...
											if (t) try {
												for (var f = r(t), p = f.next(); !p.done; p = f.next()) {
													var d = p.value;
													s.push("uniform " + d.type + " " + d.name + (d.arrayLength ? "[" + d.arrayLength + "]" : "") + ";")
												}
											} catch (e) {
												i = {
													error: e
							...
							2655: function(e, t, n) {
								...
								var a = n(8520),
									s = function(e) {
										...
										return o(t, e), t.prototype.getFunctions = function() {
											return i(i(i(i(i({}, this.bcastIndex()), this.bcastMatmulIndex()), this.offsetToIndices()), this.indicesToOffset()), this.incrementIndices())
										}, t.prototype.getCustomTypes = function() {
											return {}
										}, t.prototype.bcastIndex = function() {
											var e = this,
												t = this.context.outputTextureLayout.shape.length,
												n = {};
											return this.context.programInfo.inputNames.forEach((function(r, o) {
												var i = e.context.inputTextureLayouts[o].unpackedShape;
												if (i.length <= t) {
													for (var s = i.length, u = t - s, c = "bcastIndices_" + r, l = "", f = 0; f < s; ++f) l += "\n          realIndices[" + f + "] = int( mod(float(bcastedIndices[" + (u + f) + "]), " + i[f] + ".0) );\n          ";
													var p = "\n        void " + c + " (int bcastedIndices[" + t + "], out int realIndices[" + s + "]) {\n          " + l + "\n        }\n        ";
													n[c] = new a.GlslLibRoutine(p)
												}
											})), n
										}, t.prototype.bcastMatmulIndex = function() {
											var e = this,
												t = this.context.outputTextureLayout.shape.length,
												n = {};
											return this.context.programInfo.inputNames.forEach((function(r, o) {
												var i = e.context.inputTextureLayouts[o].shape;
												if (!(i.length < 2 || i.length > t)) {
													for (var s = i.length, u = t - s, c = "bcastMatmulIndices_" + r, l = "", f = 0; f < s - 2; ++f) l += "\n          realIndices[" + f + "] = int( mod(float(bcastedIndices[" + (u + f) + "]), " + i[f] + ".0) );\n          ";
													var p = "\n        void " + c + "(int bcastedIndices[" + t + "], out int realIndices[" + s + "]) {\n          " + l + "\n          realIndices[" + (s - 1) + "] = bcastedIndices[" + (t - 1) + "];\n          realIndices[" + (s - 2) + "] = bcastedIndices[" + (t - 2) + "];\n        }\n        ";
													n[c] = new a.GlslLibRoutine(p)
												}
											})), n
										}, t.prototype.indicesToOffset = function() {
											var e = this,
												n = {};
											return this.context.programInfo.inputNames.forEach((function(r, o) {
												var i = e.context.inputTextureLayouts[o].shape,
													s = e.context.inputTextureLayouts[o].strides,
													u = i.length,
													c = "indicesToOffset_" + r;
												n[c] = new a.GlslLibRoutine(t.indexToOffsetSingle(c, u, s)), n[c = "indicesToOffset_" + r + "_T"] = new a.GlslLibRoutine(t.indexToOffsetSingle(c, u, s.slice().reverse()))
											})), n
										}, t.indexToOffsetSingle = function(e, t, n) {
											for (var r = "", o = t - 1; o >= 0; --o) r += "\n        offset += indices[" + o + "] * " + n[o] + ";\n        ";
											return "\n      int " + e + "(int indices[" + t + "]) {\n        int offset = 0;\n        " + r + "\n        return offset;\n      }\n      "
										}, t.prototype.offsetToIndices = function() {
											var e = this,
												n = {};
											return this.context.programInfo.inputNames.forEach((function(r, o) {
												var i = e.context.inputTextureLayouts[o].shape,
												...
												n[c] = new a.GlslLibRoutine(t.offsetToIndicesSingle(c, u, s)), n[c = "offsetToIndices_" + r + "_T"] = new a.GlslLibRoutine(t.offsetToIndicesSingle(c, u, s.slice().reverse()))
											})), n
										}, t.offsetToIndicesSingle = function(e, t, n) {
											for (var r = [], o = 0; o < t - 1; ++o) r.push("\n      indices[" + o + "] = offset / " + n[o] + ";"), r.push("\n        offset -= indices[" + o + "] * " + n[o] + ";");
											return r.push("\n      indices[" + (t - 1) + "] = offset;"), "\n      void " + e + "(int offset, out int indices[" + t + "]) {\n        " + r.join("") + "\n      }\n      "
										}, t.prototype.incrementIndices = function() {
											var e = this,
												t = {};
											return this.context.programInfo.inputNames.forEach((function(n, r) {
												for (var o = e.context.inputTextureLayouts[r].shape, i = o.length, s = "incrementIndices_" + n, u = "", c = 0; c < i; ++c) u += "\n        shape[" + c + "] = " + o[c] + ";";
												var l = "\n        void " + s + "(int axis, out int indices[" + i + "]) {\n          int shape[" + i + "];\n          " + u + ";\n          for(int i = " + i + " -1 ; i >= 0; --i) {\n            if(i > axis) continue;\n            indices[i] += 1;\n            if(indices[i] < shape[i]) {\n              break;\n            }\n            indices[i] = 0;\n          }\n        }\n        ";
												t[s] = new a.GlslLibRoutine(l)
											})), t
										}, t
									}(a.GlslLib);
								t.ShapeUtilsGlslLib = s
							},
							5060: function(e, t) {
								Object.defineProperty(t, "__esModule", {
									value: !0
							...
							3891: function(e, t, n) {
								...
								var a = n(8520),
									s = function(e) {
										...
										return o(t, e), t.prototype.getCustomTypes = function() {
											return {}
										}, t.prototype.getFunctions = function() {
											return i(i(i(i({}, this.binaryVecFunctions()), this.copyVec()), this.setVecItem()), this.getVecItem())
										}, t.prototype.binaryVecFunctions = function() {
											var e = this.context.outputTextureLayout.shape.length,
												t = {
													add: "+=",
													sub: "-=",
													mul: "*=",
												...
												n = {};
											for (var r in t) {
												for (var o = r + "Vec", i = "", s = 0; s < e; ++s) i += "\n          dest[" + s + "] " + t[r] + " src[" + s + "];\n          ";
												var u = "\n        void " + o + "(int src[" + e + "], out int dest[" + e + "]) {\n          " + i + "\n        }\n        ";
												n[o] = new a.GlslLibRoutine(u)
											}
											return n
										}, t.prototype.copyVec = function() {
											for (var e = this.context.outputTextureLayout.shape.length, t = "", n = 0; n < e; ++n) t += "\n        dest[" + n + "] = src[" + n + "];\n        ";
											var r = "\n      void copyVec(int src[" + e + "], out int dest[" + e + "]) {\n        " + t + "\n      }\n      ";
											return {
												copyVec: new a.GlslLibRoutine(r)
											}
										}, t.prototype.setVecItem = function() {
											for (var e = this.context.outputTextureLayout.shape.length, t = "\n        if(index < 0)\n            index =" + e + " + index;\n        if (index == 0)\n            m[0] = value;\n        ", n = 1; n < e - 1; ++n) t += "\n        else if (index == " + n + ")\n            m[" + n + "] = value;\n            ";
											var r = "\n      void setVecItem(out int m[" + e + "], int index, int value) {\n        " + (t += "\n        else\n            m[" + (e - 1) + "] = value;\n        ") + "\n      }\n        ";
											return {
												setVecItem: new a.GlslLibRoutine(r)
											}
										}, t.prototype.getVecItem = function() {
											for (var e = this.context.outputTextureLayout.shape.length, t = "\n        if(index < 0)\n            index = " + e + " + index;\n        if (index == 0)\n            return m[0];\n      ", n = 1; n < e - 1; ++n) t += "\n        else if (index == " + n + ")\n            return m[" + n + "];\n      ";
							...
							8316: function(e, t, n) {
								...
								var a = n(6231),
									...
									g = function() {
										...
										return e.prototype.calculateTextureWidthAndHeight = function(e, t) {
											return d.calculateTextureWidthAndHeight(this.session.layoutStrategy, e, t)
										}, e.prototype.executeProgram = function(e, t) {
											...
											for (var n = [], r = 0; r < e.inputNames.length; ++r) n[r] = this.getOrCreateTextureData(t[r], e.inputTypes[r]);
											var o = function(e, t) {
													var n = t.map((function(e) {
															return e.unpackedShape.join(",") + ";" + e.width + "x" + e.height
														})).join("_"),
														r = e.name;
													return e.cacheHint && (r += "[" + e.cacheHint + "]"), r + ":" + n
												}(e, n),
												i = this.session.programManager.getArtifact(o),
												a = i ? i.programInfo : "function" == typeof e.get ? e.get() : e,
												s = d.createTextureLayoutFromTextureType(this.session.layoutStrategy, a.output.dims, a.output.textureType),
												u = this.createTextureData(s, a.output.type);
											return i || (i = this.session.programManager.build(a, n, u), this.session.programManager.setArtifact(o, i)), this.runProgram(i, n, u), u
										}, e.prototype.run = function(e, t) {
											return this.executeProgram(e, t).tensor
										}, e.prototype.runProgram = function(e, t, n) {
											for (var r = 0; r < t.length; ++r)
												if (!!t[r].isPacked != (e.programInfo.inputTypes[r] === h.TextureType.packed)) throw new Error("input[" + r + "] property packed inconsistent");
											if (!!n.isPacked != (e.programInfo.output.textureType === h.TextureType.packed)) throw new Error("output property packed inconsistent");
											this.session.programManager.run(e, t, n)
										}, e.prototype.getOrCreateTextureData = function(e, t) {
											var n = this.getTextureData(e.dataId, t === h.TextureType.packed);
											if (!n && (n = this.getTextureData(e.dataId, t !== h.TextureType.packed))) return t === h.TextureType.packed ? this.pack(n) : this.unpack(n);
											if (!n) {
												var r = d.createTextureLayoutFromTextureType(this.session.layoutStrategy, e.dims, t);
												if (t === h.TextureType.packedLastDimension) {
													var o = e.dims;
													if (4 === o.length) {
														var i = [o[0], Math.ceil(o[1] * o[2] * o[3] / 4)],
															a = d.createTextureLayoutFromTextureType(this.session.layoutStrategy, i, t),
															s = e.numberData;
														if (o[1] * o[2] * o[3] % 4 != 0) {
															var u = o[0],
																c = o[1] * o[2] * o[3],
																l = 4 * Math.ceil(1 * c / 4);
															s = new Float32Array(u * l);
															for (var f = 0; f < u; ++f) {
																var p = f * c,
																	g = f * l + f % 1 * c;
																s.set(e.numberData.subarray(p, p + c), g)
															}
														}
														return this.createTextureData(a, e.type, s, e, 1)
													}
												}
												if (t === h.TextureType.packed) {
													var b = d.createTextureLayoutFromShape(this.session.layoutStrategy, e.dims, 1, [], {
															reverseWH: !0
														}),
														y = this.createTextureData(b, e.type, e.numberData, e, 1);
													n = this.pack(y)
												} else n = this.createTextureData(r, e.type, e.numberData, e, 1)
											}
											return n
										}, e.prototype.createTextureDataFromLayoutBindTensor = function(e, t, n, r) {
											return this.createTextureData(e, t, n, r, 1)
										}, e.prototype.createTextureData = function(e, t, n, r, o) {
											a.Logger.verbose("InferenceHandler", "Creating TextureData: layout:[" + JSON.stringify(e) + "]");
											var i = this.session.textureManager.createTextureFromLayout(t, e, n, o);
											return this.createTextureDataFromTexture(e, t, i, r)
										}, e.prototype.reshapeUnpacked = function(e, t) {
											var n = this.getOrCreateTextureData(e, h.TextureType.unpacked),
												r = {
													channels: n.channels,
													height: n.height,
													width: n.width,
													shape: 0 !== t.length ? t : [1],
													strides: u.ShapeUtil.computeStrides(t),
													unpackedShape: t
												};
											return this.createTextureDataFromTexture(r, e.type, n.texture).tensor
										}, e.prototype.reshapePacked = function(e, t) {
											var n = this.getOrCreateTextureData(e, h.TextureType.packed);
											if (l.isReshapeCheap(e.dims, t)) {
												var r = {
													channels: n.channels,
													height: n.height,
													width: n.width,
											...
											var o = l.processDims3D(e.dims),
												i = l.processDims3D(t),
												a = this.reshapePacked(e, o),
												s = this.run(l.createPackedReshape3DProgramInfoLoader(this, a, i), [a]);
											return this.reshapePacked(s, t)
										}, e.prototype.createTextureDataFromTexture = function(e, t, n, a, u) {
											var c = this,
												l = r(r({}, e), {
													tensor: a || new s.Tensor(e.unpackedShape, t, (function(e) {
														return c.readTexture(l)
													}), (function(e) {
														return o(c, void 0, void 0, (function() {
															return i(this, (function(e) {
																return [2, this.readTextureAsync(l)]
															}))
														}))
													}), void 0, u),
													texture: n
												});
											return this.setTextureData(l.tensor.dataId, l, e.isPacked), l
										}, e.prototype.getTextureData = function(e, t) {
											return void 0 === t && (t = !1), this.session.isInitializer(e) ? this.session.getTextureData(e, t) : t ? this.packedTextureDataCache.get(e) : this.unpackedTextureDataCache.get(e)
										}, e.prototype.setTextureData = function(e, t, n) {
											void 0 === n && (n = !1), this.session.isInitializer(e) ? this.session.setTextureData(e, t, n) : (n ? this.packedTextureDataCache : this.unpackedTextureDataCache).set(e, t)
										}, e.prototype.isTextureLayoutCached = function(e, t) {
											return void 0 === t && (t = !1), !!this.getTextureData(e.dataId, t)
										}, e.prototype.dispose = function() {
											var e = this;
											this.session.textureManager.clearActiveTextures(), this.packedTextureDataCache.forEach((function(t) {
												return e.session.textureManager.releaseTexture(t)
											})), this.packedTextureDataCache = new Map, this.unpackedTextureDataCache.forEach((function(t) {
												return e.session.textureManager.releaseTexture(t)
											})), this.unpackedTextureDataCache = new Map
										}, e.prototype.readTexture = function(e) {
											return e.isPacked ? this.readTexture(this.unpack(e)) : this.session.backend.glContext.isFloat32DownloadSupported ? this.session.textureManager.readTexture(e, e.tensor.type, e.channels) : this.session.textureManager.readUint8TextureAsFloat(f.encodeAsUint8(this, e))
										}, e.prototype.readTextureAsync = function(e) {
											return o(this, void 0, void 0, (function() {
												return i(this, (function(t) {
													return e.isPacked ? [2, this.readTextureAsync(this.unpack(e))] : this.session.backend.glContext.isFloat32DownloadSupported ? [2, this.session.textureManager.readTextureAsync(e, e.tensor.type, e.channels)] : [2, this.session.textureManager.readUint8TextureAsFloat(f.encodeAsUint8(this, e))]
												}))
											}))
										}, e.prototype.pack = function(e) {
											return this.executeProgram(c.createPackProgramInfoLoader(this, e.tensor), [e.tensor])
										}, e.prototype.unpack = function(e) {
											return this.executeProgram(p.createUnpackProgramInfoLoader(this, e.tensor), [e.tensor])
										}, e
									}();
								t.WebGLInferenceHandler = g
							},
							1640: function(e, t, n) {
								var r = this && this.__createBinding || (Object.create ? function(e, t, n, r) {
										void 0 === r && (r = n), Object.defineProperty(e, r, {
								...
								t.WEBGL_OP_RESOLVE_RULES = [
									...
									["Asin", "", "7+", R.asin],
									["Atan", "", "7+", R.atan],
									["AveragePool", "", "7-10", m.averagePool, m.parseAveragePoolAttributes],
									["BatchNormalization", "", "7+", a.batchNormalization, a.parseBatchNormalizationAttributes],
									["Ceil", "", "6+", R.ceil],
									["Clip", "", "6-10", R.clip, R.parseClipAttributes],
									["Concat", "", "4+", u.concat, u.parseConcatAttributes],
									["Conv", "", "1+", c.conv, c.parseConvAttributes],
									["Cos", "", "7+", R.cos],
									["Div", "", "7+", s.div],
									["Dropout", "", "7+", R.identity],
									["DepthToSpace", "", "1+", l.depthToSpace, l.parseDepthToSpaceAttributes],
									["Equal", "", "7+", s.equal],
									["Elu", "", "6+", R.elu, R.parseEluAttributes],
									["Exp", "", "6+", R.exp],
									["Flatten", "", "1+", f.flatten, f.parseFlattenAttributes],
									["Floor", "", "6+", R.floor],
									["Gather", "", "1+", p.gather, p.parseGatherAttributes],
									["Gemm", "", "7-10", d.gemm, d.parseGemmAttributesV7],
									["Gemm", "", "11+", d.gemm, d.parseGemmAttributesV11],
									["GlobalAveragePool", "", "1+", v.globalAveragePool, v.parseGlobalAveragePoolAttributes],
									["GlobalMaxPool", "", "1+", w.globalMaxPool],
									["Greater", "", "7+", s.greater],
									["Identity", "", "1+", R.identity],
									["ImageScaler", "", "1+", h.imageScaler, h.parseImageScalerAttributes],
									["InstanceNormalization", "", "6+", g.instanceNormalization, g.parseInstanceNormalizationAttributes],
									["LeakyRelu", "", "6+", R.leakyRelu, R.parseLeakyReluAttributes],
									["Less", "", "7+", s.less],
									["Log", "", "6+", R.log],
									["MatMul", "", "1+", b.matMul, b.parseMatMulAttributes],
									["MaxPool", "", "1-9", _.maxPool, _.parseMaxPoolAttributes],
									["Mul", "", "7+", s.mul],
									["Neg", "", "6+", R.neg],
									["Not", "", "1+", R.not],
									["Or", "", "7+", s.or],
									["Pad", "", "2-10", y.pad, y.parsePadAttributes],
									["Pow", "", "7+", s.pow],
									["PRelu", "", "7+", s.pRelu],
									["ReduceLogSum", "", "1+", x.reduceLogSum, T.parseReduceAttributes],
									["ReduceMax", "", "1+", x.reduceMax, T.parseReduceAttributes],
									["ReduceMean", "", "1+", x.reduceMean, T.parseReduceAttributes],
									["ReduceMin", "", "1+", x.reduceMin, T.parseReduceAttributes],
									["ReduceProd", "", "1+", x.reduceProd, T.parseReduceAttributes],
									["ReduceSum", "", "1+", x.reduceSum, T.parseReduceAttributes],
									["ReduceSumSquare", "", "1+", x.reduceLogSumSquare, T.parseReduceAttributes],
									["Relu", "", "6+", R.relu],
									["Reshape", "", "5+", S.reshape],
									...
									["Sin", "", "7+", R.sin],
									["Slice", "", "10+", E.sliceV10],
									["Slice", "", "1-9", E.slice, E.parseSliceAttributes],
									["Softmax", "", "1+", I.softmax, I.parseSoftmaxAttributes],
									["Split", "", "2+", P.split, P.parseSplitAttributes],
									["Sqrt", "", "6+", R.sqrt],
									["Squeeze", "", "1+", D.squeeze, D.parseSqueezeAttributes],
									["Sub", "", "7+", s.sub],
									["Sum", "", "6+", k.sum],
									["Tan", "", "7+", R.tan],
									["Tanh", "", "6+", R.tanh],
									["Tile", "", "6+", N.tile],
									["Transpose", "", "1+", C.transpose, C.parseTransposeAttributes],
									["Upsample", "", "7-8", L.upsample, L.parseUpsampleAttributesV7],
									["Upsample", "", "9", L.upsample, L.parseUpsampleAttributesV9],
									["Unsqueeze", "", "1+", F.unsqueeze, F.parseUnsqueezeAttributes],
									["Xor", "", "7+", s.xor]
								]
							},
							2898: function(e, t, n) {
								...
								t.batchNormalization = function(e, t, n) {
									return l(t), [e.run(r(r({}, u), {
										cacheHint: n.cacheKey,
										get: function() {
											return c(e, t, n)
										}
									}), t)]
								}, t.parseBatchNormalizationAttributes = function(e) {
									var t = e.attributes.getFloat("epsilon", 1e-5),
										n = e.attributes.getFloat("momentum", .9),
										r = e.attributes.getInt("spatial", 1);
									return i.createAttributeWithCacheKey({
										epsilon: t,
										momentum: n,
										spatial: r
									})
								...
								var c = function(e, t, n) {
										var i = a.getGlsl(e.session.backend.glContext.version),
											c = t[0].dims.length,
											l = o(e.calculateTextureWidthAndHeight(t[1].dims, s.TextureType.unpacked), 2),
							...
							7839: function(e, t, n) {
								...
								t.glslAdd = s, t.glslDiv = u, t.glslMul = c, t.glslSub = l, t.glslEqual = f, t.glslGreater = p, t.glslLess = d, t.glslAnd = h, t.glslOr = g, t.glslXor = b, t.glslPow = y, t.glslPRelu = m;
								var v = function(e, t, n, r, o) {
										void 0 === r && (r = t[0].type);
										var i = e.session.pack ? a.TextureType.packed : a.TextureType.unpacked;
										return {
											name: n.name,
											inputNames: ["A", "B"],
											inputTypes: [i, i],
									...
									_ = function(e, t, n, o) {
										void 0 === o && (o = t[0].type);
										var s = e.session.pack ? a.TextureType.packed : a.TextureType.unpacked,
											u = !r.ShapeUtil.areEqual(t[0].dims, t[1].dims),
											c = t[0].dims,
											l = e.session.pack;
										if (u) {
											var f = r.BroadcastUtil.calcShape(t[0].dims, t[1].dims, !1);
											if (!f) throw new Error("Can't perform binary op on the given tensors");
											var p = (c = f).length,
												d = 0 !== t[0].dims.length ? t[0].dims.length : 1,
												h = 0 !== t[1].dims.length ? t[1].dims.length : 1,
												g = 0 !== t[0].dims.length ? "bcastIndices_A(indices, aindices);" : "aindices[0] = 0;",
												b = 0 !== t[1].dims.length ? "bcastIndices_B(indices, bindices);" : "bindices[0] = 0;",
												y = i.getGlsl(e.session.backend.glContext.version),
										...
										var v = i.getGlsl(e.session.backend.glContext.version),
								...
								t.add = function(e, t) {
									return [e.run(v(e, t, s()), t)]
								}, t.and = function(e, t) {
									return [e.run(v(e, t, h(), "bool"), t)]
								}, t.div = function(e, t) {
									return [e.run(v(e, t, u()), t)]
								}, t.equal = function(e, t) {
									return [e.run(v(e, t, f(), "bool"), t)]
								}, t.greater = function(e, t) {
									return [e.run(v(e, t, p(), "bool"), t)]
								}, t.less = function(e, t) {
									return [e.run(v(e, t, d(), "bool"), t)]
								}, t.mul = function(e, t) {
									return [e.run(v(e, t, c()), t)]
								}, t.or = function(e, t) {
									return [e.run(v(e, t, g(), "bool"), t)]
								}, t.pow = function(e, t) {
									return [e.run(v(e, t, y()), t)]
								}, t.pRelu = function(e, t) {
									return [e.run(v(e, t, m()), t)]
								}, t.sub = function(e, t) {
									return [e.run(v(e, t, l()), t)]
								}, t.xor = function(e, t) {
									return [e.run(v(e, t, b(), "bool"), t)]
								}
							},
							1163: function(e, t, n) {
								var r = this && this.__assign || function() {
								...
								var o = n(5060),
									...
									a = n(9390),
									s = n(2827);
								t.createPackedConcatProgramInfoLoader = function(e, t, n) {
									var c, l, f = (c = t.length, l = n.cacheKey, {
										name: "Concat (packed)",
									...
									return r(r({}, f), {
										get: function() {
											return function(e, t, n, c) {
												var l = n[0].dims.slice();
												if (c >= l.length || c < -1 * l.length) throw new Error("axis specified for concat doesn't match input dimensionality");
												c < 0 && (c = l.length + c);
												for (var f = l.slice(0), p = 1; p < n.length; p++)
													for (var d = n[p].dims.slice(), h = 0; h < l.length; h++)
														if (h === c) f[c] += d[h];
														else if (l[h] !== d[h]) throw new Error("non concat dimensions must match");
												var g = f.length,
													b = s.getChannels("coords", g),
													y = a.getCoordsDataType(g),
													m = s.unpackFromChannel(),
													v = n.map((function(e) {
														return e.dims
													})),
													_ = a.getGlChannels(g),
													w = new Array(v.length - 1);
												for (w[0] = v[0][c], p = 1; p < w.length; p++) w[p] = w[p - 1] + v[p][c];
												var x = _[c],
													T = _.slice(-2),
													S = _.join(),
													O = "if (" + x + " < " + w[0] + ") {\n        return getChannel(\n            getX0(" + S + "), vec2(" + T.join() + "));\n        }";
												...
												var E = w.length,
													I = w[w.length - 1];
												O += "\n            return getChannel(\n              getX" + E + "(" + u(_, x, I) + "),\n              vec2(" + u(T, x, I) + "));";
												var P = o.getGlsl(e.session.backend.glContext.version),
													D = "\n          " + m + "\n          float getValue(" + _.map((function(e) {
														return "int " + e
							...
							2069: function(e, t, n) {
								...
								var i = n(246),
									a = n(2039),
									s = n(1163);
								t.concat = function(e, t, n) {
									return d(t), e.session.pack && t[0].dims.length > 1 ? [e.run(s.createPackedConcatProgramInfoLoader(e, t, n), t)] : [e.run(u(e, t, n), t)]
								};
								var u = function(e, t, n) {
										var o, i, s = (o = t.length, i = n.cacheKey, {
											name: "Concat",
											inputNames: Array.from({
												length: o
											}, (function(e, t) {
											...
											inputTypes: Array(o).fill(a.TextureType.unpacked),
											cacheHint: i
										});
										return r(r({}, s), {
											get: function() {
												return function(e, t, n, o) {
													var i = n[0].dims.slice();
													if (o >= i.length || o < -1 * i.length) throw new Error("axis specified for concat doesn't match input dimensionality");
													o < 0 && (o = i.length + o);
													for (var s = i.slice(0), u = 1; u < n.length; u++)
														for (var d = n[u].dims.slice(), h = 0; h < i.length; h++)
															if (h === o) s[o] += d[h];
															else if (i[h] !== d[h]) throw new Error("non concat dimensions must match");
													var g, b = s.length,
														y = new Array(n.length),
														m = 0;
													for (u = 0; u < y.length; ++u) m += n[u].dims[o], y[u] = m;
													g = n.length < 5 ? c(y) : l(y);
									...
									f = function(e, t) {
										for (var n = ["float fetchDataFromCorrectTexture(int textureIndex, int indices[" + t + "]) {"], r = 0; r < e; ++r) 0 === r ? n.push("\tif (textureIndex == " + r + ") { return _X" + r + "(indices); }") : r === e - 1 ? n.push("\telse { return _X" + r + "(indices); }") : n.push("\telse if (textureIndex == " + r + ") { return _X" + r + "(indices); }");
										return n.push("\t}"), n.join("\n")
									},
									p = function(e) {
										for (var t = ["int getSizeInConcatAxisValueFromIndex(int index) {"], n = 0; n < e.length; ++n) 0 === n ? t.push("\tif (index == " + n + ") { return " + e[n] + "; }") : n === e.length - 1 ? t.push("\telse { return " + e[n] + "; }") : t.push("\telse if (index == " + n + ") { return " + e[n] + "; }");
										return t.push("\t}"), t.join("\n")
									};
								t.parseConcatAttributes = function(e) {
									return i.createAttributeWithCacheKey({
								...
								var d = function(e) {
									...
									var r = e[0].type,
										i = e[0].dims.length;
									if ("string" === r) throw new Error("string tensor is not supported yet");
									try {
										for (var a = o(e), s = a.next(); !s.done; s = a.next()) {
											var u = s.value;
											if (u.type !== r) throw new Error("input tensors should be one type");
											if (u.dims.length !== i) throw new Error("input tensors should have the same shape")
										}
									} catch (e) {
										t = {
											error: e
							...
							4770: function(e, t, n) {
								...
								var o = n(6231),
									...
									s = n(8138),
									u = n(2823);
								t.createUnpackedGroupedConvProgramInfoLoader = function(e, t, n) {
									var c, l, f = (c = t.length > 2, l = n.cacheKey, {
										name: "GroupedConv",
										inputNames: c ? ["X", "W", "Bias"] : ["X", "W"],
										inputTypes: c ? [a.TextureType.unpacked, a.TextureType.unpacked, a.TextureType.unpacked] : [a.TextureType.unpacked, a.TextureType.unpacked],
										cacheHint: l
									});
									return r(r({}, f), {
										get: function() {
											return function(e, t, n, c) {
												var l = t.length > 2 ? "value += getBias(output_channel);" : "",
													f = t[0].dims.slice(),
													p = t[1].dims.slice(),
													d = p[0] / c.group;
												o.Logger.verbose("GroupedConv", "autpPad:" + c.autoPad + ", dilations:" + c.dilations + ", group:" + c.group + ", kernelShape:" + c.kernelShape + ", pads:" + c.pads + ", strides:" + c.strides);
												var h = s.calculateOutputShape(f, p, c.dilations, c.pads, c.strides),
													g = i.getGlsl(e.session.backend.glContext.version),
													b = u.getActicationSnippet(c),
													y = b.activationFunction,
													m = b.applyActivation,
							...
							1386: function(e, t, n) {
								...
								var r = n(8138),
									o = n(8555),
									i = n(708);
								t.conv2DPackedPointwise = function(e, t, n) {
									var o = t[0].dims,
										a = t[1].dims,
										s = r.calculateOutputShape(o, a, n.dilations, n.pads, n.strides),
										u = e.reshapePacked(t[0], [o[1], o[2] * o[3]]),
										c = e.reshapePacked(t[1], [a[0], a[1]]),
										l = t.length > 2 ? [c, u, t[2]] : [c, u],
										f = e.run(i.createPackedMatmulProgramInfoLoader(e, l, n), l);
									return e.reshapePacked(f, s)
								}, t.conv2DPacked = function(e, t, n) {
									var a = t[0].dims,
										s = t[1].dims,
										u = r.calculateOutputShape(a, s, n.dilations, n.pads, n.strides),
										c = e.run(o.createPackedIm2ColProgramInfoLoader(e, t[0], t[1], u, n), [t[0]]),
										l = e.reshapePacked(t[1], [s[0], s[1] * s[2] * s[3]]),
										f = 3 === t.length ? [l, c, t[2]] : [l, c],
										p = e.run(i.createPackedMatmulProgramInfoLoader(e, f, n), f);
									return e.reshapePacked(p, u)
								}
							},
							8138: function(e, t, n) {
								var r = this && this.__assign || function() {
								...
								var a = n(246),
									...
									p = n(3248),
									d = n(5623);
								t.calculateOutputShape = function(e, t, n, r, a) {
									var s, u = e[0],
										c = e.slice(2),
										l = c.length,
										f = t[0],
										p = t.slice(2).map((function(e, t) {
											return e + (e - 1) * (n[t] - 1)
										})),
										d = c.map((function(e, t) {
											return e + r[t] + r[t + l]
										})).map((function(e, t) {
											return Math.floor((e - p[t] + a[t]) / a[t])
										}));
									return (s = [u, f]).concat.apply(s, i([], o(d)))
								}, t.conv = function(e, t, n) {
									return m(t, n), h(e, t, n)
								};
								var h = function(e, t, n) {
										var r = y(n, t),
											o = e.session.pack,
											i = 1 === r.kernelShape[0] && 1 === r.kernelShape[1];
										return r.group > 1 ? [e.run(u.createUnpackedGroupedConvProgramInfoLoader(e, t, r), t)] : i && o ? [g(e, t, r)] : o && 4 === t[0].dims.length && 1 === t[0].dims[0] && !i ? [c.conv2DPacked(e, t, r)] : [b(e, t, r)]
									},
									g = function(e, n, r) {
										var o = n[0].dims,
											i = n[1].dims,
											a = t.calculateOutputShape(o, i, r.dilations, r.pads, r.strides),
											s = e.reshapeUnpacked(n[0], [o[1], o[2] * o[3]]),
											u = e.reshapeUnpacked(n[1], [i[0], i[1]]),
											c = n.length > 2 ? [u, s, n[2]] : [u, s],
											l = e.run(d.createMatmulProgramInfoLoader(c, r), c);
										return e.reshapeUnpacked(l, a)
									},
									b = function(e, n, r) {
										var o = n[0].dims,
											i = n[1].dims,
											a = t.calculateOutputShape(o, i, r.dilations, r.pads, r.strides),
											s = e.run(p.createIm2ColProgramInfoLoader(e, n[0], n[1], a, r), [n[0]]),
											u = 3 === n.length ? [s, n[1], n[2]] : [s, n[1]];
										return e.run(l.createDotProductProgramInfoLoader(e, n, a, r), u)
									},
									y = function(e, t) {
										var n = e.kernelShape.slice();
										if (0 === e.kernelShape.length)
											for (var r = 2; r < t[1].dims.length; ++r) n.push(t[1].dims[r]);
										var o = e.pads.slice();
										s.PoolConvUtil.adjustPadsBasedOnAutoPad(t[0].dims, e.strides, e.dilations, n, o, e.autoPad);
								...
								t.parseConvAttributes = function(e) {
									var t = e.attributes,
										n = f.parseInternalActivationAttributes(t),
									...
									return a.createAttributeWithCacheKey(r({
										autoPad: o,
										dilations: i,
										group: s,
										kernelShape: u,
							...
							5193: function(e, t, n) {
								...
								var o = n(3738);
								t.depthToSpace = function(e, t, n) {
									i(t);
									var a = n.blocksize,
										s = a * a,
										u = "DCR" === n.mode ? [0, 3, 4, 1, 5, 2] : [0, 1, 4, 2, 5, 3],
										c = "DCR" === n.mode ? [t[0].dims[0], a, a, t[0].dims[1] / s, t[0].dims[2], t[0].dims[3]] : [t[0].dims[0], t[0].dims[1] / s, a, a, t[0].dims[2], t[0].dims[3]],
										l = e.reshapeUnpacked(t[0], c),
										f = {
											perm: u,
											cacheKey: "" + u
										},
										p = r(o.transpose(e, [l], f), 1)[0],
										d = [t[0].dims[0], t[0].dims[1] / s, t[0].dims[2] * a, t[0].dims[3] * a];
									return [e.reshapeUnpacked(p, d)]
								}, t.parseDepthToSpaceAttributes = function(e) {
									var t = e.attributes.getInt("blocksize");
									if (t < 1) throw new Error("blocksize must be >= 1, but got : " + t + " for DepthToSpace");
									var n = e.attributes.getString("mode", "DCR");
							...
							9828: function(e, t, n) {
								...
								var i = n(2517),
									...
									u = n(2823),
									c = n(3248);
								t.createDotProductProgramInfoLoader = function(e, t, n, l) {
									var f = function(e, t) {
										return {
											name: "ConvDotProduct",
									...
									return r(r({}, f), {
										get: function() {
											return function(e, t, n, l, f) {
												var p = n[0].dims,
													d = n[1].dims,
													h = [d[0], Math.ceil(p[1] * d[2] * d[3] / 4)],
													g = c.calculateIm2ColDims(p, d, l),
													b = o(e.calculateTextureWidthAndHeight(h, s.TextureType.packedLastDimension), 2),
													y = b[0],
													m = b[1],
													v = i.ShapeUtil.computeStrides(g),
													_ = o(e.calculateTextureWidthAndHeight(g, s.TextureType.packedLastDimension), 2),
													w = _[0],
													x = _[1],
													T = l.length,
													S = n.length < 3 ? "0.0" : "_B(b)",
													O = Math.ceil(p[1] * d[2] * d[3] / 4),
													A = u.getActicationSnippet(f),
													E = A.activationFunction,
													I = A.applyActivation,
													P = a.getGlsl(e.session.backend.glContext.version),
							...
							7992: function(e, t, n) {
								...
								var r = n(2517);
								t.flatten = function(e, t, n) {
									o(t, n);
									var i = r.ShapeUtil.flattenShape(t[0].dims, n);
									return [e.reshapeUnpacked(t[0], i)]
								}, t.parseFlattenAttributes = function(e) {
									return e.attributes.getInt("axis", 1)
								};
								var o = function(e, t) {
									if (!e || 1 !== e.length) throw new Error("Flatten requires 1 input.");
									var n = e[0].dims.length;
							...
							2823: function(e, t, n) {
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.parseInternalActivationAttributes = t.getActicationSnippet = void 0;
								var r = n(4909);
								t.getActicationSnippet = function(e) {
									...
									switch (e.activation) {
										...
										case "Sigmoid":
											...
											break;
										case "Clip":
											t = r.glslClip(e.clipMin, e.clipMax);
											break;
										default:
											return {
								...
								}, t.parseInternalActivationAttributes = function(e) {
									var t = e.getString("__internal_activation", "");
									if ("Clip" === t) {
										var n = e.getFloat("__clip_max", 3402823e32),
											r = e.getFloat("__clip_min", -3402823e32);
										return {
											activation: t,
											clipMax: n,
											clipMin: r,
											activationCacheKey: t + ":" + r + "," + n
										}
									}
									return {
										activation: t,
							...
							1253: function(e, t, n) {
								...
								t.gather = function(e, t, n) {
									return l(t, n.axis), [e.run(c(e, t, n), t)]
								}, t.parseGatherAttributes = function(e) {
									return o.createAttributeWithCacheKey({
										...
										return r(r({}, o), {
											get: function() {
												return function(e, t, n, o) {
													var i = n[0].dims.slice(),
														u = n[1].dims.slice(),
														c = new Array(i.length + u.length - 1);
													o = a.ShapeUtil.normalizeAxis(o, i.length);
													for (var l = [], f = 0; f < c.length; f++) f < o ? (c[f] = i[f], l.push("inputIdx[" + f + "] = outputIdx[" + f + "];")) : f < o + u.length ? (c[f] = u[f - o], l.push("indexDataIdx[" + (f - o) + "] = outputIdx[" + f + "];")) : (c[f] = i[f - u.length + 1], l.push("inputIdx[" + (f - u.length + 1) + "] = outputIdx[" + f + "];"));
							...
							4776: function(e, t, n) {
								...
								var i = n(246),
									a = n(2517),
									s = n(2039);
								t.gemm = function(e, t, n) {
									return f(t, n), [e.run(c(t, n), t)]
								};
								var u = function(e, t) {
									var n = 0 !== e.attributes.getInt("transA", 0),
										r = 0 !== e.attributes.getInt("transB", 0),
										o = e.attributes.getFloat("alpha", 1),
								...
								t.parseGemmAttributesV7 = function(e) {
									return u(e, !1)
								}, t.parseGemmAttributesV11 = function(e) {
									return u(e, !0)
								};
								var c = function(e, t) {
										var n = {
											...
											inputTypes: 3 === e.length ? [s.TextureType.unpacked, s.TextureType.unpacked, s.TextureType.unpacked] : [s.TextureType.unpacked, s.TextureType.unpacked],
											key: t.cacheKey
										};
										return r(r({}, n), {
											get: function() {
									...
									l = function(e, t, n) {
										var i = t[0].dims.slice(),
											u = t[1].dims.slice(),
											c = o(a.GemmUtil.getShapeOfGemmResult(i, n.transA, u, n.transB, 3 === t.length ? t[2].dims : void 0), 2),
											l = [c[0], c[1]];
										if (!l) throw new Error("Can't use gemm on the given tensors");
										var f = i[i.length - 1],
											p = "";
										n.transA && (f = i[0]), n.transA && n.transB ? p = "value += _A_T(a) * _B_T(b);" : n.transA && !n.transB ? p = "value += _A_T(a) * _B(b);" : !n.transA && n.transB ? p = "value += _A(a) * _B_T(b);" : n.transA || n.transB || (p = "value += _A(a) * _B(b);");
										var d = l.length,
							...
							8555: function(e, t, n) {
								...
								var o = n(5060),
									i = n(2039),
									a = n(2827);
								t.createPackedIm2ColProgramInfoLoader = function(e, t, n, s, u) {
									var c, l = (c = u.cacheKey, {
										name: "Im2Col (packed)",
										inputNames: ["A"],
									...
									return r(r({}, l), {
										get: function() {
											return function(e, t, n, s, u, c) {
												for (var l = n.dims, f = s.dims, p = u.length, d = [f[1] * f[2] * f[3], u[2] * u[3]], h = f[2] * f[3], g = a.unpackFromChannel(), b = o.getGlsl(e.session.backend.glContext.version), y = "", m = 0; m <= 1; m++)
													for (var v = 0; v <= 1; v++) y += "\n            blockIndex = rc.x + " + v + ";\n            pos = rc.y + " + m + ";\n\n            if(blockIndex < " + d[1] + " && pos < " + d[0] + ") {\n              offsetY = int(blockIndex / (" + u[p - 1] + ")) * " + c.strides[0] + " - " + c.pads[0] + ";\n              d0 = offsetY + " + c.dilations[0] + " * (imod(pos, " + h + ") / " + f[2] + ");\n\n              if(d0 < " + l[2] + " && d0 >= 0) {\n                offsetX = imod(blockIndex, " + u[p - 1] + ") * " + c.strides[1] + " - " + c.pads[1] + ";\n                d1 = offsetX + " + c.dilations[1] + " * imod(imod(pos, " + h + "), " + f[2] + ");\n\n                if(d1 < " + l[3] + " && d1 >= 0) {\n\n                  ch = int(float(pos)/ " + h + ".);\n                    innerDims = vec2(d0, d1);\n                    result[" + (2 * m + v) + "] = getChannel(\n                      getA(0, ch, int(innerDims.x),\n                      int(innerDims.y)), innerDims);\n                }\n              }\n            }\n\n          ";
							...
							3248: function(e, t, n) {
								...
								var o = n(2039);
								t.createIm2ColProgramInfoLoader = function(e, n, i, a, s) {
									var u, c = (u = s.cacheKey, {
										name: "Im2Col",
										inputNames: ["X"],
										...
										get: function() {
											return function(e, n, i, a, s, u) {
												var c = i.dims,
													l = a.dims,
													f = s.length,
													p = t.calculateIm2ColDims(c, l, s, 4),
								...
								}, t.calculateIm2ColDims = function(e, t, n, r) {
									return void 0 === r && (r = 4), [n[0], n[2], n[3], Math.ceil(e[1] * t[2] * t[3] / r)]
								}
							},
							6572: function(e, t, n) {
								var r = this && this.__assign || function() {
								...
								var o = n(246),
									i = n(2039);
								t.imageScaler = function(e, t, n) {
									return c(t), [e.run(s(e, t, n), t)]
								}, t.parseImageScalerAttributes = function(e) {
									var t = e.attributes.getFloat("scale"),
								...
								var a = {
									...
									u = function(e) {
										for (var t = ["float getBias(float bias[" + e + "], int channel) {"], n = 0; n < e; ++n) 0 === n ? t.push("\tif (channel == " + n + ") { return bias[" + n + "]; }") : n === e - 1 ? t.push("\telse { return bias[" + n + "]; }") : t.push("\telse if (channel == " + n + ") { return bias[" + n + "]; }");
										return t.push("\t}"), t.join("\n")
									},
									c = function(e) {
							...
							3346: function(e, t, n) {
								...
								var i = n(5060),
									a = n(2039);
								t.instanceNormalization = function(e, t, n) {
									f(t);
									var r = e.run(u(t[0]), t);
									return [e.run(l(e, t[0], n, r.dims), [t[0], r, t[1], t[2]])]
								}, t.parseInstanceNormalizationAttributes = function(e) {
									return e.attributes.getFloat("epsilon", 1e-5)
								};
								var s = {
									...
									c = {
										...
										inputTypes: [a.TextureType.unpacked, a.TextureType.packedLastDimension, a.TextureType.unpacked, a.TextureType.unpacked]
									},
									l = function(e, t, n, s) {
										var u = r(r({}, c), {
											cacheHint: "" + n
										...
										return r(r({}, u), {
											get: function() {
												return function(e, t, n, s, u) {
													var c = i.getGlsl(e.session.backend.glContext.version),
														l = o(e.calculateTextureWidthAndHeight(u, a.TextureType.packedLastDimension), 2),
														f = l[0],
														p = l[1],
														d = o([f / 4, p], 2),
							...
							708: function(e, t, n) {
								...
								var o = n(2517),
									...
									c = n(2823),
									l = n(5623);
								t.createPackedMatmulProgramInfoLoader = function(e, t, n) {
									var f, p, d = (f = t.length > 2, p = n.activationCacheKey, {
										name: "MatMul (packed)",
										inputNames: f ? ["A", "B", "Bias"] : ["A", "B"],
										inputTypes: f ? [s.TextureType.packed, s.TextureType.packed, s.TextureType.packed] : [s.TextureType.packed, s.TextureType.packed],
										cacheHint: p
									});
									return r(r({}, d), {
										get: function() {
											return function(e, t, n, f) {
												var p = n.length > 2,
													d = p ? "value += getBiasForMatmul();" : "",
													h = n[0].dims,
													g = n[1].dims,
													b = o.BroadcastUtil.calcShape(h, g, !0),
													y = !i.ShapeUtil.areEqual(n[0].dims, n[1].dims);
												if (!b) throw new Error("Can't use matmul on the given tensors");
												var m = h[h.length - 1],
													v = Math.ceil(m / 2),
													_ = h.length,
													w = g.length,
													x = a.getGlsl(e.session.backend.glContext.version),
													T = u.getCoordsDataType(b.length),
													S = b.length,
													O = u.getGlChannels(),
													A = c.getActicationSnippet(f),
													E = A.activationFunction,
													I = A.applyActivation,
													P = p ? "" + l.getBiasForMatmul(T, O, n[2].dims, b, !0) : "",
													D = y ? "" + function(e, t, n, r) {
														var i = [],
															a = [],
															s = n[0].dims,
															u = n[1].dims,
														...
														(i = s.map((function(e, n) {
															return "coords." + t[n + p]
														})))[c - 1] = "i*2", i.join(", "), (a = u.map((function(e, n) {
															return "coords." + t[n + d]
														})))[l - 2] = "i*2", a.join(", ");
														var h = o.BroadcastUtil.getBroadcastDims(s, r),
															g = o.BroadcastUtil.getBroadcastDims(u, r),
															b = h.map((function(e) {
																return "coords." + t[e + p] + " = 0;"
															})).join("\n"),
															y = g.map((function(e) {
																return "coords." + t[e + d] + " = 0;"
															})).join("\n"),
															m = "int lastDim = coords." + t[f - 1] + ";\n  coords." + t[f - 1] + " = coords." + t[f - 2] + ";\n  coords." + t[f - 2] + " = lastDim;";
														return "\nvec4 getAAtOutCoordsMatmul(int i) {\n  " + e + " coords = getOutputCoords();\n  " + m + "\n  " + b + "\n  vec4 outputValue = getA(" + i + ");\n  return outputValue;\n}\n\nvec4 getBAtOutCoordsMatmul(int i) {\n  " + e + " coords = getOutputCoords();\n  " + m + "\n  " + y + "\n  vec4 outputValue = getB(" + a + ");\n  return outputValue;\n}"
													}(T, O, n, b) : "",
													k = y ? "getAAtOutCoordsMatmul(i)" : "getA(" + function(e, t) {
														for (var n = "", r = 0; r < t - 2; r++) n += "rc." + e[r] + ", ";
														return n + "rc." + e[t - 2] + ", i*2"
													}(O, _) + ")",
													N = y ? "getBAtOutCoordsMatmul(i)" : "getB(" + function(e, t) {
														for (var n = "", r = 0; r < t - 2; r++) n += "rc." + e[r] + ", ";
														return n + "i*2, rc." + e[t - 1]
													}(O, w) + ")",
							...
							5623: function(e, t, n) {
								...
								function c(e, t) {
									var n, u, c = (n = e.length > 2, u = t.activationCacheKey, {
										name: "MatMul",
										inputNames: n ? ["A", "B", "Bias"] : ["A", "B"],
										inputTypes: n ? [i.TextureType.unpacked, i.TextureType.unpacked, i.TextureType.unpacked] : [i.TextureType.unpacked, i.TextureType.unpacked],
										cacheHint: u
									});
									return r(r({}, c), {
										get: function() {
											return function(e, t, n) {
												var u = t[0].dims,
													c = t[1].dims,
													l = o.BroadcastUtil.calcShape(u, c, !0);
												if (!l) throw new Error("Can't use matmul on the given tensors");
												var p = a.getCoordsDataType(l.length),
													d = a.getGlChannels(),
													h = s.getActicationSnippet(n),
													g = h.activationFunction,
													b = h.applyActivation,
													y = t.length > 2,
													m = y ? "value += getBiasForMatmul();" : "",
													v = y ? "" + f(p, d, t[2].dims, l, !1) : "",
													_ = l.length,
													w = u.length,
													x = c.length,
								...
								t.matMul = function(e, t, n) {
									return l(t), e.session.pack ? [e.run(u.createPackedMatmulProgramInfoLoader(e, t, n), t)] : [e.run(c(t, n), t)]
								}, t.parseMatMulAttributes = function(e) {
									return s.parseInternalActivationAttributes(e.attributes)
								}, t.createMatmulProgramInfoLoader = c;
								var l = function(e) {
								...
								function f(e, t, n, r, i) {
									var a, s = n.length,
										u = r.length,
										c = u - s;
									a = u < 2 && s > 0 ? "coords" : n.map((function(e, n) {
										return "coords." + t[n + c]
									})).join(", ");
									var l = o.BroadcastUtil.getBroadcastDims(n, r).map((function(e) {
											return "coords." + t[e + c] + " = 0;"
										})).join("\n"),
										f = "vec4(outputValue.xx, outputValue.yy)";
									return 1 === o.ShapeUtil.size(n) && (f = "vec4(outputValue.x)"), i ? "\nvec4 getBiasForMatmul() {\n  " + e + " coords = getOutputCoords();\n  " + l + "\n  vec4 outputValue = getBias(" + a + ");\n  return " + f + ";\n}" : "\nfloat getBiasForMatmul() {\n  " + e + " coords = getOutputCoords();\n  " + l + "\n  return getBias(coords.x);\n}"
								}
								t.getBiasForMatmul = f
							},
							2403: function(e, t, n) {
								var r = this && this.__assign || function() {
									return (r = Object.assign || function(e) {
								...
								t.createPackProgramInfoLoader = function(e, t) {
									return r(r({}, u), {
										get: function() {
											return function(e, t) {
												var n, c, l, f, p = o.getGlsl(e.session.backend.glContext.version),
													d = t.dims,
													h = d.length,
													g = t.dims.length,
													b = a.getCoordsDataType(g),
													y = s.getChannels("rc", g),
													m = (n = g, c = y, l = d[d.length - 2], f = d[d.length - 1], 0 === n || 1 === n ? "" : "\n    int r = " + c[n - 2] + ";\n    int c = " + c[n - 1] + ";\n    int rp1 = " + c[n - 2] + " + 1;\n    int cp1 = " + c[n - 1] + " + 1;\n    bool rEdge = rp1 >= " + f + ";\n    bool cEdge = cp1 >= " + l + ";\n    "),
													v = function(e, t, n) {
														if (0 === e) return "false";
														if (1 === e) return "rc > " + t[0];
														for (var r = "", o = e - 2; o < e; o++) r += n[o] + " >= " + t[o - e + 2], o < e - 1 && (r += "||");
														return r
													}(g, 0 === h ? [1, 1] : 1 === h ? [d[0], 1] : [d[g - 1], d[g - 2]], y),
													_ = function(e, t) {
														var n = e.length;
							...
							2827: function(e, t, n) {
								...
								function o(e, t) {
									return r.getGlChannels(t).map((function(t) {
										return e + "." + t
									}))
								}
							...
							2870: function(e, t, n) {
								...
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.parsePadAttributes = t.pad = void 0;
								var i = n(246),
									a = n(2517),
									s = n(5060),
									u = n(2039),
								...
								t.pad = function(e, t, n) {
									return f(t), [e.run(r(r({}, c), {
										cacheHint: n.cacheKey,
										get: function() {
											return l(e, t, n)
										}
									}), t)]
								}, t.parsePadAttributes = function(e) {
									var t = e.attributes.getString("mode", "constant"),
										n = e.attributes.getFloat("value", 0),
										r = e.attributes.getInts("pads");
									return i.createAttributeWithCacheKey({
										mode: t,
										value: n,
										pads: r
								...
								var l = function(e, t, n) {
										var r = a.ShapeUtil.padShape(t[0].dims.slice(), n.pads),
											o = r.length,
									...
									p = function(e, t, n) {
										var r = s.getGlsl(e.session.backend.glContext.version),
											i = o(e.calculateTextureWidthAndHeight(t.dims, u.TextureType.unpacked), 2),
											c = i[0],
											l = i[1],
											f = a.ShapeUtil.computeStrides(t.dims);
										switch (n.mode) {
											case "constant":
												return d(r, t.dims, f, c, l, n.pads, n.value);
											case "reflect":
												return h(r, t.dims, f, c, l, n.pads);
											case "edge":
												return g(r, t.dims, f, c, l, n.pads);
											default:
												throw new Error("Invalid mode")
										}
									},
									d = function(e, t, n, r, o, i, a) {
										for (var s = t.length, u = "", c = s - 1; c >= 0; --c) u += "\n        k = m[" + c + "] - " + i[c] + ";\n        if (k < 0)  return constant;\n        if (k >= " + t[c] + ") return constant;\n        offset += k * " + n[c] + ";\n        ";
										return "\n      float padA(int m[" + s + "]) {\n        const float constant = float(" + a + ");\n        int offset = 0;\n        int k = 0;\n        " + u + "\n        vec2 coords = offsetToCoords(offset, " + r + ", " + o + ");\n        float value = getColorAsFloat(" + e.texture2D + "(A, coords));\n        return value;\n      }\n      "
									},
									h = function(e, t, n, r, o, i) {
										for (var a = t.length, s = "", u = a - 1; u >= 0; --u) s += "\n        k = m[" + u + "] - " + i[u] + ";\n        if (k < 0) { k = -k; }\n        {\n          const int _2n_1 = " + 2 * (t[u] - 1) + ";\n          k = int( mod( float(k), float(_2n_1) ) ) ;\n          if(k >= " + t[u] + ") { k = _2n_1 - k; }\n        }\n        offset += k * " + n[u] + ";\n        ";
										return "\n      float padA(int m[" + a + "]) {\n        int offset = 0;\n        int k = 0;\n        " + s + "\n        vec2 coords = offsetToCoords(offset, " + r + ", " + o + ");\n        float value = getColorAsFloat(" + e.texture2D + "(A, coords));\n        return value;\n      }\n      "
									},
							...
							2143: function(e, t, n) {
								...
								}, t.parseAveragePoolAttributes = function(e) {
									var t = e.attributes.getString("auto_pad", "NOTSET"),
										n = e.attributes.getInt("ceil_mode", 0),
										r = 0 !== e.attributes.getInt("count_include_pad", 0),
								...
								var s = function(e, t, n, o) {
									...
									i.PoolConvUtil.adjustPoolAttributes(n, s, o.kernelShape, o.strides, o.pads);
									var u = i.PoolConvUtil.computePoolOutputShape(n, s, o.strides, o.kernelShape, o.pads, o.autoPad),
										c = i.ShapeUtil.size(o.kernelShape),
										l = "";
									o.countIncludePad ? l += "value /= float(" + c + ");" : l += "value /= float(" + c + " - pad);";
									var f = "\n        " + p(e[0].dims, o, "value += _X(x);", l, "0.0") + "\n      ";
									return r(r({}, t), {
										output: {
											dims: u,
											type: e[0].type,
								...
								t.globalAveragePool = function(e, t, n) {
									f(t);
									var o = {
								...
								}, t.parseGlobalAveragePoolAttributes = function(e) {
									var t = 0 !== e.attributes.getInt("count_include_pad", 0);
									return o.createAttributeWithCacheKey({
										autoPad: "",
										ceilMode: 0,
										countIncludePad: t,
								...
								}, t.parseMaxPoolAttributes = function(e) {
									var t = e.attributes.getString("auto_pad", "NOTSET"),
										n = e.attributes.getInt("ceil_mode", 0),
										r = e.attributes.getInts("kernel_shape"),
								...
								t.globalMaxPool = function(e, t) {
									return f(t), [e.run(r(r({}, l), {
										get: function() {
											return u(t, l, !0, c)
										}
									}), t)]
								...
								var f = function(e) {
									...
									p = function(e, t, n, r, o) {
										...
										if (t.kernelShape.length <= 2) {
											var s, u = t.kernelShape[t.kernelShape.length - 1],
												c = t.strides[t.strides.length - 1],
												l = t.pads[t.pads.length / 2 - 1],
												f = t.pads[t.pads.length - 1],
												p = e[a - 1],
												g = "",
												b = "";
											if (s = l + f !== 0 ? "\n          for (int i = 0; i < " + u + "; i++) {\n            x[" + a + " - 1] = indices[" + a + " - 1] * " + c + " - " + l + " + i;\n            if (x[" + a + " - 1] < 0 || x[" + a + " - 1] >= " + p + ") {\n              pad++;\n              continue;\n            }\n            " + n + "\n          }" : "\n          for (int i = 0; i < " + u + "; i++) {\n            x[" + a + " - 1] = indices[" + a + " - 1] * " + c + " - " + l + " + i;\n            " + n + "\n          }", 2 === t.kernelShape.length) {
												var y = t.kernelShape[t.kernelShape.length - 2],
													m = t.strides[t.strides.length - 2],
													v = t.pads[t.pads.length / 2 - 2],
													_ = t.pads[t.pads.length - 2],
													w = e[a - 2];
												g = v + _ !== 0 ? "\n            for (int j = 0; j < " + y + "; j++) {\n              x[" + a + " - 2] = indices[" + a + " - 2] * " + m + " - " + v + " + j;\n              if (x[" + a + " - 2] < 0 || x[" + a + " - 2] >= " + w + ") {\n                pad+= " + u + ";\n                continue;\n              }\n          " : "\n            for (int j = 0; j < " + y + "; j++) {\n              x[" + a + " - 2] = indices[" + a + " - 2] * " + m + " - " + v + " + j;\n            ", b = "\n          }\n        "
											}
											return "\n        float process(int indices[" + a + "]) {\n          int x[" + a + "];\n          copyVec(indices, x);\n\n          float value = " + o + ";\n          int pad = 0;\n          " + g + "\n          " + s + "\n          " + b + "\n          " + r + "\n          return value;\n        }\n      "
										}
										var x = i.ShapeUtil.size(t.kernelShape),
											T = i.ShapeUtil.computeStrides(t.kernelShape),
											S = T.length,
											O = t.pads.length,
											A = h(S),
											E = d(e, "inputDims"),
							...
							4939: function(e, t, n) {
								...
								var o = n(246),
									...
									u = function(e, t, n, o, i) {
										...
										return [e.run(r(r({}, a), {
											cacheHint: n.cacheKey,
											get: function() {
												return c(e, t, n, o, i, a)
											}
										}), t)]
									};
								t.parseReduceAttributes = function(e) {
									var t = e.attributes.getInts("axes", []),
								...
								var c = function(e, t, n, o, i, u) {
										for (var c = [], l = t[0].dims.length || 1, f = [], p = a.ShapeUtil.normalizeAxes(n.axes, t[0].dims.length), d = i(t, p), h = d[1], g = 0; g < t[0].dims.length; g++) p.indexOf(g) >= 0 || 0 === p.length ? (n.keepDims && c.push(1), h = "\n          for(int j" + g + " = 0; j" + g + " < " + t[0].dims[g] + "; j" + g + "++) {\n            inputIdx[" + g + "] = j" + g + ";\n            " + h + "\n          }") : (f.push("inputIdx[" + g + "] = outputIdx[" + c.length + "];"), c.push(t[0].dims[g]));
								...
								t.reduceSum = function(e, t, n) {
									return u(e, t, n, "ReduceSum", (function() {
										return ["value = 0.0;", "value += _A(inputIdx);", ""]
									}))
								}, t.reduceMean = function(e, t, n) {
									return u(e, t, n, "ReduceMean", (function(e, t) {
										for (var n = 1, r = 0; r < e[0].dims.length; r++)(t.indexOf(r) >= 0 || 0 === t.length) && (n *= e[0].dims[r]);
										return ["value = 0.0;", "value += _A(inputIdx);", "value /= " + n + ".;"]
									}))
								}, t.reduceMax = function(e, t, n) {
									return u(e, t, n, "ReduceMax", (function(e, t) {
										for (var n = [], r = 0; r < e[0].dims.length; r++)(t.indexOf(r) >= 0 || 0 === t.length) && n.push("inputIdx[" + r + "] = 0;");
										return [n.join("\n") + "\nvalue = _A(inputIdx);", "value = max(value, _A(inputIdx));", ""]
									}))
								}, t.reduceMin = function(e, t, n) {
									return u(e, t, n, "ReduceMin", (function(e, t) {
										for (var n = [], r = 0; r < e[0].dims.length; r++)(t.indexOf(r) >= 0 || 0 === t.length) && n.push("inputIdx[" + r + "] = 0;");
										return [n.join("\n") + "\nvalue = _A(inputIdx);", "value = min(value, _A(inputIdx));", ""]
									}))
								}, t.reduceProd = function(e, t, n) {
									return u(e, t, n, "ReduceProd", (function() {
										return ["value = 1.0;", "value *= _A(inputIdx);", ""]
									}))
								}, t.reduceLogSum = function(e, t, n) {
									return u(e, t, n, "ReduceLogSum", (function() {
										return ["value = 0.0;", "value += _A(inputIdx);", "value = log(value);"]
									}))
								}, t.reduceLogSumSquare = function(e, t, n) {
									return u(e, t, n, "ReduceLogSumSquare", (function() {
							...
							7019: function(e, t, n) {
								...
								var o = n(2517),
									...
									a = n(2039),
									s = n(2827);
								t.createPackedReshape3DProgramInfoLoader = function(e, t, n) {
									var u = function(e) {
										return {
											name: "Reshape (packed)",
											inputTypes: [a.TextureType.packed],
											inputNames: ["A"],
											cacheHint: "" + e
										}
									}(n);
									return r(r({}, u), {
										get: function() {
											return function(e, t, n, u) {
												for (var c = t.dims, l = u, f = "", p = 0; p < 4; p++) {
													var d = "";
													switch (p) {
														case 0:
															d = "outputCoords = rc;";
															break;
														case 1:
															d = "outputCoords = ivec3(rc.x, rc.y+1, rc.z);";
															break;
														case 2:
															d = "outputCoords = ivec3(rc.x, rc.y, rc.z+1);";
															break;
														case 3:
															d = "outputCoords = ivec3(rc.x, rc.y+1, rc.z+1);";
															break;
														default:
															throw new Error
													}
												...
												var h, g, b, y = i.getGlsl(e.session.backend.glContext.version),
													m = "\n      " + (h = c, g = o.ShapeUtil.computeStrides(h), b = ["b", "r", "c"], "\n    ivec3 inputCoordsFromReshapedOutCoords(int index) {\n      " + g.map((function(e, t) {
														return "int " + b[t] + " = index / " + e + "; " + (t === g.length - 1 ? "int " + b[t + 1] + " = index - " + b[t] + " * " + e : "index -= " + b[t] + " * " + e) + ";"
													})).join("") + "\n      return ivec3(b, r, c);\n    }\n  \n      ") + function(e) {
														var t = o.ShapeUtil.computeStrides(e);
												...
												return r(r({}, n), {
													output: {
														dims: l,
														type: t.type,
														textureType: a.TextureType.packed
													},
													shaderSource: m,
													hasMain: !0
												})
									...
									for (var t = 1, n = 0; n < e.length - 2; ++n) t *= e[n];
									return [t, e.length > 1 ? e[e.length - 2] : 1, e[e.length - 1]]
								}, t.isReshapeCheap = function(e, t) {
									return 0 === e.length || 0 === t.length || (e.length < 2 || t.length < 2 ? e[e.length - 1] === t[t.length - 1] : e[e.length - 1] === t[t.length - 1] && e[e.length - 2] === t[t.length - 2])
								}
							},
							718: function(e, t, n) {
								Object.defineProperty(t, "__esModule", {
								...
								var r = n(2517);
								t.reshape = function(e, t) {
									var n = r.ShapeUtil.calculateReshapedDims(t[0].dims, t[1].integerData);
							...
							2268: function(e, t, n) {
								...
								t.resize = function(e, t, n) {
									return c.validateInputs(t, n), [e.run(r(r({}, l), {
										cacheHint: n.cacheKey,
										get: function() {
											return f(e, t, n)
										}
									}), t)]
								}, t.parseResizeAttributesV10 = function(e) {
									return c.parseUpsampleAttributes(e, 10)
								}, t.parseResizeAttributesV11 = function(e) {
									return c.parseUpsampleAttributes(e, 11)
								};
								var f = function(e, t, n) {
										...
										if (d.every((function(e) {
												return 1 === e
											})) && "tf_crop_and_resize" !== n.coordinateTransformMode) return r(r({}, l), {
											output: {
												dims: h,
												type: t[0].type,
												textureType: a.TextureType.packed
										...
										var g = h.length;
										if (g < 2) throw new Error("output dimension should be at least 2, but got " + g);
										var b = h[g - 2],
											y = h[g - 1],
											m = t[0].dims;
										if (g !== m.length) throw new Error("output dimension should match input " + m.length + ", but got " + g);
										var v = m[g - 2],
											_ = m[g - 1],
											w = d[g - 2],
											x = d[g - 1],
									...
									p = function(e, t) {
										var n, r = e[0].dims,
											o = t.scales;
										if (0 === o.length) {
											var i = e[t.scalesInputIdx];
											if (i && 0 !== i.size) {
												if (e[t.sizesInputIdx]) throw new Error("Only one of scales or sizes must be provided as input.");
												o = d(i, t.mode, t.isResize)
											} else {
												var a = e[t.sizesInputIdx];
												if (!a || 0 === a.size) throw new Error("Either scales or sizes MUST be provided as input.");
												n = Array.from(a.integerData), o = h(n, r, t.mode, t.isResize)
											}
										} else if (e[t.sizesInputIdx]) throw new Error("Only one of scales or sizes must be provided as input.");
										var s = n || r.map((function(e, t) {
											return Math.floor(e * o[t])
										}));
										return [o, s]
									},
									d = function(e, t, n) {
										var r = Array.from(e.floatData);
										return c.scalesValidation(r, t, n), r
									},
									h = function(e, t, n, r) {
										for (var o = t.length, i = new Array(o), a = 0, s = o; a < s; a++)
											if (0 === t[a]) {
												if (0 !== e[a]) throw new Error("Input dim is zero but required output dim is non-zero.");
												i[a] = 1
											} else i[a] = e[a] / t[a];
										return c.scalesValidation(i, n, r), i
									}
							},
							8117: function(e, t, n) {
								Object.defineProperty(t, "__esModule", {
								...
								var r = n(9162);
								t.shape = function(e, t) {
									return o(t), [new r.Tensor([t[0].dims.length], "int32", void 0, void 0, new Int32Array(t[0].dims))]
								};
								var o = function(e) {
							...
							2278: function(e, t, n) {
								...
								}, t.parseSliceAttributes = function(e) {
									var t = e.attributes.getInts("starts"),
										n = e.attributes.getInts("ends"),
										r = e.attributes.getInts("axes", []);
									return o.createAttributeWithCacheKey({
										starts: t,
										ends: n,
										axes: r
								...
								var c = function(e, t, n) {
										for (var o = 0 === n.axes.length ? t.dims.slice(0).map((function(e, t) {
												return t
											})) : n.axes, i = a.ShapeUtil.normalizeAxes(o, t.dims.length), c = n.starts.map((function(e, n) {
												return e > t.dims[i[n]] - 1 ? t.dims[i[n]] : a.ShapeUtil.normalizeAxis(e, t.dims[i[n]])
											})), l = n.ends.map((function(e, n) {
												return e > t.dims[i[n]] - 1 ? t.dims[i[n]] : a.ShapeUtil.normalizeAxis(e, t.dims[i[n]])
											})), f = t.dims.slice(), p = [], d = 0; d < i.length; d++) f[i[d]] = l[d] - c[d], c[d] > 0 && p.push("outputIdx[" + i[d] + "] += " + c[d] + ";");
								...
								var f = function(e, t) {
										...
										if (t.length >= 5 && t[4].integerData.some((function(e) {
												return 1 !== e
											}))) throw new Error("currently non-1 steps is not supported for Slice");
										var n = Array.from(t[1].integerData),
							...
							5524: function(e, t, n) {
								...
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.parseSoftmaxAttributes = t.softmax = void 0;
								var i = n(246),
									a = n(2517),
									s = n(5060),
									u = n(2039),
									...
									l = {
										...
										inputNames: ["A", "Max"],
										inputTypes: [u.TextureType.unpacked, u.TextureType.unpacked]
									},
									f = {
										name: "SoftMax",
										inputNames: ["A", "Max", "Norm"],
										inputTypes: [u.TextureType.unpacked, u.TextureType.unpacked, u.TextureType.unpacked]
									};
								t.softmax = function(e, t, n) {
									g(t);
									var o = t[0].dims.slice(),
										i = a.ShapeUtil.normalizeAxis(n.axis, o.length),
										s = a.ShapeUtil.sizeToDimension(o, i),
										u = a.ShapeUtil.sizeFromDimension(o, i),
										b = p(e, t[0], s, u, [s]),
										y = e.run(r(r({}, c), {
											cacheHint: n.cacheKey,
											get: function() {
										...
										_ = h(e, t[0], s, u, b.output.dims, m.output.dims);
									return [e.run(r(r({}, f), {
										cacheHint: n.cacheKey,
										get: function() {
											return _
								...
								}, t.parseSoftmaxAttributes = function(e) {
									return i.createAttributeWithCacheKey({
										axis: e.attributes.getInt("axis", 1)
									})
								};
								var p = function(e, t, n, i, a) {
										var l = o(e.calculateTextureWidthAndHeight(t.dims, u.TextureType.unpacked), 2),
											f = l[0],
											p = l[1],
											d = a.length;
										if (n < 1 || i < 1) throw new Error("Logical row count N and feature count D must be greater than or equal to 1");
										...
										var h = s.getGlsl(e.session.backend.glContext.version),
									...
									d = function(e, t, n, i, a, c) {
										var f = o(e.calculateTextureWidthAndHeight(t.dims, u.TextureType.unpacked), 2),
											p = f[0],
											d = f[1],
											h = c.length;
										if (n < 1 || i < 1) throw new Error("Logical row count N and feature count D must be greater than or equal to 1");
										if (1 !== c.length) throw new Error("Dimensionality of the output should be 1");
										if (c[0] !== n) throw new Error("Shape of the output should be equal to logical row count");
										if (1 !== a.length) throw new Error("Dimensionality of the intermediate results should be 1");
										if (a[0] !== n) throw new Error("Shape of the intermediate results should be equal to logical row count");
									...
									h = function(e, t, n, i, a, s) {
										var c = o(e.calculateTextureWidthAndHeight(t.dims, u.TextureType.unpacked), 2),
											l = c[0],
											p = c[1],
											d = t.dims.length;
										if (n < 1 || i < 1) throw new Error("Logical row count N and feature count D must be greater than or equal to 1");
										if (1 !== a.length || 1 !== s.length) throw new Error("Dimensionality of the intermediate results should be 1");
										if (a[0] !== n || s[0] !== n) throw new Error("Shape of the intermediate results should be equal to logical row count");
							...
							5975: function(e, t, n) {
								...
								t.split = function(e, t, n) {
									f(t);
									for (var o = a.ShapeUtil.normalizeAxis(n.axis, t[0].dims.length), i = c(e, t, o, n), s = [], p = function(i) {
											s.push(e.run(r(r({}, u), {
												cacheHint: n.cacheKey + ";" + i,
												get: function() {
													return l(e, t[0], n, o, i)
												}
											}), t))
										}, d = 0; d < i; ++d) p(d);
									return s
								}, t.parseSplitAttributes = function(e) {
									var t = e.attributes.getInt("axis", 0),
								...
								var c = function(e, t, n, r) {
										return o(a.SplitUtil.splitShape(t[0].dims, n, r.split, r.numOutputs), 2)[1].length
									},
									l = function(e, t, n, i, c) {
										var l = o(a.SplitUtil.splitShape(t.dims, i, n.split, n.numOutputs), 2),
											f = l[0],
											p = l[1][c],
											d = f[c],
											h = "\n      float process(int indices[" + d.length + "]) {\n        indices[" + i + "] += " + p + ";\n        return _A(indices);\n      }\n    ";
										return r(r({}, u), {
											cacheHint: n.cacheKey + ":" + c,
											output: {
												dims: d,
												type: t.type,
												textureType: s.TextureType.unpacked
							...
							3933: function(e, t, n) {
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.parseSqueezeAttributes = t.squeeze = void 0;
								var r = n(2517);
								t.squeeze = function(e, t, n) {
									o(t);
									var i = r.ShapeUtil.squeezeShape(t[0].dims, n);
									return [e.reshapeUnpacked(t[0], i)]
								}, t.parseSqueezeAttributes = function(e) {
									return e.attributes.getInts("axes")
								};
								var o = function(e) {
							...
							6558: function(e, t, n) {
								...
								var a = function(e, t, n) {
										var a = o.getGlsl(e.session.backend.glContext.version),
											s = t[0].dims.slice(),
											u = "\n      void main() {\n        vec4 result = " + t.map((function(e, t) {
												return a.texture2D + "(X" + t + ",TexCoords)"
											})).join(" + ") + ";\n        " + a.output + " = result;\n      }\n    ";
										return r(r({}, n), {
											output: {
												dims: s,
									...
									s = function(e) {
										...
										for (var t = e[0].dims.length, n = 1; n < e.length; n++) {
											if (t !== e[n].dims.length) throw new Error("Input shapes are mismatched.");
											for (var r = 0; r < t; r++)
												if (e[0].dims[r] !== e[n].dims[r]) throw new Error("Input shapes are not matched.")
										}
										if ("float32" !== e[0].type && "float64" !== e[0].type) throw new Error("Invalid input type.");
										for (n = 1; n < e.length; n++)
											if (e[0].type !== e[n].type) throw new Error("Input types are not matched.")
									}
							},
							5723: function(e, t, n) {
								var r = this && this.__assign || function() {
								...
								var a = function(e, t, n) {
										for (var o = t[0].dims.slice(), a = new Array(o.length), s = [], u = 0; u < o.length; u++) a[u] = o[u] * t[1].numberData[u], s.push("inputIdx[" + u + "] = int(mod(float(outputIdx[" + u + "]), " + o[u] + ".));");
										var c = a.length,
							...
							3738: function(e, t, n) {
								...
								t.transpose = function(e, t, n) {
									return h(t), [e.run(r(r({}, c), {
										cacheHint: n.cacheKey,
										get: function() {
											return l(e, t[0], n.perm)
										}
									}), t)]
								}, t.parseTransposeAttributes = function(e) {
									return a.createAttributeWithCacheKey({
								...
								var l = function(e, t, n) {
									...
									f = function(e, t) {
										return t && t.length !== e.length && (t = i([], o(e.keys())).reverse()), t
									},
									p = function(e, t) {
										return t = f(e, t), s.ShapeUtil.sortBasedOnPerm(e, t)
									},
									d = function(e, t, n) {
										var r = [];
										r.push("void " + e + "(out int a[" + n + "], int src[" + n + "]) {");
										for (var o = 0; o < n; ++o) r.push("\ta[" + t[o] + "]=src[" + o + "];");
							...
							8710: function(e, t, n) {
								...
								var r = n(5060),
									o = n(2039);
								t.encodeAsUint8 = function(e, t) {
									var n = t.shape,
										i = r.getGlsl(e.session.backend.glContext.version),
							...
							4909: function(e, t, n) {
								...
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.tanh = t.tan = t.sqrt = t.sin = t.sigmoid = t.relu = t.not = t.neg = t.log = t.parseLeakyReluAttributes = t.leakyRelu = t.identity = t.floor = t.exp = t.parseEluAttributes = t.elu = t.cos = t.ceil = t.parseClipAttributes = t.clip = t.atan = t.asin = t.acos = t.abs = t.glslTanh = t.glslTan = t.glslSqrt = t.glslSigmoid = t.glslRelu = t.glslSin = t.glslNot = t.glslNeg = t.glslLog = t.glslLeakyRelu = t.glslIdentity = t.glslClip = t.glslFloor = t.glslExp = t.glslElu = t.glslCos = t.glslCeil = t.glslAtan = t.glslAsin = t.glslAcos = t.glslAbs = void 0;
								var o = n(246),
									i = n(8520),
									a = n(5060),
									s = n(2039);
								...
								t.glslAbs = u, t.glslAcos = c, t.glslAsin = l, t.glslAtan = f, t.glslCeil = p, t.glslCos = d, t.glslElu = h, t.glslExp = g, t.glslFloor = b, t.glslClip = y, t.glslIdentity = m, t.glslLeakyRelu = v, t.glslLog = _, t.glslNeg = w, t.glslNot = x, t.glslSin = T, t.glslRelu = S, t.glslSigmoid = O, t.glslSqrt = A, t.glslTan = E, t.glslTanh = I;
								var D = function(e, t, n, o) {
									var i = e.session.pack ? s.TextureType.packed : s.TextureType.unpacked,
										u = {
											name: n.name,
											inputTypes: [i],
											inputNames: ["A"],
									...
									return r(r({}, u), {
										get: function() {
											return function(e, t, n, o) {
												var i = e.session.pack ? s.TextureType.packed : s.TextureType.unpacked,
													u = a.getGlsl(e.session.backend.glContext.version);
												return r(r({}, t), {
													output: {
														dims: n.dims,
														type: n.type,
								...
								t.abs = function(e, t) {
									return [e.run(D(e, t[0], u()), t)]
								}, t.acos = function(e, t) {
									return [e.run(D(e, t[0], c()), t)]
								}, t.asin = function(e, t) {
									return [e.run(D(e, t[0], l()), t)]
								}, t.atan = function(e, t) {
									return [e.run(D(e, t[0], f()), t)]
								}, t.clip = function(e, t, n) {
									return [e.run(D(e, t[0], y(n.min, n.max), n.cacheKey), t)]
								}, t.parseClipAttributes = function(e) {
									return o.createAttributeWithCacheKey({
										min: e.attributes.getFloat("min", -34028234663852886e22),
										max: e.attributes.getFloat("max", 34028234663852886e22)
									})
								}, t.ceil = function(e, t) {
									return [e.run(D(e, t[0], p()), t)]
								}, t.cos = function(e, t) {
									return [e.run(D(e, t[0], d()), t)]
								}, t.elu = function(e, t, n) {
									return [e.run(D(e, t[0], h(n.alpha), n.cacheKey), t)]
								}, t.parseEluAttributes = function(e) {
									return o.createAttributeWithCacheKey({
										alpha: e.attributes.getFloat("alpha", 1)
									})
								}, t.exp = function(e, t) {
									return [e.run(D(e, t[0], g()), t)]
								}, t.floor = function(e, t) {
									return [e.run(D(e, t[0], b()), t)]
								}, t.identity = function(e, t) {
									return [e.run(D(e, t[0], m()), t)]
								}, t.leakyRelu = function(e, t, n) {
									return [e.run(D(e, t[0], v(n.alpha), n.cacheKey), t)]
								}, t.parseLeakyReluAttributes = function(e) {
									return o.createAttributeWithCacheKey({
										alpha: e.attributes.getFloat("alpha", .01)
									})
								}, t.log = function(e, t) {
									return [e.run(D(e, t[0], _()), t)]
								}, t.neg = function(e, t) {
									return [e.run(D(e, t[0], w()), t)]
								}, t.not = function(e, t) {
									return [e.run(D(e, t[0], x()), t)]
								}, t.relu = function(e, t) {
									return [e.run(D(e, t[0], S()), t)]
								}, t.sigmoid = function(e, t) {
									return [e.run(D(e, t[0], O()), t)]
								}, t.sin = function(e, t) {
									return [e.run(D(e, t[0], T()), t)]
								}, t.sqrt = function(e, t) {
									return [e.run(D(e, t[0], A()), t)]
								}, t.tan = function(e, t) {
									return [e.run(D(e, t[0], E()), t)]
								}, t.tanh = function(e, t) {
									return [e.run(D(e, t[0], I()), t)]
								}
							},
							5611: function(e, t, n) {
								var r = this && this.__assign || function() {
								...
								t.createUnpackProgramInfo = function(e, t) {
									var n = t.dims.length,
										c = s.getChannels("rc", n),
										l = c.slice(-2),
										f = a.getCoordsDataType(n),
										p = s.unpackFromChannel(),
										d = 0 === t.dims.length ? "" : function(e, t) {
											if (1 === e) return "rc";
											for (var n = "", r = 0; r < e; r++) n += t[r], r < e - 1 && (n += ",");
											return n
										}(n, c),
										h = n <= 1 ? "rc" : "vec2(" + l.join(",") + ")",
								...
								}, t.createUnpackProgramInfoLoader = function(e, n) {
									return r(r({}, u), {
										get: function() {
											return t.createUnpackProgramInfo(e, n)
										}
									})
								}
							},
							8428: function(e, t, n) {
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.parseUnsqueezeAttributes = t.unsqueeze = void 0;
								var r = n(2517);
								t.unsqueeze = function(e, t, n) {
									o(t);
									var i = r.ShapeUtil.unsqueezeShape(t[0].dims, n);
									return [e.reshapeUnpacked(t[0], i)]
								}, t.parseUnsqueezeAttributes = function(e) {
									return e.attributes.getInts("axes")
								};
								var o = function(e) {
							...
							9793: function(e, t, n) {
								...
								t.upsample = function(e, n, o) {
									return t.validateInputs(n, o), [e.run(r(r({}, c), {
										cacheHint: o.cacheKey,
										get: function() {
											return l(e, n, o)
										}
									}), n)]
								}, t.parseUpsampleAttributesV7 = function(e) {
									return t.parseUpsampleAttributes(e, 7)
								}, t.parseUpsampleAttributesV9 = function(e) {
									return t.parseUpsampleAttributes(e, 9)
								}, t.parseUpsampleAttributes = function(e, n) {
									var r = n >= 10,
										o = e.attributes.getString("mode", "nearest");
									if ("nearest" !== o && "linear" !== o && (n < 11 || "cubic" !== o)) throw new Error("unrecognized mode: " + o);
									var i = [];
									n < 9 && (i = e.attributes.getFloats("scales"), t.scalesValidation(i, o, r));
									var s = e.attributes.getFloat("extrapolation_value", 0),
									...
									var c = "tf_crop_and_resize" === u,
										l = c,
										f = "nearest" === o && n >= 11 ? e.attributes.getString("nearest_mode", "round_prefer_floor") : "";
									if (-1 === ["round_prefer_floor", "round_prefer_ceil", "floor", "ceil", ""].indexOf(f)) throw new Error("nearest_mode '" + f + "' is not supported");
									var p = e.attributes.getFloat("cubic_coeff_a", -.75),
										d = 0 !== e.attributes.getInt("exclude_outside", 0);
									if (d && "cubic" !== o) throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");
									var h = n < 11 || "nearest" === o && "asymmetric" === u && "floor" === f,
										g = 0,
										b = 0,
										y = 0;
									return n > 10 ? (g = 1, b = 2, y = 3) : 9 === n && (b = 1), a.createAttributeWithCacheKey({
										opset: n,
										isResize: r,
										mode: o,
										scales: i,
								...
								var l = function(e, t, n) {
									for (var i = s.getGlsl(e.session.backend.glContext.version), a = o(e.calculateTextureWidthAndHeight(t[0].dims, u.TextureType.unpacked), 2), l = a[0], f = a[1], p = t[0].dims.map((function(e, t) {
											return Math.floor(e * n.scales[t])
										})), d = o(e.calculateTextureWidthAndHeight(p, u.TextureType.unpacked), 2), h = d[0], g = d[1], b = p.length, y = new Array(b), m = new Array(b), v = "\n      int output_pitches[" + b + "];\n      int input_pitches[" + b + "];\n      ", _ = b - 1; _ >= 0; _--) y[_] = _ === b - 1 ? 1 : y[_ + 1] * p[_ + 1], m[_] = _ === b - 1 ? 1 : m[_ + 1] * t[0].dims[_ + 1], v += "\n        output_pitches[" + _ + "] = " + y[_] + ";\n        input_pitches[" + _ + "] = " + m[_] + ";\n        ";
									...
									return r(r({}, c), {
										...
										variables: [{
											...
											data: n.scales.map((function(e) {
												return Math.ceil(e)
											}))
										}]
									})
								};
								t.validateInputs = function(e, t) {
									...
									if ("string" === e[0].type) throw new Error("Invalid input tensor types.")
								}, t.scalesValidation = function(e, t, n) {
									var r, o, a, s;
									if (n) try {
										for (var u = i(e), c = u.next(); !c.done; c = u.next())
											if (c.value <= 0) throw new Error("Scale value should be greater than 0.")
									} catch (e) {
										a = {
											error: e
										}
										...
										for (var l = i(e), f = l.next(); !f.done; f = l.next())
											if (f.value < 1) throw new Error("Scale value should be greater than or equal to 1.")
									} catch (e) {
										r = {
											error: e
										}
							...
							1958: function(e, t, n) {
								...
								var i = n(2174),
									...
									c = function() {
										...
										return e.prototype.getArtifact = function(e) {
											return this.repo.get(e)
										}, e.prototype.setArtifact = function(e, t) {
											this.repo.set(e, t)
										}, e.prototype.run = function(e, t, n) {
											var r, o = this;
											this.profiler.event("op", "ProgramManager.run " + (null !== (r = e.programInfo.name) && void 0 !== r ? r : "unknown kernel"), (function() {
												var r, i = o.glContext.gl,
													s = e.program;
												i.useProgram(s);
												try {
													o.bindOutput(n), o.attributesBound || o.bindAttributes(e.attribLocations), o.bindUniforms(e.uniformLocations, null !== (r = e.programInfo.variables) && void 0 !== r ? r : [], t)
												} catch (t) {
													throw a.Logger.error("ProgramManager", e.programInfo.shaderSource), t
												}
												o.profiler.event("backend", "GlContext.draw()", (function() {
													o.glContext.draw()
												}))
											}), this.glContext)
										}, e.prototype.dispose = function() {
											var e = this;
											this.vertexShader && this.glContext.deleteShader(this.vertexShader), this.repo.forEach((function(t) {
												return e.glContext.deleteProgram(t.program)
											}))
										}, e.prototype.build = function(e, t, n) {
											var r = this;
											return this.profiler.event("backend", "ProgramManager.build", (function() {
												var o = new s.GlslPreprocessor(r.glContext, e, t, n),
													i = o.preprocess(),
													a = r.compile(i);
												return {
													programInfo: e,
													program: a,
													uniformLocations: r.getUniformLocations(a, o.context.programInfo.inputNames, o.context.programInfo.variables),
													attribLocations: r.getAttribLocations(a)
												}
											}))
											...
											if (!this.vertexShader) {
												...
												var t = u.getVertexShaderSource(this.glContext.version);
											...
											var n = this.glContext.compileShader(e, this.glContext.gl.FRAGMENT_SHADER),
												r = this.glContext.createProgram(this.vertexShader, n);
											return this.glContext.deleteShader(n), r
										}, e.prototype.bindOutput = function(e) {
											var t = e.width,
												n = e.height;
											a.Logger.verbose("ProrgramManager", "Binding output texture to Framebuffer: w/h=" + t + "/" + n + ", shape=" + e.shape + ", type=" + e.tensor.type), this.glContext.attachFramebuffer(e.texture, t, n)
										}, e.prototype.bindAttributes = function(e) {
											var t = e.position,
												n = e.textureCoord;
											this.glContext.setVertexAttributes(t, n), this.attributesBound = !0
										}, e.prototype.bindUniforms = function(e, t, n) {
											var r, i, a, s = this.glContext.gl,
												u = 0,
												c = function(e, r, o, i) {
													var c = null === (a = t.find((function(t) {
														return t.name === e
													}))) || void 0 === a ? void 0 : a.data;
													if ("sampler2D" !== r && !c) throw new Error("variable '" + e + "' does not have data defined in program info");
													switch (r) {
														case "sampler2D":
															l.bindTexture(n[u], o, u), u++;
															break;
														case "float":
															i ? s.uniform1fv(o, c) : s.uniform1f(o, c);
															break;
														case "int":
															i ? s.uniform1iv(o, c) : s.uniform1i(o, c);
															break;
														default:
												...
												l = this;
											try {
												for (var f = o(e), p = f.next(); !p.done; p = f.next()) {
													var d = p.value;
													c(d.name, d.type, d.location, d.arrayLength)
												}
											} catch (e) {
												r = {
													error: e
										...
										}, e.prototype.bindTexture = function(e, t, n) {
											this.glContext.bindTextureToUniform(e.texture, n, t)
										}, e.prototype.getAttribLocations = function(e) {
											return {
												position: this.getAttribLocation(e, "position"),
												textureCoord: this.getAttribLocation(e, "textureCoord")
											}
										}, e.prototype.getUniformLocations = function(e, t, n) {
											var i, a, s, u, c = [];
											if (t) try {
												for (var l = o(t), f = l.next(); !f.done; f = l.next()) {
													var p = f.value;
													c.push({
														name: p,
														type: "sampler2D",
														location: this.getUniformLocation(e, p)
													})
												}
											} catch (e) {
												i = {
											...
											if (n) try {
												for (var d = o(n), h = d.next(); !h.done; h = d.next()) {
													var g = h.value;
													c.push(r(r({}, g), {
														location: this.getUniformLocation(e, g.name)
													}))
												}
											} catch (e) {
												s = {
											...
											return c
										}, e.prototype.getUniformLocation = function(e, t) {
											var n = this.glContext.gl.getUniformLocation(e, t);
											if (null === n) throw new Error("Uniform " + t + " not found.");
											return n
										}, e.prototype.getAttribLocation = function(e, t) {
							...
							6416: function(e, t, n) {
								...
								var r = n(6231),
									...
									l = function() {
										function e(e, t) {
											this.backend = e, this.context = t, this.layoutStrategy = new u.PreferLogicalStrategy(e.glContext.maxTextureSize), this.programManager = new s.ProgramManager(this.context.profiler, e.glContext, this.layoutStrategy), this.textureManager = new c.TextureManager(e.glContext, this.layoutStrategy, this.context.profiler, {
										...
										return e.prototype.createInferenceHandler = function() {
											return new i.WebGLInferenceHandler(this)
										}, e.prototype.onGraphInitialized = function(e) {
											var t = e.getValues().filter((function(e) {
												return -1 === e.from && e.tensor
											})).map((function(e) {
												return e.tensor.dataId
											}));
											this.initializers = new Set(t)
										}, e.prototype.isInitializer = function(e) {
											return !!this.initializers && this.initializers.has(e)
										}, e.prototype.addInitializer = function(e) {
											this.initializers.add(e)
										}, e.prototype.getTextureData = function(e, t) {
											return t ? this.packedTextureDataCache.get(e) : this.unpackedTextureDataCache.get(e)
										}, e.prototype.setTextureData = function(e, t, n) {
											void 0 === n && (n = !1), r.Logger.verbose("WebGLSessionHandler", "Storing Texture data in cache"), n ? this.packedTextureDataCache.set(e, t) : this.unpackedTextureDataCache.set(e, t)
										}, e.prototype.dispose = function() {
											var e = this;
											this.programManager.dispose(), this.textureManager.clearActiveTextures(), this.packedTextureDataCache.forEach((function(t) {
												return e.textureManager.releaseTexture(t, !0)
											})), this.packedTextureDataCache = new Map, this.unpackedTextureDataCache.forEach((function(t) {
												return e.textureManager.releaseTexture(t, !0)
											})), this.unpackedTextureDataCache = new Map
										}, e.prototype.resolve = function(e, t, n) {
											var r = o.resolveOperator(e, t, a.WEBGL_OP_RESOLVE_RULES);
											return {
												impl: r.opImpl,
							...
							7769: function(e, t, n) {
								...
								var r = n(6231),
									o = function() {
										function e(e, t) {
											if (void 0 === t && (t = 1), 1 === t) this.internalFormat = e.R32F, this.format = e.RED, this.textureType = e.FLOAT, this.channelSize = t;
											else {
										...
										return e.prototype.encode = function(e, t) {
											var n, o;
											return e.constructor !== Float32Array && (r.Logger.warning("Encoder", "data was not of type Float32; creating new Float32Array"), o = new Float32Array(e)), t * this.channelSize > e.length ? (r.Logger.warning("Encoder", "Source data too small. Allocating larger array"), o = e, n = this.allocate(t * this.channelSize), o.forEach((function(e, t) {
												return n[t] = e
											}))) : n = o = e, n
										}, e.prototype.allocate = function(e) {
											return new Float32Array(4 * e)
										}, e.prototype.decode = function(e, t) {
											return 1 === this.channelSize ? e.filter((function(e, t) {
												return t % 4 == 0
											})).subarray(0, t) : e.subarray(0, t)
										}, e
									}();
								t.RedFloat32DataEncoder = o;
								var i = function() {
									function e(e, t, n) {
										if (void 0 === t && (t = 1), 1 !== t && 4 !== t) throw new Error("Invalid number of channels: " + t);
										this.internalFormat = e.RGBA, this.format = e.RGBA, this.channelSize = t, this.textureType = n || e.FLOAT
									}
									return e.prototype.encode = function(e, t) {
										var n = e;
										return 1 === this.channelSize && (r.Logger.verbose("Encoder", "Exploding into a larger array"), n = this.allocate(t), e.forEach((function(e, t) {
											return n[4 * t] = e
										}))), n
									}, e.prototype.allocate = function(e) {
										return new Float32Array(4 * e)
								...
								t.RGBAFloatDataEncoder = i;
								var a = function() {
									function e(e, t) {
										if (void 0 === t && (t = 1), this.channelSize = 4, 1 === t) this.internalFormat = e.ALPHA, this.format = e.ALPHA, this.textureType = e.UNSIGNED_BYTE, this.channelSize = t;
										else {
											if (4 !== t) throw new Error("Invalid number of channels: " + t);
							...
							7859: function(e, t, n) {
								...
								var r = n(6231),
									...
									i = function() {
										...
										return e.prototype.computeTextureWH = function(e, t) {
											if (0 === e.length) return [1, 1];
											var n = this.maxTextureSize;
											if (t && void 0 !== t.breakAxis) {
												var o = t.breakAxis >= e.length ? 1 : e.slice(t.breakAxis).reduce((function(e, t) {
														return e * t
													})),
													i = t.breakAxis <= 0 ? 1 : e.slice(0, t.breakAxis).reduce((function(e, t) {
														return e * t
													}));
											...
											for (var a = e.reduce((function(e, t) {
													return e * t
												})), s = Math.floor(Math.sqrt(a)); s < n && s < a && a % s != 0; s++);
											if (s >= n || a % s != 0) throw new Error("The given dimensions are outside this GPU's boundaries: " + e);
											return [s, a / s]
										}, e
									}();
								t.AlwaysKeepOriginalSizeStrategy = i;
								var a = function() {
									function e(e) {
										this.maxTextureSize = e
									}
									return e.prototype.computeTextureWH = function(e, t) {
										var n = this.computeTexture(e, t);
										return t && t.isPacked && (n[0] /= 2, n[1] /= 2), t && t.reverseWH ? [n[1], n[0]] : n
									}, e.prototype.computeTexture = function(e, t) {
										var n = t && t.isPacked;
										if (0 === e.length) return n ? [2, 2] : [1, 1];
										var o = this.maxTextureSize;
										if (t && void 0 !== t.breakAxis) {
											var i = t.breakAxis >= e.length ? 1 : e.slice(t.breakAxis).reduce((function(e, t) {
													return e * t
												})),
												a = t.breakAxis <= 0 ? 1 : e.slice(0, t.breakAxis).reduce((function(e, t) {
													return e * t
												}));
											if (!(i > o || a > o)) return [i, a];
											r.Logger.verbose("TextureLayout", "Given width/height preferences were unattainable: shape:" + e + ", breakAxis:" + t.breakAxis)
										}
										var u = e.slice(0);
										if (n && (o *= 2, 1 === (u = u.map((function(e, t) {
												return t >= u.length - 2 ? u[t] % 2 == 0 ? u[t] : u[t] + 1 : u[t]
											}))).length && (u = [2, u[0]])), 2 !== u.length) {
											var c = s(u);
											u = c.newShape
										}
										var p = l(u);
										return u.length <= 1 && p <= o ? [1, p] : 2 === u.length && u[0] <= o && u[1] <= o ? u : 3 === u.length && u[0] * u[1] <= o && u[2] <= o ? [u[0] * u[1], u[2]] : 3 === u.length && u[0] <= o && u[1] * u[2] <= o ? [u[0], u[1] * u[2]] : 4 === u.length && u[0] * u[1] * u[2] <= o && u[3] <= o ? [u[0] * u[1] * u[2], u[3]] : 4 === u.length && u[0] <= o && u[1] * u[2] * u[3] <= o ? [u[0], u[1] * u[2] * u[3]] : n ? f(p / 4).map((function(e) {
											return 2 * e
										})) : f(p)
									}, e
								}();
								...
								function s(e, t) {
									for (var n = [], r = [], o = null != t && Array.isArray(t) && 0 === t.length, i = null == t || o ? null : u(t, e).sort(), a = 0, s = 0; s < e.length; ++s) {
										if (null != i) {
											if (i[a] === s && 1 !== e[s]) throw new Error("Can't squeeze axis " + s + " since its dim '" + e[s] + "' is not 1");
											(null == i[a] || i[a] > s) && 1 === e[s] && (n.push(e[s]), r.push(s)), i[a] <= s && a++
										}
								...
								t.PreferLogicalStrategy = a, t.squeezeShape = s, t.parseAxisParam = u, t.isInt = c, t.sizeFromShape = l, t.getRowsCols = function(e) {
								...
								}, t.sizeToSquarishShape = f, t.getBatchDim = function(e, t) {
									return void 0 === t && (t = 2), l(e.slice(0, e.length - t))
								}
							},
							4057: function(e, t, n) {
								var r = this && this.__read || function(e, t) {
								...
								var o = n(2517),
									i = n(2039);
								t.createTextureLayoutFromTextureType = function(e, n, r) {
									var o = r === i.TextureType.unpacked || r === i.TextureType.unpackedReversed ? 1 : 4,
										...
										c = r === i.TextureType.packedLastDimension ? n.map((function(e, t) {
											return t === n.length - 1 ? 4 * e : e
										})) : void 0;
									return t.createTextureLayoutFromShape(e, n, o, c, {
										isPacked: a,
										reverseWH: s,
										breakAxis: u
									})
								}, t.calculateTextureWidthAndHeight = function(e, n, r) {
									var o = t.createTextureLayoutFromTextureType(e, n, r);
									return [o.width, o.height]
								}, t.createTextureLayoutFromShape = function(e, t, n, i, a) {
									void 0 === n && (n = 1);
									var s = !(!a || !a.isPacked),
										u = r(e.computeTextureWH(s && i || t, a), 2),
										c = u[0],
										l = u[1],
										f = t.length,
										p = t.slice(0);
									if (0 === f && (p = [1]), 1 === n) i = t;
										...
										i = t, f > 0 && (p[f - 1] = Math.ceil(p[f - 1] / 2)), f > 1 && (p[f - 2] = Math.ceil(p[f - 2] / 2))
									...
									return {
										...
										isPacked: s,
										shape: p,
										strides: o.ShapeUtil.computeStrides(p),
										unpackedShape: i,
										reversedWH: a && a.reverseWH
									}
								}
							},
							5702: function(e, t, n) {
								...
								var i = n(6231),
									a = function() {
										...
										return e.prototype.createTextureFromLayout = function(e, t, n, r) {
											var o = this.toEncoderType(e),
												a = this.glContext.getEncoder(o, t.channels || 1, r);
											if (t.isPacked && 1 === r) throw new Error("not implemented");
											var s, u, c = t.width,
												l = t.height;
											if (this.config.reuseTextures) {
												s = c + "x" + l + "_" + a.format + "_" + a.internalFormat + "_" + a.textureType, (u = this.inUseTextures.get(s)) || (u = [], this.inUseTextures.set(s, u));
												var f = this.idleTextures.get(s);
												if (f && f.length > 0) {
													var p = f.pop();
													return u.push(p), 1 === r && this.glContext.updateTexture(p, c, l, a, this.toTextureData(e, n)), p
												}
											}
											i.Logger.verbose("TextureManager", "Creating new texture of size " + t.width + "x" + t.height);
											var d = this.glContext.allocateTexture(c, l, a, this.toTextureData(e, n));
											return this.config.reuseTextures && (u.push(d), this.textureLookup.set(d, s)), d
										}, e.prototype.readTexture = function(e, t, n) {
											var r = this;
											return n || (n = 1), this.profiler.event("backend", "TextureManager.readTexture", (function() {
												var o = e.shape.reduce((function(e, t) {
														return e * t
													})) * n,
													i = r.glContext.readTexture(e.texture, e.width, e.height, o, r.toEncoderType(t), n);
												return r.toTensorData(t, i)
											}))
										}, e.prototype.readTextureAsync = function(e, t, n) {
											return r(this, void 0, void 0, (function() {
												var i, a, s = this;
												return o(this, (function(u) {
													return i = e.tensor.dataId, n || (n = 1), this.pendingRead.has(i) ? (a = this.pendingRead.get(i), [2, new Promise((function(e) {
														return null == a ? void 0 : a.push(e)
													}))]) : [2, this.profiler.event("backend", "TextureManager.readTextureAsync", (function() {
														return r(s, void 0, void 0, (function() {
															var r, a, s, u;
															return o(this, (function(o) {
																switch (o.label) {
																	case 0:
																		return this.pendingRead.set(i, []), r = e.shape.reduce((function(e, t) {
																			return e * t
																		})) * n, [4, this.glContext.createAndWaitForFence()];
																	case 1:
																		return o.sent(), a = this.glContext.readTexture(e.texture, e.width, e.height, r, this.toEncoderType(t), n), s = this.toTensorData(t, a), u = this.pendingRead.get(i), this.pendingRead.delete(i), null == u || u.forEach((function(e) {
																			return e(s)
																		})), [2, s]
																}
															}))
										...
										}, e.prototype.readUint8TextureAsFloat = function(e) {
											var t = this;
											return this.profiler.event("backend", "TextureManager.readUint8TextureAsFloat", (function() {
												var n = e.shape.reduce((function(e, t) {
														return e * t
													})),
													r = t.glContext.readTexture(e.texture, e.width, e.height, 4 * n, "byte", 4);
												return new Float32Array(r.buffer, r.byteOffset, n)
											}))
										}, e.prototype.releaseTexture = function(e, t) {
											var n;
											if (this.config.reuseTextures && (n = this.textureLookup.get(e.texture))) {
												t && this.textureLookup.delete(n);
												var r = this.inUseTextures.get(n);
												if (r) {
													var o = r.indexOf(e.texture);
													if (-1 !== o) {
														r.splice(o, 1);
														var a = this.idleTextures.get(n);
														a || (a = [], this.idleTextures.set(n, a)), a.push(e.texture)
													}
												}
											}
											n && !t || (i.Logger.verbose("TextureManager", "Deleting texture of size " + e.width + "x" + e.height), this.glContext.deleteTexture(e.texture))
										}, e.prototype.toTensorData = function(e, t) {
											switch (e) {
												case "int16":
										...
										}, e.prototype.toTextureData = function(e, t) {
											if (t) return t instanceof Float32Array ? t : new Float32Array(t)
										}, e.prototype.toEncoderType = function(e) {
											return "float"
										}, e.prototype.clearActiveTextures = function() {
							...
							9390: function(e, t, n) {
								...
								t.getPackedShape = function(e) {
									...
									return i.assert(void 0 !== e && 0 !== e.length, (function() {
										return "empty string found for sampler name"
								...
								}, t.getGlChannels = function(e) {
									return void 0 === e && (e = 6), ["x", "y", "z", "w", "u", "v"].slice(0, e)
								}
							},
							7305: function(e, t, n) {
								Object.defineProperty(t, "__esModule", {
								...
								function a(e) {
									...
									if ((!e || "webgl2" === e) && (t = n.getContext("webgl2", i))) try {
										return new o.WebGLContext(t, 2)
									} catch (e) {
										r.Logger.warning("GlContextFactory", "failed to create WebGLContext using contextId 'webgl2'. Error: " + e)
									}
									if ((!e || "webgl" === e) && (t = n.getContext("webgl", i) || n.getContext("experimental-webgl", i))) try {
										return new o.WebGLContext(t, 1)
									} catch (e) {
								...
								t.createWebGLContext = function e(t) {
									var n;
									t && "webgl2" !== t || !("webgl2" in i) ? t && "webgl" !== t || !("webgl" in i) || (n = i.webgl) : n = i.webgl2, n = n || a(t), t = t || 1 === n.version ? "webgl" : "webgl2";
									var r = n.gl;
							...
							1713: function(e, t, n) {
								...
								var p = function() {
									...
									return e.prototype.allocateTexture = function(e, t, n, r) {
										var o = this.gl,
											i = o.createTexture();
									...
									}, e.prototype.readTexture = function(e, t, n, r, o, i) {
										var a = this.gl;
										i || (i = 1), this.frameBufferBound || this.attachFramebuffer(e, t, n);
										var s = this.getEncoder(o, i),
											u = s.allocate(t * n);
									...
									}, e.prototype.isFramebufferReady = function() {
										return !0
									}, e.prototype.getActiveTexture = function() {
										var e = this.gl;
										return "TEXTURE" + (e.getParameter(this.gl.ACTIVE_TEXTURE) - e.TEXTURE0)
									}, e.prototype.getTextureBinding = function() {
										return this.gl.getParameter(this.gl.TEXTURE_BINDING_2D)
									}, e.prototype.getFramebufferBinding = function() {
										return this.gl.getParameter(this.gl.FRAMEBUFFER_BINDING)
									}, e.prototype.setVertexAttributes = function(e, t) {
										var n = this.gl;
									...
									}, e.prototype.createProgram = function(e, t) {
										var n = this.gl,
											r = n.createProgram();
										return n.attachShader(r, e), n.attachShader(r, t), n.linkProgram(r), r
									}, e.prototype.compileShader = function(e, t) {
										var n = this.gl,
											r = n.createShader(t);
										...
										return r
									}, e.prototype.deleteShader = function(e) {
										this.gl.deleteShader(e)
									}, e.prototype.bindTextureToUniform = function(e, t, n) {
										var r = this.gl;
									...
									}, e.prototype.checkError = function() {
										if (u.env.debug) {
											var e = this.gl,
												t = e.getError(),
												n = "";
									...
									}, e.prototype.getEncoder = function(e, t, n) {
										if (void 0 === n && (n = 0), 2 === this.version) return new c.RedFloat32DataEncoder(this.gl, t);
										switch (e) {
											case "float":
												return 1 === n || this.isRenderFloat32Supported ? new c.RGBAFloatDataEncoder(this.gl, t) : new c.RGBAFloatDataEncoder(this.gl, t, this.textureHalfFloatExtension.HALF_FLOAT_OES);
											case "int":
										...
										for (var e = this.gl, t = 0; t < this.maxTextureImageUnits; ++t) e.activeTexture(e.TEXTURE0 + t), e.bindTexture(e.TEXTURE_2D, null)
									}, e.prototype.dispose = function() {
										if (!this.disposed) {
											var e = this.gl;
									...
									}, e.prototype.createDefaultGeometry = function() {
										...
										var e = this.gl.createFramebuffer();
										if (!e) throw new Error("createFramebuffer returned null");
										return e
									}, e.prototype.queryVitalParameters = function() {
										var e = this.gl;
									...
									}, e.prototype.checkFloatTextureAttachableToFrameBuffer = function() {
										var e = this.gl,
											t = e.createTexture();
										e.bindTexture(e.TEXTURE_2D, t);
										var n = 2 === this.version ? e.RGBA32F : e.RGBA;
										...
										return this.isFloatTextureAttachableToFrameBuffer
									}, e.prototype.checkFloat32Blend = function() {
										var e, t, n, r, o, i = this.gl;
										try {
											e = i.createTexture(), t = i.createFramebuffer(), i.bindTexture(i.TEXTURE_2D, e);
											var a = 2 === this.version ? i.RGBA32F : i.RGBA;
											return i.texImage2D(i.TEXTURE_2D, 0, a, 1, 1, 0, i.RGBA, i.FLOAT, null), i.bindFramebuffer(i.FRAMEBUFFER, t), i.framebufferTexture2D(i.FRAMEBUFFER, i.COLOR_ATTACHMENT0, i.TEXTURE_2D, e, 0), i.enable(i.BLEND), !!(n = i.createShader(i.VERTEX_SHADER)) && (i.shaderSource(n, "void main(){}"), i.compileShader(n), !!(r = i.createShader(i.FRAGMENT_SHADER)) && (i.shaderSource(r, "precision highp float;void main(){gl_FragColor=vec4(0.5);}"), i.compileShader(r), !!(o = i.createProgram()) && (i.attachShader(o, n), i.attachShader(o, r), i.linkProgram(o), i.useProgram(o), i.drawArrays(i.POINTS, 0, 1), i.getError() === i.NO_ERROR)))
										} finally {
											i.disable(i.BLEND), o && i.deleteProgram(o), n && i.deleteShader(n), r && i.deleteShader(r), t && (i.bindFramebuffer(i.FRAMEBUFFER, null), i.deleteFramebuffer(t)), e && (i.bindTexture(i.TEXTURE_2D, null), i.deleteTexture(e))
										}
									}, e.prototype.beginTimer = function() {
									...
									}, e.prototype.isTimerResultAvailable = function(e) {
										var t, n;
										if (2 !== this.version || !this.disjointTimerQueryWebgl2Extension) throw new Error("WebGL1 profiling currently not supported");
										var r = this.gl,
											o = this.disjointTimerQueryWebgl2Extension;
										return t = r.getQueryParameter(e, r.QUERY_RESULT_AVAILABLE), n = r.getParameter(o.GPU_DISJOINT_EXT), t && !n
									}, e.prototype.getTimerResult = function(e) {
										var t;
										if (2 !== this.version) throw new Error("WebGL1 profiling currently not supported");
										var n = this.gl;
										return t = n.getQueryParameter(e, n.QUERY_RESULT), n.deleteQuery(e), t / 1e6
										...
										return a(this, void 0, void 0, (function() {
											...
											return s(this, (function(n) {
												switch (n.label) {
													case 0:
														return [4, l.repeatedTry((function() {
															return t.isTimerResultAvailable(e)
														}))];
													case 1:
														return n.sent(), [2, this.getTimerResult(e)]
												}
											}))
										}))
										...
										return a(this, void 0, void 0, (function() {
											...
											return s(this, (function(t) {
												return e = this.createFence(this.gl), [2, this.pollFence(e)]
											}))
										}))
									}, e.prototype.createFence = function(e) {
										var t = e,
											n = t.fenceSync(t.SYNC_GPU_COMMANDS_COMPLETE, 0);
										return e.flush(), {
											query: n,
											isFencePassed: null === n ? function() {
												return !0
											} : function() {
												var e = t.clientWaitSync(n, 0, 0);
												return e === t.ALREADY_SIGNALED || e === t.CONDITION_SATISFIED
											}
										}
										...
										for (var e = f(this.itemsToPoll.map((function(e) {
												return e.isDoneFn
										...
										return a(this, void 0, void 0, (function() {
											...
											return s(this, (function(r) {
												switch (r.label) {
													case 0:
														return this.itemsToPoll.push({
															isDoneFn: e,
															resolveFn: t
														}), this.itemsToPoll.length > 1 ? [2] : [4, l.repeatedTry((function() {
									...
									l = function() {
										...
										return e.prototype.initialize = function(e) {
											...
											this.profiler.event("session", "ExecutionPlan.initialize", (function() {
												var n = t.graph.getNodes();
												if (n.length !== e.length) throw new Error("The size of nodes and OPs do not match.");
												t._ops = e.map((function(e, t) {
													return new c(e, n[t])
												})), t.reset(), t._starter = [], t._ops.forEach((function(e, n) {
													var r, o, a = !0;
													try {
														for (var s = i(e.node.inputs), u = s.next(); !u.done; u = s.next()) {
															var c = u.value;
															if (!t._values[c] && -1 === t.graph.getInputIndices().indexOf(c)) {
																a = !1;
																break
															}
														}
											...
											this._values = this.graph.getValues().map((function(e) {
												return e.tensor
											}))
											...
											return r(this, void 0, void 0, (function() {
												...
												return o(this, (function(c) {
													return [2, this.profiler.event("session", "ExecutionPlan.execute", (function() {
														return r(n, void 0, void 0, (function() {
															var n, c, l, f, p, d, h, g, b, y, m, v, _ = this;
															return o(this, (function(w) {
																switch (w.label) {
																	case 0:
																		if (this.reset(), n = e.createInferenceHandler(), c = this.graph.getInputIndices(), t.length !== c.length) throw new Error("number of input tensors don't match the number of inputs to the model: actual: " + t.length + " expected: " + c.length);
																		t.forEach((function(e, t) {
																			var n = c[t];
																			_._values[n] = e
																		})), l = this._starter.slice(0), f = this.graph.getValues(), p = this.graph.getNodes(), d = 0, h = function() {
																			var e, t, c, h, b, y;
																			return o(this, (function(m) {
																				switch (m.label) {
																					case 0:
																						if (e = l[d++], t = g._ops[e], -1 !== (c = t.node.inputs.map((function(e) {
																								return _._values[e]
																							}))).indexOf(void 0)) throw new Error("unresolved input detected: op: " + t.node);
																						return h = c, u.Logger.verbose("ExecPlan", "Runing op:" + t.node.name + " (" + h.map((function(e, n) {
																							return "'" + t.node.inputs[n] + "': " + e.type + "[" + e.dims.join(",") + "]"
																						})).join(", ") + ")"), [4, g.profiler.event("node", t.node.name, (function() {
																							return r(_, void 0, void 0, (function() {
																								return o(this, (function(e) {
																									return [2, t.op.impl(n, h, t.op.context)]
																								}))
																							}))
																						}))];
																					case 1:
																						if ((b = m.sent()).length !== t.node.outputs.length) throw new Error("the size of output does not match model definition.");
																						return b.forEach((function(e, n) {
																							var r = t.node.outputs[n];
																							if (_._values[r]) throw new Error("output [" + r + "] already has value: op:" + t.node.name);
																							_._values[r] = e
																						})), y = new Set, b.forEach((function(e, n) {
																							var r, o, a, s, u = t.node.outputs[n];
																							try {
																								for (var c = (r = void 0, i(f[u].to)), l = c.next(); !l.done; l = c.next()) {
																									var d = l.value,
																										h = p[d],
																										g = !0;
																									try {
																										for (var b = (a = void 0, i(h.inputs)), m = b.next(); !m.done; m = b.next()) {
																											var v = m.value;
																											if (!_._values[v]) {
																												g = !1;
																												break
																						...
																						})), l.push.apply(l, s([], a(y))), [2]
																				}
																			}))
																		}, g = this, w.label = 1;
																	case 1:
																		return d < l.length ? [5, h()] : [3, 3];
																	case 2:
																		return w.sent(), [3, 1];
																	case 3:
																		b = [], y = 0, w.label = 4;
																	case 4:
																		if (!(y < this.graph.getOutputIndices().length)) return [3, 9];
																		if (m = this.graph.getOutputIndices()[y], void 0 === (v = this._values[m])) throw new Error("required output [" + m + "] does not have value");
																		return 0 !== m ? [3, 6] : [4, v.getData()];
																	case 5:
																		return w.sent(), [3, 7];
																	case 6:
																		v.data, w.label = 7;
																	...
																	case 8:
																		return y++, [3, 4];
																	case 9:
																		return u.Logger.verbose("ExecPlan", "disposing of inferenceHandler"), n.dispose(), [2, b]
																}
															}))
														}))
													}))]
							...
							7070: function(e, t, n) {
								...
								var o = n(1446),
									i = n(7778),
									a = n(9395).onnxruntime.experimental.fbs,
									s = n(9162),
									u = n(2517);
								t.Graph = {
									from: function(e, t) {
								...
								var c = function() {
										function e(e) {
											this._from = void 0, this._to = [], this.tensor = void 0, this.type = void 0, e && (this.type = u.ProtoUtil.tensorValueTypeFromProto(e.type.tensorType))
										}
									...
									l = function(e, t) {
										e instanceof o.onnx.NodeProto ? (this.name = e.name, this.opType = e.opType, this.attributes = new i.Attribute(e.attribute)) : e instanceof a.Node && (this.name = null != t ? t : e.name(), this.opType = e.opType(), this.attributes = new i.Attribute(u.ProtoUtil.tensorAttributesFromORTFormat(e))), this.inputs = [], this.outputs = [], this.executeNode = !0
									},
									f = function() {
										function e(e, t) {
										...
										return e.prototype.getInputIndices = function() {
											return this._allInputIndices
										}, e.prototype.getInputNames = function() {
											return this._allInputNames
										}, e.prototype.getOutputIndices = function() {
											return this._allOutputIndices
										}, e.prototype.getOutputNames = function() {
											return this._allOutputNames
										}, e.prototype.getValues = function() {
											return this._allData
										}, e.prototype.getNodes = function() {
											return this._nodes
										}, e.prototype.buildGraph = function(e) {
											if (e instanceof o.onnx.GraphProto) this.buildGraphFromOnnxFormat(e);
											else {
												if (!(e instanceof a.Graph)) throw new TypeError("Graph type is not supported.");
												this.buildGraphFromOrtFormat(e)
											}
										}, e.prototype.buildGraphFromOnnxFormat = function(e) {
											var t, n, o, i, a, f, p, d, h, g, b, y, m = new Map;
											...
											var _ = [];
											try {
												for (var w = r(e.input), x = w.next(); !x.done; x = w.next()) {
													var T = x.value;
													if (m.has(T.name)) throw new Error("duplicated input name: " + T.name);
													var S = this._allData.push(new c(T)) - 1;
													m.set(T.name, S), _.push(T.name)
												}
											} catch (e) {
												t = {
													error: e
											...
											try {
												for (var O = r(e.initializer), A = O.next(); !A.done; A = O.next()) {
													T = A.value;
													var E = m.get(T.name);
													if (void 0 === E) {
														var I = new c;
														I.type = {
															shape: {
																dims: u.ProtoUtil.tensorDimsFromProto(T.dims)
															},
															tensorType: u.ProtoUtil.tensorDataTypeFromProto(T.dataType)
														}, E = this._allData.push(I) - 1, m.set(T.name, E)
													}
													this._allData[E]._from = -1, this._allData[E].tensor = s.Tensor.fromProto(T)
												}
											} catch (e) {
												o = {
													error: e
											...
											for (T = 0; T < this._allData.length; T++) this._allData[T].tensor || (this._allInputIndices.push(T), this._allInputNames.push(_[T]));
											if (!e.output) throw new Error("missing information in graph: output");
											try {
												for (var P = r(e.output), D = P.next(); !D.done; D = P.next()) {
													if (T = D.value, m.has(T.name)) throw new Error("duplicated output name: " + T.name);
													S = this._allData.push(new c(T)) - 1, m.set(T.name, S), this._allOutputIndices.push(S), this._allOutputNames.push(T.name)
												}
											} catch (e) {
												a = {
													error: e
											...
											try {
												for (var k = r(e.node), N = k.next(); !N.done; N = k.next()) {
													if (!(U = N.value).name)
														for (var C = 0;; C++) {
															var R = "unnamed_" + U.opType + "_" + C;
															if (!v.has(R)) {
																U.name = R;
																break
															}
														}
													if (v.has(U.name)) throw new Error("duplicated node name: " + U.name);
													S = this._nodes.push(new l(U)) - 1, v.set(U.name, S)
												}
											} catch (e) {
												p = {
													error: e
											...
											for (T = 0; T < this._nodes.length; T++) {
												var F = this._nodes[T];
												if (!(U = e.node[T]).output) throw new Error("missing output for node: " + U.name);
												try {
													for (var L = (h = void 0, r(U.output)), M = L.next(); !M.done; M = L.next()) {
														var j = M.value;
														if (void 0 === (z = m.get(j)) && (z = this._allData.push(new c) - 1, m.set(j, z)), F.outputs.push(z), void 0 !== this._allData[z]._from) throw new Error("multiple nodes output to one data value: " + z);
														if (this._allData[z]._from = T, "Constant" === U.opType) {
															if (!U.attribute || 1 !== U.attribute.length || !U.attribute[0].t) throw new Error("missing attributes or missing tensor value in attributes for this Constant operator");
															if (!U.output || 1 !== U.output.length) throw new Error("missing output or incorrect number of outputs for this Constant operator");
															F.outputs.pop(), F.executeNode = !1, this._allData[z]._from = -1, this._allData[z].tensor = s.Tensor.fromProto(U.attribute[0].t)
														}
													}
												} catch (e) {
													h = {
											...
											for (T = 0; T < this._nodes.length; T++) {
												var U;
												if (F = this._nodes[T], !(U = e.node[T]).input) throw new Error("missing input for node: " + U.name);
												try {
													for (var B = (b = void 0, r(U.input)), V = B.next(); !V.done; V = B.next()) {
														var z, G = V.value;
														if (void 0 === (z = m.get(G))) throw new Error("unrecognized input '" + G + "' for node: " + U.name);
														F.inputs.push(z), this._allData[z]._to.push(T)
													}
												} catch (e) {
													b = {
														error: e
											...
											return !0
										}, e.prototype.buildGraphFromOrtFormat = function(e) {
											var t, n, r, o = new Map;
											this._allData = [], this._allInputIndices = [], this._allInputNames = [], this._allOutputIndices = [], this._allOutputNames = [], this._nodes = [];
											for (var i = new Map, f = [], p = 0; p < e.inputsLength(); p++) {
												var d = e.inputs(p);
												if (o.has(d)) throw new Error("duplicated input name: " + d);
												for (var h = 0; h < e.nodeArgsLength(); h++)
													if ((null === (t = e.nodeArgs(h)) || void 0 === t ? void 0 : t.name()) === d) {
														var g = new c;
														if ((null === (r = null === (n = e.nodeArgs(h)) || void 0 === n ? void 0 : n.type()) || void 0 === r ? void 0 : r.valueType()) !== a.TypeInfoValue.tensor_type) throw new Error("Unexpected value type for the nodeArg.");
														for (var b = e.nodeArgs(h).type().value(new a.TensorTypeAndShape), y = u.ProtoUtil.tensorDataTypeFromProto(b.elemType()), m = b.shape(), v = [], _ = 0; _ < m.dimLength(); _++) v.push(u.LongUtil.longToNumber(m.dim(_).value().dimValue()));
														g.type = {
															shape: {
																dims: v
															},
														...
														var w = this._allData.push(g) - 1;
														o.set(d, w), f.push(d)
													}
											}
											for (p = 0; p < e.initializersLength(); p++) {
												var x = e.initializers(p),
													T = o.get(x.name());
												void 0 === T && (g = new c, v = u.ProtoUtil.tensorDimsFromORTFormat(x), y = u.ProtoUtil.tensorDataTypeFromProto(x.dataType()), g.type = {
													shape: {
														dims: v
													},
													tensorType: y
												}, T = this._allData.push(g) - 1, o.set(x.name(), T)), this._allData[T]._from = -1, this._allData[T].tensor = s.Tensor.fromOrtTensor(x)
											}
											for (p = 0; p < this._allData.length; p++) this._allData[p].tensor || (this._allInputIndices.push(p), this._allInputNames.push(f[p]));
											for (p = 0; p < e.outputsLength(); p++) {
												var S = e.outputs(p);
												if (o.has(S)) throw new Error("duplicated output name: " + S);
												w = this._allData.push(new c) - 1, o.set(S, w), this._allOutputIndices.push(w), this._allOutputNames.push(S)
											}
											if (!e.nodes) throw new Error("missing information in graph: node");
											for (p = 0; p < e.nodesLength(); p++) {
												var O = (P = e.nodes(p)).name();
												if (!O)
													for (var A = 0; O = "unnamed_" + P.opType() + "_" + A, i.has(O); A++);
												if (i.has(O)) throw new Error("duplicated node name: " + O);
												w = this._nodes.push(new l(P, O)) - 1, i.set(O, w)
											}
											for (p = 0; p < this._nodes.length; p++) {
												var E = this._nodes[p];
												if (null == (P = e.nodes(p))) throw new Error("No node exists at index " + p);
												if (0 === (null == P ? void 0 : P.outputsLength())) throw new Error("missing output for node: " + P.name);
												for (h = 0; h < (null == P ? void 0 : P.outputsLength()); h++) {
													var I = null == P ? void 0 : P.outputs(h);
													if (void 0 === (D = o.get(I)) && (D = this._allData.push(new c) - 1, o.set(I, D)), E.outputs.push(D), void 0 !== this._allData[D]._from) throw new Error("multiple nodes output to one data value: " + D);
													if (this._allData[D]._from = p, "Constant" === P.opType()) {
														if (1 !== P.attributesLength() || !P.attributes(0).t()) throw new Error("missing attributes or missing tensor value in attributes for this Constant operator");
														if (1 !== P.outputsLength()) throw new Error("missing output or incorrect number of outputs for this Constant operator");
														E.outputs.pop(), E.executeNode = !1, this._allData[D]._from = -1, this._allData[D].tensor = s.Tensor.fromOrtTensor(P.attributes(0).t())
													}
												}
											}
											for (p = 0; p < this._nodes.length; p++) {
												var P;
												if (E = this._nodes[p], 0 === (P = e.nodes(p)).inputsLength()) throw new Error("missing input for node: " + P.name);
												for (h = 0; h < P.inputsLength(); h++) {
													var D, k = P.inputs(h);
													if (void 0 === (D = o.get(k))) throw new Error("unrecognized input '" + k + "' for node: " + P.name());
													E.inputs.push(D), this._allData[D]._to.push(p)
												}
											}
										}, e.prototype.checkIsAcyclic = function() {
											var e = this,
												t = new Set;
											this._allInputIndices.forEach((function(n) {
												e._allData[n]._to.forEach((function(e) {
													t.add(e)
												}))
											}));
											for (var n = Array.from(t), r = new Array(this._nodes.length).fill("white"), o = function() {
													var t = n.pop();
													"gray" === r[t] ? r[t] = "black" : (n.push(t), r[t] = "gray", i._nodes[t].outputs.forEach((function(o) {
														var i = e._allData[o];
														...
														i._to.forEach((function(e) {
															if ("gray" === r[e]) throw new Error("model graph is cyclic");
															"white" === r[e] && n.push(e)
														}))
													})))
												}, i = this; n.length > 0;) o()
										...
										}, e.prototype.finalizeGraph = function() {
											for (var e, t = this, n = 0, r = function(r) {
													if (!o._nodes[r].executeNode) return n++, o._nodes[r].outputs.forEach((function(e) {
														t._allData[e]._from = -2
													})), o._nodes.splice(r, 1), r--, e = r, "continue";
													n > 0 && (o._nodes[r].inputs.forEach((function(e) {
														var o = t._allData[e]._to.indexOf(r + n); - 1 !== o && (t._allData[e]._to[o] = r)
													})), o._nodes[r].outputs.forEach((function(e) {
														t._allData[e]._from && t._allData[e]._from === r + n && (t._allData[e]._from = r)
													}))), e = r
												}, o = this, i = 0; i < this._nodes.length; i++) r(i), i = e;
											n = 0;
											var a, s = function(e) {
													if (-2 === u._allData[e].from && -1 === u._allOutputIndices.indexOf(e + n)) return n++, u._allData.splice(e, 1), e--, a = e, "continue";
													if (n > 0) {
														var r = -1;
														void 0 !== u._allData[e].from && -1 !== u._allData[e].from ? -1 !== (r = u._nodes[u._allData[e].from].outputs.indexOf(e + n)) && (u._nodes[u._allData[e].from].outputs[r] = e) : -1 !== (r = u._allInputIndices.indexOf(e + n)) && (u._allInputIndices[r] = e), u._allData[e].to.forEach((function(o) {
															-1 !== (r = t._nodes[o].inputs.indexOf(e + n)) && (t._nodes[o].inputs[r] = e)
														})), 0 === u._allData[e].to.length && -1 !== (r = u._allOutputIndices.indexOf(e + n)) && (u._allOutputIndices[r] = e)
													}
													a = e
												},
												u = this;
											for (i = 0; i < this._allData.length; i++) s(i), i = a
										}, e.prototype.deleteNode = function(e) {
											var t, n, o = this._nodes[e];
											if (o.inputs.length > 1) throw new Error("Node deletion with multiple inputs is not supported. ");
											if (o.outputs.length > 1)
												for (var i = 1; i < o.outputs.length; i++)
													if (this._allData[o.outputs[i]].to.length > 0) throw new Error("Node deletion with more than one output connected to other nodes is not supported. ");
											o.executeNode = !1;
											var a = o.inputs[0],
												s = o.outputs[0],
												u = this._allData[s].to,
												c = this._allData[a].to.indexOf(e);
											if (-1 === c) throw new Error("The Value object doesn't have the current Node in it's 'to' property ");
											this._allData[a].to.splice(c, 1), this._allData[s]._to = [];
											var l = this._allOutputIndices.indexOf(s);
											if (-1 !== l && (this._allOutputIndices[l] = a), u && u.length > 0) try {
												for (var f = r(u), p = f.next(); !p.done; p = f.next()) {
													var d = p.value,
														h = this._nodes[d].inputs.indexOf(s);
													if (-1 === h) throw new Error("The Node object doesn't have the output Value in it's 'inputs' property ");
													this._nodes[d].inputs[h] = a, this._allData[a].to.push(d)
												}
											} catch (e) {
												t = {
													error: e
										...
										}, e.prototype.removeAllDropoutNodes = function() {
											var e, t, n = 0;
											try {
										...
										}, e.prototype.removeAllIdentityNodes = function() {
											var e, t, n = 0;
											try {
												for (var o = r(this._nodes), i = o.next(); !i.done; i = o.next()) "Identity" === i.value.opType && this.deleteNode(n), n++
											} catch (t) {
												e = {
													error: t
												}
										...
										}, e.prototype.isActivation = function(e) {
											switch (e.opType) {
												case "Relu":
												case "Sigmoid":
												case "Clip":
										...
										}, e.prototype.fuseConvActivationNodes = function() {
											var e, t;
											try {
												for (var n = r(this._nodes), o = n.next(); !o.done; o = n.next()) {
													var i = o.value;
													if ("Conv" === i.opType) {
														var a = this._allData[i.outputs[0]]._to;
														if (1 === a.length && this.isActivation(this._nodes[a[0]])) {
															var s = this._nodes[a[0]];
															i.attributes.set("__internal_activation", "string", s.opType), "Clip" === s.opType && (i.attributes.set("__clip_min", "float", s.attributes.getFloat("min")), i.attributes.set("__clip_max", "float", s.attributes.getFloat("max"))), this.deleteNode(a[0])
														}
													}
												}
											} catch (t) {
							...
							6231: function(e, t) {
								var n, r, o = this && this.__awaiter || function(e, t, n, r) {
										return new(n || (n = Promise))((function(o, i) {
											function a(e) {
												try {
													u(r.next(e))
								...
								var a = function() {
									...
									c = ((n = {}).none = new a, n.console = new s, n),
									l = {
										provider: "console",
								...
								function p(e, t, n, r) {
									if (void 0 === t) return o = e, {
										verbose: p.verbose.bind(null, o),
										info: p.info.bind(null, o),
										warning: p.warning.bind(null, o),
										error: p.error.bind(null, o),
										fatal: p.fatal.bind(null, o)
									};
									if (void 0 === n) d(e, t);
									else if ("number" == typeof n && void 0 === r) d(e, t);
									else if ("string" == typeof n && void 0 === r) d(e, n, 0, t);
									else {
								...
								function d(e, t, n, r) {
									var o = f[r || ""] || f[""];
									u[e] < u[o.minimalSeverity] || (o.logDateTime && (t = (new Date).toISOString() + "|" + t), o.logSourceLocation, c[o.provider].log(e, t, r))
								}! function(e) {
									function t(e) {
										f = {}, n("", e || {})
									}
								...
								var h = function() {
										...
										return e.prototype.end = function() {
											...
											return o(this, void 0, void 0, (function() {
												return i(this, (function(e) {
													...
													return this.ctx.endTimer(), [2, this.ctx.waitForQueryAndGetTime(this.timer)]
												}))
											}))
										}, e
									}(),
									...
									b = function() {
										...
										return e.create = function(e) {
										...
										}, e.prototype.event = function(e, t, n, r) {
											var a = this,
												s = this._started ? this.begin(e, t, r) : void 0,
												u = !1,
												c = n();
											if (c && "function" == typeof c.then) return u = !0, new Promise((function(e, t) {
												c.then((function(t) {
													return o(a, void 0, void 0, (function() {
														return i(this, (function(n) {
															switch (n.label) {
																case 0:
																	return s ? [4, s.end()] : [3, 2];
																case 1:
																	n.sent(), n.label = 2;
																case 2:
																	return e(t), [2]
											...
											if (!u && s) {
												var l = s.end();
												if (l && "function" == typeof l.then) return new Promise((function(e, t) {
													l.then((function() {
														e(c)
													}), (function(e) {
														t(e)
											...
											return c
										}, e.prototype.begin = function(e, n, r) {
											var a = this;
											if (!this._started) throw new Error("profiler is not started yet");
											if (void 0 === r) {
												var s = t.now();
												return this.flush(s), new h(e, n, s, (function(e) {
													return a.endSync(e)
												}))
											}
											var u = r.beginTimer();
											return new h(e, n, 0, (function(e) {
												return o(a, void 0, void 0, (function() {
													return i(this, (function(t) {
														return [2, this.end(e)]
													}))
											...
											return o(this, void 0, void 0, (function() {
												...
												return i(this, (function(n) {
													switch (n.label) {
														case 0:
															return [4, e.checkTimer()];
														case 1:
															return t = n.sent(), this._timingEvents.length < this._maxNumberEvents && (this._timingEvents.push(new g(e.category, e.name, e.startTime, t)), this.flush(t)), [2]
													}
												}))
											}))
										}, e.prototype.endSync = function(e) {
											var n = t.now();
											this._timingEvents.length < this._maxNumberEvents && (this._timingEvents.push(new g(e.category, e.name, e.startTime, n)), this.flush(n))
										}, e.prototype.logOneEvent = function(e) {
								...
								t.Profiler = b, t.now = "undefined" != typeof performance && performance.now ? function() {
									return performance.now()
								} : Date.now
							},
							2644: function(e, t, n) {
								...
								var r = n(4819),
									...
									u = function() {
										...
										return e.prototype.load = function(e, t, n) {
										...
										}, e.prototype.loadFromOnnxFormat = function(e, t) {
											var n = o.onnx.ModelProto.decode(e);
											if (s.LongUtil.longToNumber(n.irVersion) < 3) throw new Error("only support ONNX model with IR_VERSION>=3");
											this._opsets = n.opsetImport.map((function(e) {
												return {
													domain: e.domain,
													version: s.LongUtil.longToNumber(e.version)
												}
											})), this._graph = i.Graph.from(n.graph, t)
										}, e.prototype.loadFromOrtFormat = function(e, t) {
											var n = new r.flatbuffers.ByteBuffer(e),
												o = a.InferenceSession.getRootAsInferenceSession(n).model();
											if (s.LongUtil.longToNumber(o.irVersion()) < 3) throw new Error("only support ONNX model with IR_VERSION>=3");
											this._opsets = [];
											for (var u = 0; u < o.opsetImportLength(); u++) {
												var c = o.opsetImport(u);
												this._opsets.push({
													domain: null == c ? void 0 : c.domain(),
													version: s.LongUtil.longToNumber(c.version())
												})
											}
											this._graph = i.Graph.from(o.graph(), t)
											...
											enumerable: !1,
											configurable: !0
										}), Object.defineProperty(e.prototype, "opsets", {
											get: function() {
												return this._opsets
											},
											enumerable: !1,
							...
							1047: function(e, t) {
								...
								function r(e, t) {
									if (t.endsWith("+")) {
										var n = Number.parseInt(t.substring(0, t.length - 1), 10);
										return !isNaN(n) && n <= e
									}
									if (2 === t.split("-").length) {
										var r = t.split("-"),
											o = (n = Number.parseInt(r[0], 10), Number.parseInt(r[1], 10));
										return !isNaN(n) && !isNaN(o) && n <= e && e <= o
									}
									return Number.parseInt(t, 10) === e
								}
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.resolveOperator = void 0, t.resolveOperator = function(e, t, o) {
									var i, a, s, u;
									try {
										for (var c = n(o), l = c.next(); !l.done; l = c.next()) {
											var f = l.value,
												...
												b = f[4];
											if (e.opType === p) try {
												for (var y = (s = void 0, n(t)), m = y.next(); !m.done; m = y.next()) {
													var v = m.value;
													if ((v.domain === d || "ai.onnx" === v.domain && "" === d) && r(v.version, h)) return {
														opImpl: g,
														opInit: b
													}
												}
									...
									throw new TypeError("cannot resolve operator '" + e.opType + "' with opsets: " + t.map((function(e) {
										return (e.domain || "ai.onnx") + " v" + e.version
									})).join(", "))
								}
							},
							9395: function(e, t, n) {
								...
								var r, o, i, a, s = n(4819);
								(a = (i = (o = (r = t.onnxruntime || (t.onnxruntime = {})).experimental || (r.experimental = {})).fbs || (o.fbs = {})).AttributeType || (i.AttributeType = {}))[a.UNDEFINED = 0] = "UNDEFINED", a[a.FLOAT = 1] = "FLOAT", a[a.INT = 2] = "INT", a[a.STRING = 3] = "STRING", a[a.TENSOR = 4] = "TENSOR", a[a.GRAPH = 5] = "GRAPH", a[a.FLOATS = 6] = "FLOATS", a[a.INTS = 7] = "INTS", a[a.STRINGS = 8] = "STRINGS", a[a.TENSORS = 9] = "TENSORS", a[a.GRAPHS = 10] = "GRAPHS", a[a.SPARSE_TENSOR = 11] = "SPARSE_TENSOR", a[a.SPARSE_TENSORS = 12] = "SPARSE_TENSORS",
									function(e) {
										! function(e) {
											! function(e) {
												var t;
												(t = e.DimensionValueType || (e.DimensionValueType = {}))[t.UNKNOWN = 0] = "UNKNOWN", t[t.VALUE = 1] = "VALUE", t[t.PARAM = 2] = "PARAM"
											}(e.fbs || (e.fbs = {}))
									...
									function(e) {
										! function(e) {
											! function(e) {
												var t;
												(t = e.NodeType || (e.NodeType = {}))[t.Primitive = 0] = "Primitive", t[t.Fused = 1] = "Fused"
											}(e.fbs || (e.fbs = {}))
										}(e.experimental || (e.experimental = {}))
									}(t.onnxruntime || (t.onnxruntime = {})),
									function(e) {
										! function(e) {
											! function(e) {
												var t;
												(t = e.TypeInfoValue || (e.TypeInfoValue = {}))[t.NONE = 0] = "NONE", t[t.tensor_type = 1] = "tensor_type", t[t.sequence_type = 2] = "sequence_type", t[t.map_type = 3] = "map_type"
											}(e.fbs || (e.fbs = {}))
										}(e.experimental || (e.experimental = {}))
									}(t.onnxruntime || (t.onnxruntime = {})),
									function(e) {
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsShape = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsShape = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.dim = function(t, n) {
													...
													}, t.prototype.dimLength = function() {
														var e = this.bb.__offset(this.bb_pos, 4);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.startShape = function(e) {
														e.startObject(1)
													}, t.addDim = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, t.createDimVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startDimVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.endShape = function(e) {
														return e.endObject()
													}, t.createShape = function(e, n) {
														return t.startShape(e), t.addDim(e, n), t.endShape(e)
													}, t
												}();
												t.Shape = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsDimension = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsDimension = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													...
													}, t.prototype.denotation = function(e) {
														var t = this.bb.__offset(this.bb_pos, 6);
														return t ? this.bb.__string(this.bb_pos + t, e) : null
													}, t.startDimension = function(e) {
														e.startObject(2)
													}, t.addValue = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, t.addDenotation = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, t.endDimension = function(e) {
														return e.endObject()
													}, t.createDimension = function(e, n, r) {
														return t.startDimension(e), t.addValue(e, n), t.addDenotation(e, r), t.endDimension(e)
													}, t
												}();
												t.Dimension = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsDimensionValue = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsDimensionValue = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.dimType = function() {
														var t = this.bb.__offset(this.bb_pos, 4);
														return t ? this.bb.readInt8(this.bb_pos + t) : e.experimental.fbs.DimensionValueType.UNKNOWN
													}, t.prototype.dimValue = function() {
														var e = this.bb.__offset(this.bb_pos, 6);
														return e ? this.bb.readInt64(this.bb_pos + e) : this.bb.createLong(0, 0)
													}, t.prototype.dimParam = function(e) {
														var t = this.bb.__offset(this.bb_pos, 8);
														return t ? this.bb.__string(this.bb_pos + t, e) : null
													}, t.startDimensionValue = function(e) {
														e.startObject(3)
													}, t.addDimType = function(t, n) {
														t.addFieldInt8(0, n, e.experimental.fbs.DimensionValueType.UNKNOWN)
													}, t.addDimValue = function(e, t) {
														e.addFieldInt64(1, t, e.createLong(0, 0))
													}, t.addDimParam = function(e, t) {
														e.addFieldOffset(2, t, 0)
													}, t.endDimensionValue = function(e) {
														return e.endObject()
													}, t.createDimensionValue = function(e, n, r, o) {
														return t.startDimensionValue(e), t.addDimType(e, n), t.addDimValue(e, r), t.addDimParam(e, o), t.endDimensionValue(e)
													}, t
												}();
												t.DimensionValue = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsTensorTypeAndShape = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsTensorTypeAndShape = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.elemType = function() {
														var t = this.bb.__offset(this.bb_pos, 4);
													...
													}, t.startTensorTypeAndShape = function(e) {
														e.startObject(2)
													}, t.addElemType = function(t, n) {
														t.addFieldInt32(0, n, e.experimental.fbs.TensorDataType.UNDEFINED)
													}, t.addShape = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, t.endTensorTypeAndShape = function(e) {
														return e.endObject()
													}, t.createTensorTypeAndShape = function(e, n, r) {
														return t.startTensorTypeAndShape(e), t.addElemType(e, n), t.addShape(e, r), t.endTensorTypeAndShape(e)
													}, t
												}();
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsMapType = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsMapType = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.keyType = function() {
														var t = this.bb.__offset(this.bb_pos, 4);
														return t ? this.bb.readInt32(this.bb_pos + t) : e.experimental.fbs.TensorDataType.UNDEFINED
													}, t.prototype.valueType = function(t) {
														var n = this.bb.__offset(this.bb_pos, 6);
														return n ? (t || new e.experimental.fbs.TypeInfo).__init(this.bb.__indirect(this.bb_pos + n), this.bb) : null
													}, t.startMapType = function(e) {
														e.startObject(2)
													}, t.addKeyType = function(t, n) {
														t.addFieldInt32(0, n, e.experimental.fbs.TensorDataType.UNDEFINED)
													}, t.addValueType = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, t.endMapType = function(e) {
														return e.endObject()
													}, t.createMapType = function(e, n, r) {
														return t.startMapType(e), t.addKeyType(e, n), t.addValueType(e, r), t.endMapType(e)
													}, t
												}();
												t.MapType = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsSequenceType = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsSequenceType = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.elemType = function(t) {
														var n = this.bb.__offset(this.bb_pos, 4);
														return n ? (t || new e.experimental.fbs.TypeInfo).__init(this.bb.__indirect(this.bb_pos + n), this.bb) : null
													}, t.startSequenceType = function(e) {
														e.startObject(1)
													}, t.addElemType = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, t.endSequenceType = function(e) {
														return e.endObject()
													}, t.createSequenceType = function(e, n) {
														return t.startSequenceType(e), t.addElemType(e, n), t.endSequenceType(e)
													}, t
												}();
												t.SequenceType = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(e) {
											! function(e) {
												var t = function() {
													...
													return e.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, e.prototype.nodeIndex = function() {
														return this.bb.readUint32(this.bb_pos)
													}, e.prototype.srcArgIndex = function() {
														return this.bb.readInt32(this.bb_pos + 4)
													}, e.prototype.dstArgIndex = function() {
														return this.bb.readInt32(this.bb_pos + 8)
													}, e.createEdgeEnd = function(e, t, n, r) {
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsNodeEdge = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsNodeEdge = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.nodeIndex = function() {
														var e = this.bb.__offset(this.bb_pos, 4);
														return e ? this.bb.readUint32(this.bb_pos + e) : 0
													}, t.prototype.inputEdges = function(t, n) {
														var r = this.bb.__offset(this.bb_pos, 6);
														return r ? (n || new e.experimental.fbs.EdgeEnd).__init(this.bb.__vector(this.bb_pos + r) + 12 * t, this.bb) : null
													}, t.prototype.inputEdgesLength = function() {
														var e = this.bb.__offset(this.bb_pos, 6);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.prototype.outputEdges = function(t, n) {
														var r = this.bb.__offset(this.bb_pos, 8);
														return r ? (n || new e.experimental.fbs.EdgeEnd).__init(this.bb.__vector(this.bb_pos + r) + 12 * t, this.bb) : null
													}, t.prototype.outputEdgesLength = function() {
														var e = this.bb.__offset(this.bb_pos, 8);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.startNodeEdge = function(e) {
														e.startObject(3)
													}, t.addNodeIndex = function(e, t) {
														e.addFieldInt32(0, t, 0)
													}, t.addInputEdges = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, t.startInputEdgesVector = function(e, t) {
														e.startVector(12, t, 4)
													}, t.addOutputEdges = function(e, t) {
														e.addFieldOffset(2, t, 0)
													}, t.startOutputEdgesVector = function(e, t) {
														e.startVector(12, t, 4)
													}, t.endNodeEdge = function(e) {
														return e.endObject()
													}, t.createNodeEdge = function(e, n, r, o) {
														return t.startNodeEdge(e), t.addNodeIndex(e, n), t.addInputEdges(e, r), t.addOutputEdges(e, o), t.endNodeEdge(e)
													}, t
												}();
												t.NodeEdge = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													}, t.prototype.implicitInputs = function(e, t) {
														var n = this.bb.__offset(this.bb_pos, 28);
														return n ? this.bb.__string(this.bb.__vector(this.bb_pos + n) + 4 * e, t) : null
													}, t.prototype.implicitInputsLength = function() {
														var e = this.bb.__offset(this.bb_pos, 28);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.startNode = function(e) {
														e.startObject(13)
													}, t.addName = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, t.addDocString = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, t.addDomain = function(e, t) {
														e.addFieldOffset(2, t, 0)
													}, t.addSinceVersion = function(e, t) {
														e.addFieldInt32(3, t, 0)
													}, t.addIndex = function(e, t) {
														e.addFieldInt32(4, t, 0)
													}, t.addOpType = function(e, t) {
														e.addFieldOffset(5, t, 0)
													}, t.addType = function(t, n) {
														t.addFieldInt32(6, n, e.experimental.fbs.NodeType.Primitive)
													}, t.addExecutionProviderType = function(e, t) {
														e.addFieldOffset(7, t, 0)
													}, t.addInputs = function(e, t) {
														e.addFieldOffset(8, t, 0)
													}, t.createInputsVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startInputsVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.addOutputs = function(e, t) {
														e.addFieldOffset(9, t, 0)
													}, t.createOutputsVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startOutputsVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.addAttributes = function(e, t) {
														e.addFieldOffset(10, t, 0)
													}, t.createAttributesVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startAttributesVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.addInputArgCounts = function(e, t) {
														e.addFieldOffset(11, t, 0)
													}, t.createInputArgCountsVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addInt32(t[n]);
														return e.endVector()
													}, t.startInputArgCountsVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.addImplicitInputs = function(e, t) {
														e.addFieldOffset(12, t, 0)
													}, t.createImplicitInputsVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startImplicitInputsVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.endNode = function(e) {
														return e.endObject()
													}, t.createNode = function(e, n, r, o, i, a, s, u, c, l, f, p, d, h) {
														return t.startNode(e), t.addName(e, n), t.addDocString(e, r), t.addDomain(e, o), t.addSinceVersion(e, i), t.addIndex(e, a), t.addOpType(e, s), t.addType(e, u), t.addExecutionProviderType(e, c), t.addInputs(e, l), t.addOutputs(e, f), t.addAttributes(e, p), t.addInputArgCounts(e, d), t.addImplicitInputs(e, h), t.endNode(e)
													}, t
												}();
												t.Node = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsValueInfo = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsValueInfo = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.name = function(e) {
														var t = this.bb.__offset(this.bb_pos, 4);
														return t ? this.bb.__string(this.bb_pos + t, e) : null
														...
														return n ? (t || new e.experimental.fbs.TypeInfo).__init(this.bb.__indirect(this.bb_pos + n), this.bb) : null
													}, t.startValueInfo = function(e) {
														e.startObject(3)
													}, t.addName = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, t.addDocString = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, t.addType = function(e, t) {
														e.addFieldOffset(2, t, 0)
													}, t.endValueInfo = function(e) {
														return e.endObject()
													}, t.createValueInfo = function(e, n, r, o) {
														return t.startValueInfo(e), t.addName(e, n), t.addDocString(e, r), t.addType(e, o), t.endValueInfo(e)
													}, t
												}();
												t.ValueInfo = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsTypeInfo = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsTypeInfo = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.denotation = function(e) {
														var t = this.bb.__offset(this.bb_pos, 4);
														return t ? this.bb.__string(this.bb_pos + t, e) : null
													}, t.prototype.valueType = function() {
														var t = this.bb.__offset(this.bb_pos, 6);
													...
													}, t.startTypeInfo = function(e) {
														e.startObject(3)
													}, t.addDenotation = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, t.addValueType = function(t, n) {
														t.addFieldInt8(1, n, e.experimental.fbs.TypeInfoValue.NONE)
													}, t.addValue = function(e, t) {
														e.addFieldOffset(2, t, 0)
													}, t.endTypeInfo = function(e) {
														return e.endObject()
													}, t.createTypeInfo = function(e, n, r, o) {
														return t.startTypeInfo(e), t.addDenotation(e, n), t.addValueType(e, r), t.addValue(e, o), t.endTypeInfo(e)
													}, t
												}();
												t.TypeInfo = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(e) {
											! function(e) {
												var t = function() {
													...
													return e.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, e.getRootAsOperatorSetId = function(t, n) {
														return (n || new e).__init(t.readInt32(t.position()) + t.position(), t)
													}, e.getSizePrefixedRootAsOperatorSetId = function(t, n) {
														return t.setPosition(t.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new e).__init(t.readInt32(t.position()) + t.position(), t)
														...
														var e = this.bb.__offset(this.bb_pos, 6);
														return e ? this.bb.readInt64(this.bb_pos + e) : this.bb.createLong(0, 0)
													}, e.startOperatorSetId = function(e) {
														e.startObject(2)
													}, e.addDomain = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, e.addVersion = function(e, t) {
														e.addFieldInt64(1, t, e.createLong(0, 0))
													}, e.endOperatorSetId = function(e) {
														return e.endObject()
													}, e.createOperatorSetId = function(t, n, r) {
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsTensor = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsTensor = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.name = function(e) {
														var t = this.bb.__offset(this.bb_pos, 4);
														return t ? this.bb.__string(this.bb_pos + t, e) : null
													...
													}, t.prototype.stringData = function(e, t) {
														var n = this.bb.__offset(this.bb_pos, 14);
														return n ? this.bb.__string(this.bb.__vector(this.bb_pos + n) + 4 * e, t) : null
													}, t.prototype.stringDataLength = function() {
														var e = this.bb.__offset(this.bb_pos, 14);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.startTensor = function(e) {
														e.startObject(6)
													}, t.addName = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, t.addDocString = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, t.addDims = function(e, t) {
														e.addFieldOffset(2, t, 0)
													}, t.createDimsVector = function(e, t) {
														e.startVector(8, t.length, 8);
														for (var n = t.length - 1; n >= 0; n--) e.addInt64(t[n]);
														return e.endVector()
													}, t.startDimsVector = function(e, t) {
														e.startVector(8, t, 8)
													}, t.addDataType = function(t, n) {
														t.addFieldInt32(3, n, e.experimental.fbs.TensorDataType.UNDEFINED)
													}, t.addRawData = function(e, t) {
														e.addFieldOffset(4, t, 0)
													}, t.createRawDataVector = function(e, t) {
														e.startVector(1, t.length, 1);
														for (var n = t.length - 1; n >= 0; n--) e.addInt8(t[n]);
														return e.endVector()
													}, t.startRawDataVector = function(e, t) {
														e.startVector(1, t, 1)
													}, t.addStringData = function(e, t) {
														e.addFieldOffset(5, t, 0)
													}, t.createStringDataVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startStringDataVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.endTensor = function(e) {
														return e.endObject()
													}, t.createTensor = function(e, n, r, o, i, a, s) {
														return t.startTensor(e), t.addName(e, n), t.addDocString(e, r), t.addDims(e, o), t.addDataType(e, i), t.addRawData(e, a), t.addStringData(e, s), t.endTensor(e)
													}, t
												}();
												t.Tensor = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsSparseTensor = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsSparseTensor = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													...
													}, t.prototype.indices = function(t) {
														var n = this.bb.__offset(this.bb_pos, 6);
														return n ? (t || new e.experimental.fbs.Tensor).__init(this.bb.__indirect(this.bb_pos + n), this.bb) : null
													}, t.prototype.dims = function(e) {
														var t = this.bb.__offset(this.bb_pos, 8);
														...
														var e = this.bb.__offset(this.bb_pos, 8);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.startSparseTensor = function(e) {
														e.startObject(3)
													}, t.addValues = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, t.addIndices = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, t.addDims = function(e, t) {
														e.addFieldOffset(2, t, 0)
													}, t.createDimsVector = function(e, t) {
														...
														e.startVector(8, t, 8)
													}, t.endSparseTensor = function(e) {
														return e.endObject()
													}, t.createSparseTensor = function(e, n, r, o) {
														return t.startSparseTensor(e), t.addValues(e, n), t.addIndices(e, r), t.addDims(e, o), t.endSparseTensor(e)
													}, t
												}();
												t.SparseTensor = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsAttribute = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsAttribute = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.name = function(e) {
														var t = this.bb.__offset(this.bb_pos, 4);
														return t ? this.bb.__string(this.bb_pos + t, e) : null
													...
													}, t.prototype.floats = function(e) {
														var t = this.bb.__offset(this.bb_pos, 20);
														return t ? this.bb.readFloat32(this.bb.__vector(this.bb_pos + t) + 4 * e) : 0
													}, t.prototype.floatsLength = function() {
														var e = this.bb.__offset(this.bb_pos, 20);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.prototype.floatsArray = function() {
														var e = this.bb.__offset(this.bb_pos, 20);
													...
													}, t.prototype.ints = function(e) {
														var t = this.bb.__offset(this.bb_pos, 22);
														return t ? this.bb.readInt64(this.bb.__vector(this.bb_pos + t) + 8 * e) : this.bb.createLong(0, 0)
													}, t.prototype.intsLength = function() {
														var e = this.bb.__offset(this.bb_pos, 22);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.prototype.strings = function(e, t) {
														var n = this.bb.__offset(this.bb_pos, 24);
														return n ? this.bb.__string(this.bb.__vector(this.bb_pos + n) + 4 * e, t) : null
													}, t.prototype.stringsLength = function() {
														var e = this.bb.__offset(this.bb_pos, 24);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.prototype.tensors = function(t, n) {
													...
													}, t.prototype.tensorsLength = function() {
														var e = this.bb.__offset(this.bb_pos, 26);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.prototype.graphs = function(t, n) {
													...
													}, t.prototype.graphsLength = function() {
														var e = this.bb.__offset(this.bb_pos, 28);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.startAttribute = function(e) {
														e.startObject(13)
													}, t.addName = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, t.addDocString = function(e, t) {
														...
														e.addFieldOffset(7, t, 0)
													}, t.addFloats = function(e, t) {
														e.addFieldOffset(8, t, 0)
													}, t.createFloatsVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addFloat32(t[n]);
														return e.endVector()
													}, t.startFloatsVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.addInts = function(e, t) {
														e.addFieldOffset(9, t, 0)
													}, t.createIntsVector = function(e, t) {
														e.startVector(8, t.length, 8);
														for (var n = t.length - 1; n >= 0; n--) e.addInt64(t[n]);
														return e.endVector()
													}, t.startIntsVector = function(e, t) {
														e.startVector(8, t, 8)
													}, t.addStrings = function(e, t) {
														e.addFieldOffset(10, t, 0)
													}, t.createStringsVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startStringsVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.addTensors = function(e, t) {
														e.addFieldOffset(11, t, 0)
													}, t.createTensorsVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startTensorsVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.addGraphs = function(e, t) {
														e.addFieldOffset(12, t, 0)
													}, t.createGraphsVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startGraphsVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.endAttribute = function(e) {
														return e.endObject()
													}, t.createAttribute = function(e, n, r, o, i, a, s, u, c, l, f, p, d, h) {
														return t.startAttribute(e), t.addName(e, n), t.addDocString(e, r), t.addType(e, o), t.addF(e, i), t.addI(e, a), t.addS(e, s), t.addT(e, u), t.addG(e, c), t.addFloats(e, l), t.addInts(e, f), t.addStrings(e, p), t.addTensors(e, d), t.addGraphs(e, h), t.endAttribute(e)
													}, t
												}();
												t.Attribute = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsGraph = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsGraph = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.initializers = function(t, n) {
														var r = this.bb.__offset(this.bb_pos, 4);
														return r ? (n || new e.experimental.fbs.Tensor).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : null
													}, t.prototype.initializersLength = function() {
														var e = this.bb.__offset(this.bb_pos, 4);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.prototype.nodeArgs = function(t, n) {
														var r = this.bb.__offset(this.bb_pos, 6);
														return r ? (n || new e.experimental.fbs.ValueInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : null
													}, t.prototype.nodeArgsLength = function() {
														var e = this.bb.__offset(this.bb_pos, 6);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.prototype.nodes = function(t, n) {
														var r = this.bb.__offset(this.bb_pos, 8);
														return r ? (n || new e.experimental.fbs.Node).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : null
													}, t.prototype.nodesLength = function() {
														var e = this.bb.__offset(this.bb_pos, 8);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.prototype.maxNodeIndex = function() {
														var e = this.bb.__offset(this.bb_pos, 10);
														return e ? this.bb.readUint32(this.bb_pos + e) : 0
													}, t.prototype.nodeEdges = function(t, n) {
													...
													}, t.prototype.nodeEdgesLength = function() {
														var e = this.bb.__offset(this.bb_pos, 12);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.prototype.inputs = function(e, t) {
														var n = this.bb.__offset(this.bb_pos, 14);
														...
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.prototype.sparseInitializers = function(t, n) {
														var r = this.bb.__offset(this.bb_pos, 18);
														return r ? (n || new e.experimental.fbs.SparseTensor).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : null
													}, t.prototype.sparseInitializersLength = function() {
														var e = this.bb.__offset(this.bb_pos, 18);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.startGraph = function(e) {
														e.startObject(8)
													}, t.addInitializers = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, t.createInitializersVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startInitializersVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.addNodeArgs = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, t.createNodeArgsVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startNodeArgsVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.addNodes = function(e, t) {
														e.addFieldOffset(2, t, 0)
													}, t.createNodesVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startNodesVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.addMaxNodeIndex = function(e, t) {
														e.addFieldInt32(3, t, 0)
													}, t.addNodeEdges = function(e, t) {
														e.addFieldOffset(4, t, 0)
													}, t.createNodeEdgesVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startNodeEdgesVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.addInputs = function(e, t) {
														e.addFieldOffset(5, t, 0)
													}, t.createInputsVector = function(e, t) {
														...
														e.startVector(4, t, 4)
													}, t.addSparseInitializers = function(e, t) {
														e.addFieldOffset(7, t, 0)
													}, t.createSparseInitializersVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startSparseInitializersVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.endGraph = function(e) {
														return e.endObject()
													}, t.createGraph = function(e, n, r, o, i, a, s, u, c) {
														return t.startGraph(e), t.addInitializers(e, n), t.addNodeArgs(e, r), t.addNodes(e, o), t.addMaxNodeIndex(e, i), t.addNodeEdges(e, a), t.addInputs(e, s), t.addOutputs(e, u), t.addSparseInitializers(e, c), t.endGraph(e)
													}, t
												}();
												t.Graph = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsModel = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsModel = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.irVersion = function() {
														var e = this.bb.__offset(this.bb_pos, 4);
														return e ? this.bb.readInt64(this.bb_pos + e) : this.bb.createLong(0, 0)
													}, t.prototype.opsetImport = function(t, n) {
														var r = this.bb.__offset(this.bb_pos, 6);
													...
													}, t.prototype.opsetImportLength = function() {
														var e = this.bb.__offset(this.bb_pos, 6);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.prototype.producerName = function(e) {
														var t = this.bb.__offset(this.bb_pos, 8);
														return t ? this.bb.__string(this.bb_pos + t, e) : null
													}, t.prototype.producerVersion = function(e) {
														var t = this.bb.__offset(this.bb_pos, 10);
														return t ? this.bb.__string(this.bb_pos + t, e) : null
													}, t.prototype.domain = function(e) {
														var t = this.bb.__offset(this.bb_pos, 12);
														return t ? this.bb.__string(this.bb_pos + t, e) : null
													}, t.prototype.modelVersion = function() {
														var e = this.bb.__offset(this.bb_pos, 14);
														return e ? this.bb.readInt64(this.bb_pos + e) : this.bb.createLong(0, 0)
													}, t.prototype.docString = function(e) {
														var t = this.bb.__offset(this.bb_pos, 16);
														...
														var n = this.bb.__offset(this.bb_pos, 18);
														return n ? (t || new e.experimental.fbs.Graph).__init(this.bb.__indirect(this.bb_pos + n), this.bb) : null
													}, t.prototype.graphDocString = function(e) {
														var t = this.bb.__offset(this.bb_pos, 20);
														return t ? this.bb.__string(this.bb_pos + t, e) : null
													}, t.startModel = function(e) {
														e.startObject(9)
													}, t.addIrVersion = function(e, t) {
														e.addFieldInt64(0, t, e.createLong(0, 0))
													}, t.addOpsetImport = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, t.createOpsetImportVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startOpsetImportVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.addProducerName = function(e, t) {
														e.addFieldOffset(2, t, 0)
													}, t.addProducerVersion = function(e, t) {
														e.addFieldOffset(3, t, 0)
													}, t.addDomain = function(e, t) {
														e.addFieldOffset(4, t, 0)
													}, t.addModelVersion = function(e, t) {
														e.addFieldInt64(5, t, e.createLong(0, 0))
													}, t.addDocString = function(e, t) {
														e.addFieldOffset(6, t, 0)
													}, t.addGraph = function(e, t) {
														e.addFieldOffset(7, t, 0)
													}, t.addGraphDocString = function(e, t) {
														e.addFieldOffset(8, t, 0)
													}, t.endModel = function(e) {
														return e.endObject()
													}, t.createModel = function(e, n, r, o, i, a, s, u, c, l) {
														return t.startModel(e), t.addIrVersion(e, n), t.addOpsetImport(e, r), t.addProducerName(e, o), t.addProducerVersion(e, i), t.addDomain(e, a), t.addModelVersion(e, s), t.addDocString(e, u), t.addGraph(e, c), t.addGraphDocString(e, l), t.endModel(e)
													}, t
												}();
												t.Model = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(e) {
											! function(e) {
												var t = function() {
													...
													return e.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, e.getRootAsKernelCreateInfos = function(t, n) {
														return (n || new e).__init(t.readInt32(t.position()) + t.position(), t)
													}, e.getSizePrefixedRootAsKernelCreateInfos = function(t, n) {
														return t.setPosition(t.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new e).__init(t.readInt32(t.position()) + t.position(), t)
													}, e.prototype.nodeIndices = function(e) {
														var t = this.bb.__offset(this.bb_pos, 4);
														return t ? this.bb.readUint32(this.bb.__vector(this.bb_pos + t) + 4 * e) : 0
													}, e.prototype.nodeIndicesLength = function() {
														var e = this.bb.__offset(this.bb_pos, 4);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, e.prototype.nodeIndicesArray = function() {
														var e = this.bb.__offset(this.bb_pos, 4);
													...
													}, e.prototype.kernelDefHashes = function(e) {
														var t = this.bb.__offset(this.bb_pos, 6);
														return t ? this.bb.readUint64(this.bb.__vector(this.bb_pos + t) + 8 * e) : this.bb.createLong(0, 0)
													}, e.prototype.kernelDefHashesLength = function() {
														var e = this.bb.__offset(this.bb_pos, 6);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, e.startKernelCreateInfos = function(e) {
														e.startObject(2)
													}, e.addNodeIndices = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, e.createNodeIndicesVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addInt32(t[n]);
														return e.endVector()
													}, e.startNodeIndicesVector = function(e, t) {
														e.startVector(4, t, 4)
													}, e.addKernelDefHashes = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, e.createKernelDefHashesVector = function(e, t) {
														e.startVector(8, t.length, 8);
														for (var n = t.length - 1; n >= 0; n--) e.addInt64(t[n]);
														return e.endVector()
													}, e.startKernelDefHashesVector = function(e, t) {
														e.startVector(8, t, 8)
													}, e.endKernelCreateInfos = function(e) {
														return e.endObject()
													}, e.createKernelCreateInfos = function(t, n, r) {
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsSubGraphSessionState = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsSubGraphSessionState = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.graphId = function(e) {
														var t = this.bb.__offset(this.bb_pos, 4);
														return t ? this.bb.__string(this.bb_pos + t, e) : null
													}, t.prototype.sessionState = function(t) {
														var n = this.bb.__offset(this.bb_pos, 6);
														return n ? (t || new e.experimental.fbs.SessionState).__init(this.bb.__indirect(this.bb_pos + n), this.bb) : null
													}, t.startSubGraphSessionState = function(e) {
														e.startObject(2)
													}, t.addGraphId = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, t.addSessionState = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, t.endSubGraphSessionState = function(e) {
														var t = e.endObject();
														return e.requiredField(t, 4), t
													}, t.createSubGraphSessionState = function(e, n, r) {
														return t.startSubGraphSessionState(e), t.addGraphId(e, n), t.addSessionState(e, r), t.endSubGraphSessionState(e)
													}, t
												}();
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsSessionState = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsSessionState = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.prototype.kernels = function(t) {
														var n = this.bb.__offset(this.bb_pos, 4);
														return n ? (t || new e.experimental.fbs.KernelCreateInfos).__init(this.bb.__indirect(this.bb_pos + n), this.bb) : null
													}, t.prototype.subGraphSessionStates = function(t, n) {
														var r = this.bb.__offset(this.bb_pos, 6);
													...
													}, t.prototype.subGraphSessionStatesLength = function() {
														var e = this.bb.__offset(this.bb_pos, 6);
														return e ? this.bb.__vector_len(this.bb_pos + e) : 0
													}, t.startSessionState = function(e) {
														e.startObject(2)
													}, t.addKernels = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, t.addSubGraphSessionStates = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, t.createSubGraphSessionStatesVector = function(e, t) {
														e.startVector(4, t.length, 4);
														for (var n = t.length - 1; n >= 0; n--) e.addOffset(t[n]);
														return e.endVector()
													}, t.startSubGraphSessionStatesVector = function(e, t) {
														e.startVector(4, t, 4)
													}, t.endSessionState = function(e) {
														return e.endObject()
													}, t.createSessionState = function(e, n, r) {
														return t.startSessionState(e), t.addKernels(e, n), t.addSubGraphSessionStates(e, r), t.endSessionState(e)
													}, t
												}();
												t.SessionState = n
											}(t.fbs || (t.fbs = {}))
										...
										! function(t) {
											! function(t) {
												var n = function() {
													...
													return t.prototype.__init = function(e, t) {
														return this.bb_pos = e, this.bb = t, this
													}, t.getRootAsInferenceSession = function(e, n) {
														return (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.getSizePrefixedRootAsInferenceSession = function(e, n) {
														return e.setPosition(e.position() + s.flatbuffers.SIZE_PREFIX_LENGTH), (n || new t).__init(e.readInt32(e.position()) + e.position(), e)
													}, t.bufferHasIdentifier = function(e) {
														return e.__has_identifier("ORTM")
													}, t.prototype.ortVersion = function(e) {
														var t = this.bb.__offset(this.bb_pos, 4);
														return t ? this.bb.__string(this.bb_pos + t, e) : null
													}, t.prototype.model = function(t) {
														var n = this.bb.__offset(this.bb_pos, 6);
														return n ? (t || new e.experimental.fbs.Model).__init(this.bb.__indirect(this.bb_pos + n), this.bb) : null
													}, t.prototype.sessionState = function(t) {
														var n = this.bb.__offset(this.bb_pos, 8);
														return n ? (t || new e.experimental.fbs.SessionState).__init(this.bb.__indirect(this.bb_pos + n), this.bb) : null
													}, t.startInferenceSession = function(e) {
														e.startObject(3)
													}, t.addOrtVersion = function(e, t) {
														e.addFieldOffset(0, t, 0)
													}, t.addModel = function(e, t) {
														e.addFieldOffset(1, t, 0)
													}, t.addSessionState = function(e, t) {
														e.addFieldOffset(2, t, 0)
													}, t.endInferenceSession = function(e) {
														return e.endObject()
													}, t.finishInferenceSessionBuffer = function(e, t) {
														e.finish(t, "ORTM")
													}, t.finishSizePrefixedInferenceSessionBuffer = function(e, t) {
														e.finish(t, "ORTM", !0)
													}, t.createInferenceSession = function(e, n, r, o) {
														return t.startInferenceSession(e), t.addOrtVersion(e, n), t.addModel(e, r), t.addSessionState(e, o), t.endInferenceSession(e)
													}, t
												}();
										...
										return e.prototype.dispose = function() {
											...
											return r(this, void 0, void 0, (function() {
												...
												return o(this, (function(o) {
													switch (o.label) {
														case 0:
															for (n in t = new Map, e) Object.hasOwnProperty.call(e, n) && (r = e[n], t.set(n, new a.Tensor(r.dims, r.type, void 0, void 0, r.data)));
															return [4, this.session.run(t)];
														case 1:
															return s = o.sent(), u = {}, s.forEach((function(e, t) {
																u[t] = new i.Tensor(e.type, e.data, e.dims)
															})), [2, u]
													}
												}))
											}))
							...
							6919: function(e, t, n) {
								...
								var i = n(7067),
									...
									f = function() {
										function e(e) {
											void 0 === e && (e = {}), this._initialized = !1, this.backendHint = e.backendHint, this.profiler = c.Profiler.create(e.profiler), this.context = {
												profiler: this.profiler,
												graphInputTypes: [],
												graphInputDims: []
											}
										}
										return Object.defineProperty(e.prototype, "inputNames", {
											get: function() {
												return this._model.graph.getInputNames()
											},
											enumerable: !1,
											configurable: !0
										}), Object.defineProperty(e.prototype, "outputNames", {
											get: function() {
															...
															return [4, this.profiler.event("session", "Session.loadModel", (function() {
																return r(u, void 0, void 0, (function() {
																	...
																	return o(this, (function(o) {
																		switch (o.label) {
																			case 0:
																				return [4, s.resolveBackend(this.backendHint)];
																			case 1:
																				return r = o.sent(), this.sessionHandler = r.createSessionHandler(this.context), this._model = new l.Model, "string" != typeof e ? [3, 7] : (u = e.endsWith(".ort"), "undefined" != typeof fetch ? [3, 3] : [4, a.promisify(i.readFile)(e)]);
																			case 2:
																				return c = o.sent(), this.initialize(Buffer.from(c), u), [3, 6];
																			case 3:
																				return [4, fetch(e)];
																			case 4:
																				return [4, o.sent().arrayBuffer()];
																			case 5:
																				c = o.sent(), this.initialize(new Uint8Array(c), u), o.label = 6;
																			case 6:
																				return [3, 8];
																			case 7:
																				ArrayBuffer.isView(e) ? this.initialize(e) : (f = new Uint8Array(e, t || 0, n || e.byteLength), this.initialize(f)), o.label = 8;
																			case 8:
																				return [2]
																		}
																	}))
											...
											this.profiler.event("session", "Session.initialize", (function() {
												var r = n.sessionHandler.transformGraph ? n.sessionHandler : void 0;
												n._model.load(e, r, t), n.sessionHandler.onGraphInitialized && n.sessionHandler.onGraphInitialized(n._model.graph), n.initializeOps(n._model.graph), n._executionPlan = new u.ExecutionPlan(n._model.graph, n._ops, n.profiler)
											})), this._initialized = !0
											...
											return r(this, void 0, void 0, (function() {
												...
												return o(this, (function(n) {
													...
													return [2, this.profiler.event("session", "Session.run", (function() {
														return r(t, void 0, void 0, (function() {
															var t, n;
															return o(this, (function(r) {
																switch (r.label) {
																	case 0:
																		return t = this.normalizeAndValidateInputs(e), [4, this._executionPlan.execute(this.sessionHandler, t)];
																	case 1:
										...
										}, e.prototype.normalizeAndValidateInputs = function(e) {
											var t = this._model.graph.getInputNames();
											if (Array.isArray(e)) {
												...
												for (var n = new Array(e.size), r = 0, o = 0; o < t.length; ++o) {
													var i = e.get(t[o]);
											...
											if (this.context.graphInputTypes && 0 !== this.context.graphInputTypes.length && this.context.graphInputDims && 0 !== this.context.graphInputDims.length) this.validateInputTensorDims(this.context.graphInputDims, e, !1);
												...
												for (o = 0; o < a.length; ++o) {
													var c = s[a[o]];
													u[o] = c.type.shape.dims, this.context.graphInputTypes.push(c.type.tensorType), this.context.graphInputDims.push(e[o].dims)
												}
												this.validateInputTensorDims(u, e, !0)
											}
											return this.validateInputTensorTypes(this.context.graphInputTypes, e), e
										}, e.prototype.validateInputTensorTypes = function(e, t) {
											for (var n = 0; n < t.length; n++) {
												var r = e[n],
													o = t[n].type;
												if (r !== o) throw new Error("input tensor[" + n + "] check failed: expected type '" + r + "' but got " + o)
											}
										}, e.prototype.validateInputTensorDims = function(e, t, n) {
											for (var r = 0; r < t.length; r++) {
												var o = e[r],
													i = t[r].dims;
												if (!this.compareTensorDims(o, i, n)) throw new Error("input tensor[" + r + "] check failed: expected shape '[" + o.join(",") + "]' but got [" + i.join(",") + "]")
											}
										}, e.prototype.compareTensorDims = function(e, t, n) {
											if (e.length !== t.length) return !1;
											for (var r = 0; r < e.length; ++r)
												if (e[r] !== t[r] && (!n || 0 !== e[r])) return !1;
											return !0
										}, e.prototype.createOutput = function(e) {
											var t = this._model.graph.getOutputNames();
											if (e.length !== t.length) throw new Error("expected number of outputs do not match number of generated outputs");
											for (var n = new Map, r = 0; r < t.length; ++r) n.set(t[r], e[r]);
											return n
										}, e.prototype.initializeOps = function(e) {
											var t = e.getNodes();
											this._ops = new Array(t.length);
											for (var n = 0; n < t.length; n++) this._ops[n] = this.sessionHandler.resolve(t[n], this._model.opsets, e)
										}, e
									}();
								t.Session = f
							},
							9162: function(e, t, n) {
								...
								var a = n(3442),
									s = i(n(3720)),
									u = n(1446),
									c = n(9395).onnxruntime.experimental.fbs,
									l = n(2517),
									f = function() {
										function e(e, t, n, r, o, i) {
											void 0 === i && (i = a.Guid.create()), this.dims = e, this.type = t, this.dataProvider = n, this.asyncDataProvider = r, this.cache = o, this.dataId = i, this.size = l.ShapeUtil.validateDimsAndCalcSize(e);
											var s = this.size,
												u = void 0 === n && void 0 === r && void 0 === o;
											if (void 0 !== o && o.length !== s) throw new RangeError("Input dims doesn't match data length.");
											if ("string" === t) {
												if (!(void 0 === o || Array.isArray(o) && o.every((function(e) {
												...
												if (void 0 !== o) {
													var c = d(t);
													if (!(o instanceof c)) throw new TypeError("cache should be type " + c.name)
												}
												if (u) {
													var f = new ArrayBuffer(s * function(e) {
														switch (e) {
															case "bool":
															case "int8":
															case "uint8":
										...
										return Object.defineProperty(e.prototype, "data", {
											get: function() {
												if (void 0 === this.cache) {
													var e = this.dataProvider(this.dataId);
											...
											return this.data[l.ShapeUtil.indicesToOffset(e, this.strides)]
										}, e.prototype.set = function(e, t) {
											this.data[l.ShapeUtil.indicesToOffset(e, this.strides)] = t
											...
											return r(this, void 0, void 0, (function() {
												...
												return o(this, (function(t) {
													switch (t.label) {
														case 0:
															return void 0 !== this.cache ? [3, 2] : (e = this, [4, this.asyncDataProvider(this.dataId)]);
														case 1:
															e.cache = t.sent(), t.label = 2;
														case 2:
															return [2, this.cache]
													}
												}))
											...
											var n = l.ProtoUtil.tensorDataTypeFromProto(t.dataType),
												r = new e(l.ProtoUtil.tensorDimsFromProto(t.dims), n);
											if ("string" === n) t.stringData.forEach((function(e, t) {
												...
												var o = r.data,
													i = new DataView(t.rawData.buffer, t.rawData.byteOffset, t.rawData.byteLength),
													a = p(t.dataType),
													c = t.rawData.byteLength / a;
												if (t.rawData.byteLength % a != 0) throw new Error("invalid buffer length");
												if (o.length !== c) throw new Error("buffer length mismatch");
												for (var f = 0; f < c; f++) {
													var d = g(i, t.dataType, f * a);
													o[f] = d
												}
											} else {
												var b = void 0;
												...
												if (null == b) throw new Error("failed to populate data from a tensorproto value");
												var y = r.data;
												if (y.length !== b.length) throw new Error("array length mismatch");
												for (f = 0; f < b.length; f++) {
													var m = b[f];
													s.default.isLong(m) ? y[f] = h(m, t.dataType) : y[f] = m
												}
											}
											return r
										}, e.fromData = function(t, n, r) {
											return new e(n, r, void 0, void 0, t)
										}, e.fromOrtTensor = function(t) {
											if (!t) throw new Error("cannot construct Value from an empty tensor");
											var n = l.ProtoUtil.tensorDimsFromORTFormat(t),
												r = l.ProtoUtil.tensorDataTypeFromProto(t.dataType()),
												o = new e(n, r);
											if ("string" === r)
												for (var i = 0; i < t.stringDataLength(); i++) o.data[i] = t.stringData(i);
											else if (t.rawDataArray() && "number" == typeof t.rawDataLength() && t.rawDataLength() > 0) {
												var a = o.data,
													s = new DataView(t.rawDataArray().buffer, t.rawDataArray().byteOffset, t.rawDataLength()),
													u = p(t.dataType()),
													c = t.rawDataLength() / u;
												if (t.rawDataLength() % u != 0) throw new Error("invalid buffer length");
												if (a.length !== c) throw new Error("buffer length mismatch");
												for (i = 0; i < c; i++) {
													var f = g(s, t.dataType(), i * u);
													a[i] = f
												}
											}
											return o
								...
								function p(e) {
									switch (e) {
										...
										case u.onnx.TensorProto.DataType.UINT64:
											return 8;
										default:
											throw new Error("cannot calculate sizeof() on type " + u.onnx.TensorProto.DataType[e])
									}
								}
								...
								function h(e, t) {
									if (t === u.onnx.TensorProto.DataType.INT64 || t === c.TensorDataType.INT64) {
										if (e.greaterThanOrEqual(2147483648) || e.lessThan(-2147483648)) throw new TypeError("int64 is not supported")
									} else {
										if (t !== u.onnx.TensorProto.DataType.UINT32 && t !== c.TensorDataType.UINT32 && t !== u.onnx.TensorProto.DataType.UINT64 && t !== c.TensorDataType.UINT64) throw new TypeError("not a LONG type: " + u.onnx.TensorProto.DataType[t]);
								...
								function g(e, t, n) {
									switch (t) {
										...
										case u.onnx.TensorProto.DataType.INT64:
											return h(s.default.fromBits(e.getUint32(n, !0), e.getUint32(n + 4, !0), !1), t);
										case u.onnx.TensorProto.DataType.DOUBLE:
											return e.getFloat64(n, !0);
										case u.onnx.TensorProto.DataType.UINT64:
											return h(s.default.fromBits(e.getUint32(n, !0), e.getUint32(n + 4, !0), !0), t);
										default:
											throw new Error("cannot read from DataView for type " + u.onnx.TensorProto.DataType[t])
									}
								}
								t.Tensor = f
							},
							2517: function(e, t, n) {
								...
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.PoolConvUtil = t.ReduceUtil = t.SplitUtil = t.MathUtil = t.ShapeUtil = t.LongUtil = t.ProtoUtil = t.GemmUtil = t.arrayCopyHelper = t.BroadcastUtil = t.MatMulUtil = t.ArrayUtil = t.assert = t.checkInputsShape = void 0;
								var a = n(4819),
									s = i(n(3720)),
									u = n(1446),
									c = n(9162);
								t.checkInputsShape = function(e) {
									for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
									if (!e || e.length !== t.length) return !1;
									for (var r = 0; r < e.length; r++)
										if (!e[r].dims || e[r].dims.length !== t[r]) return !1;
									return !0
								...
								var l = function() {
									function e() {}
									return e.arraysEqual = function(e, t) {
										if (e.length !== t.length) return !1;
								...
								var f = function() {
									function e() {}
									return e.preprocessInputShapes = function(e, t) {
										return [1 === e.length ? [1, e[0]] : e, 1 === t.length ? [t[0], 1] : t]
									}, e.postprocessOutputShape = function(e, t, n) {
										1 === t && e.splice(e.length - 2, 1), 1 === n && e.pop()
									}, e.calcMatMulShape = function(e, t) {
								...
								var p = function() {
									function e() {}
									return e.calcShape = function(e, t, n) {
										var o;
										void 0 === n && (n = !1);
										var i = e.length,
											a = t.length;
										...
										if (n) {
											if (i < 2 || a < 2) return;
											var c = f.calcMatMulShape([e[i - 2], e[i - 1]], [t[a - 2], t[a - 1]]);
											if (void 0 === c) return;
											o = r(c, 2), u[s - 2] = o[0], u[s - 1] = o[1]
										}
										for (var l = n ? 3 : 1; l <= s; l++) {
											var p = i - l < 0 ? 1 : e[i - l],
												d = a - l < 0 ? 1 : t[a - l];
											if (p !== d && p > 1 && d > 1) return;
											u[s - l] = Math.max(p, d)
										}
										return u
									...
									}, e.fillIndex = function(e, t, n) {
										for (var r = e.length - t.length, o = 0; o < t.length; o++) n[o] = e[r + o] % t[o]
									}, e.calc = function(t, n, r, o, i) {
										var a = e.calcShape(t.dims, n.dims);
										if (a) {
											if (o && !b.areEqual(a, t.dims)) return;
											var s = b.size(a),
												u = o ? t : new c.Tensor(a, i || t.type);
											if (0 === a.length) u.set([], r(t.get([]), n.get([])));
											else {
												var l = new Array(a.length),
													f = new Array(t.dims.length),
													p = new Array(n.dims.length),
													d = 0,
													h = 0,
													g = !1,
													y = !1;
												0 === t.dims.length && (d = t.get([]), g = !0), 0 === n.dims.length && (h = n.get([]), y = !0);
												for (var m = void 0, v = 0; v < s; v++) {
													m = v;
													for (var _ = a.length - 1; _ >= 0; _--) l[_] = m % a[_], m = Math.floor(m / a[_]);
													g || (e.fillIndex(l, t.dims, f), d = t.get(f)), y || (e.fillIndex(l, n.dims, p), h = n.get(p)), u.set(l, r(d, h))
												}
											}
											return u
										}
									}, e.isValidBroadcast = function(e, t) {
										var n = e.length,
											r = t.length;
										if (n > r) return !1;
										for (var o = 1; o <= n; o++)
											if (1 !== e[n - o] && e[n - o] !== t[r - o]) return !1;
										return !0
									}, e.getBroadcastDims = function(e, t) {
								...
								t.BroadcastUtil = p, t.arrayCopyHelper = function(e, t, n, r, o) {
								...
								var d = function() {
									function e() {}
									return e.getShapeOfGemmResult = function(e, t, n, r, o) {
										...
										if (o && !p.isValidBroadcast(o, [i, s])) throw new Error("gemm: invalid bias shape for broadcast");
										return [i, s, a]
									}, e
								}();
								t.GemmUtil = d;
								var h = function() {
									function e() {}
									return e.tensorDataTypeFromProto = function(e) {
										switch (e) {
											case u.onnx.TensorProto.DataType.INT8:
												return "int8";
											case u.onnx.TensorProto.DataType.UINT8:
											...
											case u.onnx.TensorProto.DataType.UINT64:
												return "uint32";
											default:
												throw new Error("unsupported data type: " + u.onnx.TensorProto.DataType[e])
										}
									}, e.tensorDataTypeStringToEnum = function(e) {
										switch (e) {
											case "int8":
												return u.onnx.TensorProto.DataType.INT8;
											case "uint8":
												return u.onnx.TensorProto.DataType.UINT8;
											case "bool":
												return u.onnx.TensorProto.DataType.BOOL;
											case "int16":
												return u.onnx.TensorProto.DataType.INT16;
											case "uint16":
												return u.onnx.TensorProto.DataType.UINT16;
											case "int32":
												return u.onnx.TensorProto.DataType.INT32;
											case "uint32":
												return u.onnx.TensorProto.DataType.UINT32;
											case "float32":
												return u.onnx.TensorProto.DataType.FLOAT;
											case "float64":
												return u.onnx.TensorProto.DataType.DOUBLE;
											case "string":
												return u.onnx.TensorProto.DataType.STRING;
											case "int64":
												return u.onnx.TensorProto.DataType.INT64;
											case "uint64":
												return u.onnx.TensorProto.DataType.UINT64;
											default:
												throw new Error("unsupported data type: " + e)
										}
									}, e.tensorDimsFromProto = function(e) {
										return e.map((function(e) {
											return s.default.isLong(e) ? e.toNumber() : e
										}))
									}, e.tensorValueTypeFromProto = function(t) {
										return {
											tensorType: e.tensorDataTypeFromProto(t.elemType),
											shape: {
												dims: e.tensorDimsFromProto(t.shape.dim.map((function(e) {
													return e.dimValue
												})))
											}
										}
									}, e.tensorDimsFromORTFormat = function(e) {
										for (var t = [], n = 0; n < e.dimsLength(); n++) t.push(g.longToNumber(e.dims(n)));
										return t
									}, e.tensorAttributesFromORTFormat = function(e) {
										for (var t = [], n = 0; n < e.attributesLength(); n++) t.push(e.attributes(n));
										return t
									}, e
								}();
								t.ProtoUtil = h;
								var g = function() {
									function e() {}
									return e.longToNumber = function(e) {
										return s.default.isLong(e) ? e.toNumber() : e instanceof a.flatbuffers.Long ? s.default.fromValue({
											low: e.low,
											high: e.high,
											unsigned: !0
										}).toNumber() : e
									}, e.isLong = function(e) {
										return s.default.isLong(e) || e instanceof a.flatbuffers.Long
									}, e
								}();
								t.LongUtil = g;
								var b = function() {
									...
									return e.size = function(t) {
									...
									}, e.sizeFromDimension = function(t, n) {
									...
									}, e.sizeToDimension = function(t, n) {
									...
									}, e.getSizeFromDimensionRange = function(e, t, n) {
										for (var r = 1, o = t; o < n; o++) {
									...
									}, e.indicesToOffset = function(e, t, n) {
										void 0 === n && (n = e.length);
										for (var r = 0, o = 0; o < n; ++o) r += t[o] * e[o];
										return r
									}, e.offsetToIndices = function(e, t) {
										var n = t.length;
										if (0 === n) return [];
										if (1 === n) return [e * t[0]];
										for (var r = new Array(t.length), o = 0; o < r.length - 1; ++o) r[o] = Math.floor(e / t[o]), e -= r[o] * t[o];
										return r[r.length - 1] = e, r
									}, e.normalizeAxis = function(e, t) {
										if (e < -t && e >= t) throw new Error("unsupported axis for this operation.");
										return e < 0 ? e + t : e
									}, e.normalizeAxes = function(e, t) {
										var n = this;
										return e.map((function(e) {
											return n.normalizeAxis(e, t)
										}))
									}, e.incrementIndex = function(e, t, n) {
										...
										for (var r = n - 1; r >= 0 && (e[r]++, !(e[r] < t[r])); --r) e[r] = 0
									}, e.calculateReshapedDims = function(t, n) {
										if (0 === n.length) {
											if (0 === t.length || 1 === e.size(t)) return [];
											throw new Error("cannot reshape to a scalar Tensor")
										}
										for (var r = n.length, o = new Array(r), i = -1, a = 1, s = 0; s < r; s++) {
											if (n[s] < -1) throw new Error("a dimension in shape hints cannot be less than -1");
											if (-1 === n[s]) {
												if (-1 !== i) throw new Error("at most one dimension in shape hints can be -1");
												i = s
											} else {
												if (0 === n[s]) {
													if (s >= t.length) throw new Error("the dimension with value zero exceeds the dimension size of the input tensor");
													o[s] = t[s]
												} else o[s] = n[s];
												a *= o[s]
											}
										...
										var u = e.size(t);
										if (-1 !== i) {
											if (u % a != 0) throw new Error("the input tensor cannot be reshaped to the requested shape. Input shape: [" + t + "] Output shape: [" + n + "]");
											o[i] = u / a
										} else if (a !== u) throw new Error("reshapedDims and originalDims don't have matching sizes");
										return o
									}, e.sortBasedOnPerm = function(e, t) {
										return t ? t.map((function(t) {
											return e[t]
										})) : e.slice().reverse()
									}, e.padShape = function(e, t) {
										var n = e.length;
									...
									}, e.validateDimsAndCalcSize = function(e) {
										var t, n;
										...
										try {
											for (var i = o(e), a = i.next(); !a.done; a = i.next()) {
												var s = a.value;
												if (!Number.isInteger(s)) throw new TypeError("Invalid shape: " + s + " is not an integer");
												if (s < 0 || s > 2147483647) throw new TypeError("Invalid shape: length " + s + " is not allowed");
												r *= s
											}
										} catch (e) {
											t = {
										...
										return r
									}, e.flattenShape = function(e, t) {
										t < 0 && (t += e.length);
										var n = e.reduce((function(e, t) {
												return e * t
											}), 1),
											r = e.slice(t).reduce((function(e, t) {
												return e * t
											}), 1);
										return [n / r, r]
									}, e.squeezeShape = function(t, n) {
										var r = new Array;
										n = e.normalizeAxes(n, t.length);
										for (var o = 0; o < t.length; o++) {
											var i = n.indexOf(o) >= 0;
											if (i && 1 !== t[o]) throw new Error("squeeze an axis of size different than 1");
											(0 === n.length && t[o] > 1 || n.length > 0 && !i) && r.push(t[o])
										}
										return r
									}, e.unsqueezeShape = function(t, n) {
										var r = new Array(t.length + n.length);
										r.fill(0);
										for (var o = 0; o < n.length; o++) {
											var i = e.normalizeAxis(n[o], t.length);
											if (i >= r.length) throw new Error("'axes' has an out of range axis");
											if (0 !== r[i]) throw new Error("'axes' has a duplicate axis");
											r[i] = 1
										}
										var a = 0;
										for (o = 0; o < r.length; o++) 0 === r[o] && (r[o] = t[a++]);
										if (a !== t.length) throw new Error("the unsqueezed dimension could not be established");
										return r
									}, e
								}();
								t.ShapeUtil = b;
								var y = function() {
									function e() {}
									return e.sqr = function(e, t, n, r, o) {
										if (r < 0 || r >= t.length) throw new Error("sourceIndex out of bounds");
										if (n < 0 || n >= e.length) throw new Error("targetIndex out of bounds");
										if (r + o > t.length) throw new Error("source indices to be copied are outside bounds");
										if (n + o > e.length) throw new Error("target array is too small to hold result");
										for (var i = 0; i < o; i++) e[n + i] += Math.pow(t[r + i], 2)
									}, e.axpy = function(e, t, n, r, o, i) {
										if (r < 0 || r >= t.length) throw new Error("sourceIndex out of bounds");
										if (n < 0 || n >= e.length) throw new Error("targetIndex out of bounds");
										if (r + o > t.length) throw new Error("source indices to be copied are outside bounds");
										if (n + o > e.length) throw new Error("target array is too small to hold result");
										for (var a = 0; a < o; a++) e[n + a] += i * t[r + a]
									}, e.powx = function(e, t, n, r, o, i) {
										if (r < 0 || r >= t.length) throw new Error("sourceIndex out of bounds");
										if (n < 0 || n >= e.length) throw new Error("targetIndex out of bounds");
										if (r + o > t.length) throw new Error("source indices to be copied are outside bounds");
										if (n + o > e.length) throw new Error("target array is too small to hold result");
										for (var a = 0; a < o; a++) e[n + a] = Math.pow(t[r + a], i)
									}, e.mul = function(e, t, n, r, o) {
										if (r < 0 || r >= t.length) throw new Error("sourceIndex out of bounds");
										if (n < 0 || n >= e.length) throw new Error("targetIndex out of bounds");
										if (r + o > t.length) throw new Error("source indices to be copied are outside bounds");
										if (n + o > e.length) throw new Error("target array is too small to hold result");
										for (var i = 0; i < o; i++) e[n + i] = t[r + i] * e[n + i]
									}, e
								}();
								t.MathUtil = y;
								var m = function() {
									function e() {}
									return e.splitShape = function(t, n, r, o) {
										if (0 === r.length) {
											if (!o) throw new Error("need to know number of outputs when the 'split' attribute is not specified");
											e.determineSplit(t[n], o, r)
										}
										for (var i = [], a = [0], s = 0; s < r.length; ++s) {
											0 !== s && a.push(a[s - 1] + r[s - 1]);
											var u = t.slice();
											u[n] = r[s], i.push(u)
										}
										return [i, a]
									}, e.determineSplit = function(e, t, n) {
										if (e % t != 0) throw new Error("cannot split tensor to equal sized parts");
										for (var r = 0; r < t; ++r) n.push(e / t)
									}, e
								}();
								t.SplitUtil = m;
								var v = function() {
									function e() {}
									return e.calcReduce = function(t, n, r, o, i) {
										var a = t.dims.slice(0);
										0 === n.length && a.forEach((function(e, t) {
											return n.push(t)
										}));
										for (var s = e.calcReduceShape(a, n, !0), u = b.size(s), l = new c.Tensor(s, t.type), f = b.computeStrides(s), d = b.computeStrides(a), h = new Array(a.length), g = 0; g < u; g++) {
											var y = b.offsetToIndices(g, f);
											p.fillIndex(y, a, h), l.set(y, e.calcReduceByAxis(t.numberData, n, a, 0, b.indicesToOffset(h, d), o, i))
										}
										return r ? l : new c.Tensor(e.calcReduceShape(a, n, r), l.type, void 0, void 0, l.data, l.dataId)
									}, e.calcReduceByAxis = function(t, n, r, o, i, a, s) {
										var u = 0;
										if (o >= n.length) return a(t[i]);
										for (var c = n[o], l = c >= r.length ? 1 : b.size(r.slice(c + 1)), f = 0; f < r[c]; f++) u = 0 === f ? e.calcReduceByAxis(t, n, r, o + 1, i, a, s) : s(u, e.calcReduceByAxis(t, n, r, o + 1, i, a, s)), i += l;
										return u
									}, e.calcReduceShape = function(e, t, n) {
										for (var r = e.slice(), o = 0; o < t.length; o++) r[t[o]] = n ? 1 : 0;
								...
								var _ = function() {
									function e() {}
									return e.adjustPoolAttributes = function(e, t, n, r, o) {
										...
										if (e)
											for (var i = 0; i < t.length - 2; i++) i >= n.length ? n.push(t[i + 2]) : n[i] = t[i + 2];
									...
									}, e.adjustPadsBasedOnAutoPad = function(t, n, r, o, i, a) {
										if (a) {
											...
											for (var s = 0; s < t.length - 2; s++) e.adjustPadAndReturnShape(t[s + 2], n[s], r[s], o[s], i, s, s + t.length - 2, a)
										}
									}, e.computePoolOutputShape = function(t, n, r, o, i, a) {
										if (n.length <= 0) throw new Error("input shape must be of size greater than 0");
										var s = [n[0], n[1]],
											u = new Array(o.length).fill(1);
										return e.computeShapeHelper(t, n, s, r, u, o, i, a), s
									}, e.computeConvOutputShape = function(t, n, r, o, i, a, s) {
										if (t.length <= 0 || n.length <= 0) throw new Error("invalid input tensor dims or invalid filter tensor dims");
										var u = [t[0], n[0]];
										return e.computeShapeHelper(!1, t, u, r, o, i, a, s), u
									}, e.computeShapeHelper = function(t, n, r, o, i, a, s, u) {
										if (t)
											for (var c = 0; c < n.length - 2; c++) r.push(1);
										else
											for (c = 0; c < n.length - 2; c++) r.push(e.adjustPadAndReturnShape(n[c + 2], o[c], i[c], a[c], s, c, c + n.length - 2, u))
									}, e.adjustPadAndReturnShape = function(e, t, n, r, o, i, a, s) {
										var u = n * (r - 1) + 1;
										...
										switch (s) {
											...
											case "SAME_UPPER":
												...
												var c = ((e + t - 1) / t - 1) * t + r - e;
												return o[i] = "SAME_LOWER" === s ? Math.floor((c + 1) / 2) : Math.floor(c / 2), o[a] = c - o[i], Math.floor((e + c - r) / t + 1);
											default:
							...
							7967: function(e, t) {
								...
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.iterateExtraOptions = void 0, t.iterateExtraOptions = function(e, r, o, i) {
									...
									Object.entries(e).forEach((function(e) {
										var a = n(e, 2),
											...
											u = a[1],
											c = r ? r + s : s;
										if ("object" == typeof u) t.iterateExtraOptions(u, c + ".", o, i);
										else if ("string" == typeof u || "number" == typeof u) i(c, u.toString());
										else {
											if ("boolean" != typeof u) throw new Error("Can't handle extra config type: " + typeof u);
											i(c, u ? "1" : "0")
										}
									}))
								}
							...
							2157: function(e, t, n) {
								...
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.endProfiling = t.run = t.releaseSession = t.createSession = t.initOrt = t.initWasm = void 0;
								var c, l, f, p = n(2174),
									d = a(n(349)),
									h = n(6361),
									g = function() {
										return !!p.env.wasm.proxy && "undefined" != typeof document
									},
									b = !1,
									y = !1,
									m = !1,
									...
									x = [],
									T = function() {
										if (b || !y || m || !c) throw new Error("worker not ready")
									},
									S = function(e) {
										switch (e.data.type) {
											case "init-wasm":
												b = !1, e.data.err ? (m = !0, l[1](e.data.err)) : (y = !0, l[0]());
												break;
											case "init-ort":
											...
											case "run":
												...
												break;
											case "end-profiling":
												e.data.err ? x.shift()[1](e.data.err) : x.shift()[0]()
										}
									},
								...
								t.initWasm = function() {
									return s(void 0, void 0, void 0, (function() {
										return u(this, (function(e) {
											if (g()) {
												if (y) return [2];
												if (b) throw new Error("multiple calls to 'initWasm()' detected.");
												if (m) throw new Error("previous call to 'initWasm()' failed.");
												return b = !0, void 0 === p.env.wasm.wasmPaths && O && 0 !== O.indexOf("blob:") && (p.env.wasm.wasmPaths = O.substr(0, O.lastIndexOf("/") + 1)), [2, new Promise((function(e, t) {
													null == c || c.terminate(), (c = n(9710).Z()).onmessage = S, l = [e, t];
													var r = {
														type: "init-wasm",
														in: p.env.wasm
													};
											...
											return [2, h.initializeWebAssembly(p.env.wasm)]
										}))
									}))
								}, t.initOrt = function(e, t) {
									return s(void 0, void 0, void 0, (function() {
										return u(this, (function(n) {
											return g() ? (T(), [2, new Promise((function(n, r) {
												f = [n, r];
												var o = {
													type: "init-ort",
													in: {
									...
									return s(void 0, void 0, void 0, (function() {
										return u(this, (function(n) {
											return g() ? (T(), [2, new Promise((function(n, r) {
												...
												c.postMessage(o, [e.buffer])
											}))]) : [2, d.createSession(e, t)]
										}))
									}))
								}, t.releaseSession = function(e) {
									return s(void 0, void 0, void 0, (function() {
										return u(this, (function(t) {
											return g() ? (T(), [2, new Promise((function(t, n) {
												_.push([t, n]);
												var r = {
													type: "release",
													in: e
												...
												c.postMessage(r)
											}))]) : (d.releaseSession(e), [2])
										}))
									}))
								}, t.run = function(e, t, n, r, o) {
									return s(void 0, void 0, void 0, (function() {
										return u(this, (function(i) {
											return g() ? (T(), [2, new Promise((function(i, a) {
												w.push([i, a]);
												var s = {
													type: "run",
													in: {
												...
												c.postMessage(s, d.extractTransferableBuffers(n))
											}))]) : [2, d.run(e, t, n, r, o)]
										}))
									}))
								}, t.endProfiling = function(e) {
									return s(void 0, void 0, void 0, (function() {
										return u(this, (function(t) {
											return g() ? (T(), [2, new Promise((function(t, n) {
												x.push([t, n]);
							...
							586: function(e, t, n) {
								...
								var r = n(7967),
									o = n(4983),
									i = n(6361);
								t.setRunOptions = function(e) {
									var t = i.getInstance(),
										n = 0,
										a = [],
										s = e || {};
									try {
										if (void 0 === (null == e ? void 0 : e.logSeverityLevel)) s.logSeverityLevel = 2;
										else if ("number" != typeof e.logSeverityLevel || !Number.isInteger(e.logSeverityLevel) || e.logSeverityLevel < 0 || e.logSeverityLevel > 4) throw new Error("log serverity level is not valid: " + e.logSeverityLevel);
										if (void 0 === (null == e ? void 0 : e.logVerbosityLevel)) s.logVerbosityLevel = 0;
										...
										void 0 === (null == e ? void 0 : e.terminate) && (s.terminate = !1);
										var u = 0;
										if (void 0 !== (null == e ? void 0 : e.tag) && (u = o.allocWasmString(e.tag, a)), 0 === (n = t._OrtCreateRunOptions(s.logSeverityLevel, s.logVerbosityLevel, !!s.terminate, u))) throw new Error("Can't create run options");
										return void 0 !== (null == e ? void 0 : e.extra) && r.iterateExtraOptions(e.extra, "", new WeakSet, (function(e, r) {
											var i = o.allocWasmString(e, a),
												s = o.allocWasmString(r, a);
											if (0 !== t._OrtAddRunConfigEntry(n, i, s)) throw new Error("Can't set a run config entry: " + e + " - " + r)
										})), [n, a]
									} catch (e) {
										throw 0 !== n && t._OrtReleaseRunOptions(n), a.forEach(t._free), e
									}
								}
							},
							2306: function(e, t, n) {
								...
								var a, s = n(2174),
									...
									l = function() {
										function e() {}
										return e.prototype.loadModel = function(e, t) {
											return r(this, void 0, void 0, (function() {
												var n;
												return o(this, (function(r) {
													switch (r.label) {
														case 0:
															return a ? [3, 2] : [4, u.initOrt(s.env.wasm.numThreads, c(s.env.logLevel))];
														case 1:
															r.sent(), a = !0, r.label = 2;
														case 2:
															return [4, u.createSession(e, t)];
														case 3:
															return n = i.apply(void 0, [r.sent(), 3]), this.sessionId = n[0], this.inputNames = n[1], this.outputNames = n[2], [2]
													}
												}))
											}))
										}, e.prototype.dispose = function() {
											return r(this, void 0, void 0, (function() {
												return o(this, (function(e) {
													return [2, u.releaseSession(this.sessionId)]
												}))
											}))
										}, e.prototype.run = function(e, t, n) {
											return r(this, void 0, void 0, (function() {
												var r, i, a, c, l, f, p = this;
												return o(this, (function(o) {
													switch (o.label) {
														case 0:
															return r = [], i = [], Object.entries(e).forEach((function(e) {
																var t = e[0],
																	n = e[1],
																	o = p.inputNames.indexOf(t);
																if (-1 === o) throw new Error("invalid input '" + t + "'");
																r.push(n), i.push(o)
															})), a = [], Object.entries(t).forEach((function(e) {
																var t = e[0],
																	n = p.outputNames.indexOf(t);
																if (-1 === n) throw new Error("invalid output '" + t + "'");
																a.push(n)
															})), [4, u.run(this.sessionId, i, r.map((function(e) {
																return [e.type, e.dims, e.data]
															})), a, n)];
														case 1:
															for (c = o.sent(), l = {}, f = 0; f < c.length; f++) l[this.outputNames[a[f]]] = new s.Tensor(c[f][0], c[f][2], c[f][1]);
															return [2, l]
													}
												}))
											}))
										}, e.prototype.startProfiling = function() {}, e.prototype.endProfiling = function() {
											u.endProfiling(this.sessionId)
										}, e
									}();
								t.OnnxruntimeWebAssemblySessionHandler = l
							},
							4919: function(e, t, n) {
								Object.defineProperty(t, "__esModule", {
									value: !0
								...
								var r = n(7967),
									o = n(4983),
									i = n(6361);
								t.setSessionOptions = function(e) {
									var t = i.getInstance(),
										n = 0,
										a = [],
										s = e || {};
									...
									try {
										void 0 === (null == e ? void 0 : e.graphOptimizationLevel) && (s.graphOptimizationLevel = "all");
										var u = function(e) {
											switch (e) {
												case "disabled":
													return 0;
										...
										void 0 === (null == e ? void 0 : e.enableCpuMemArena) && (s.enableCpuMemArena = !0), void 0 === (null == e ? void 0 : e.enableMemPattern) && (s.enableMemPattern = !0), void 0 === (null == e ? void 0 : e.executionMode) && (s.executionMode = "sequential");
										var c = function(e) {
												switch (e) {
													case "sequential":
														return 0;
											...
											l = 0;
										if (void 0 !== (null == e ? void 0 : e.logId) && (l = o.allocWasmString(e.logId, a)), void 0 === (null == e ? void 0 : e.logSeverityLevel)) s.logSeverityLevel = 2;
										else if ("number" != typeof e.logSeverityLevel || !Number.isInteger(e.logSeverityLevel) || e.logSeverityLevel < 0 || e.logSeverityLevel > 4) throw new Error("log serverity level is not valid: " + e.logSeverityLevel);
										if (void 0 === (null == e ? void 0 : e.logVerbosityLevel)) s.logVerbosityLevel = 0;
										else if ("number" != typeof e.logVerbosityLevel || !Number.isInteger(e.logVerbosityLevel)) throw new Error("log verbosity level is not valid: " + e.logVerbosityLevel);
										if (void 0 === (null == e ? void 0 : e.enableProfiling) && (s.enableProfiling = !1), 0 === (n = t._OrtCreateSessionOptions(u, !!s.enableCpuMemArena, !!s.enableMemPattern, c, !!s.enableProfiling, 0, l, s.logSeverityLevel, s.logVerbosityLevel))) throw new Error("Can't create session options");
										return void 0 !== (null == e ? void 0 : e.extra) && r.iterateExtraOptions(e.extra, "", new WeakSet, (function(e, r) {
											var i = o.allocWasmString(e, a),
												s = o.allocWasmString(r, a);
											if (0 !== t._OrtAddSessionConfigEntry(n, i, s)) throw new Error("Can't set a session config entry: " + e + " - " + r)
										})), [n, a]
									} catch (e) {
										throw 0 !== n && t._OrtReleaseSessionOptions(n), a.forEach(t._free), e
									}
								}
							},
							4983: function(e, t, n) {
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.allocWasmString = void 0;
								var r = n(6361);
								t.allocWasmString = function(e, t) {
									var n = r.getInstance(),
							...
							349: function(e, t, n) {
								...
								Object.defineProperty(t, "__esModule", {
									value: !0
								}), t.extractTransferableBuffers = t.endProfiling = t.run = t.releaseSession = t.createSession = t.initOrt = void 0;
								var i = n(586),
									a = n(4919),
									s = n(4983),
									u = n(6361);
								t.initOrt = function(e, t) {
									var n = u.getInstance()._OrtInit(e, t);
									if (0 !== n) throw new Error("Can't initialize onnxruntime. error code = " + n)
								};
								var c = [];
								t.createSession = function(e, t) {
									var n, o = u.getInstance(),
										i = o._malloc(e.byteLength),
										s = 0,
										l = 0,
										f = [];
									try {
										if (l = (n = r(a.setSessionOptions(t), 2))[0], f = n[1], o.HEAPU8.set(e, i), 0 === (s = o._OrtCreateSession(i, e.byteLength, l))) throw new Error("Can't create a session")
									} finally {
										o._free(i), o._OrtReleaseSessionOptions(l), f.forEach(o._free)
									}
									for (var p = o._OrtGetInputCount(s), d = o._OrtGetOutputCount(s), h = [], g = [], b = [], y = [], m = 0; m < p; m++) {
										var v = o._OrtGetInputName(s, m);
										if (0 === v) throw new Error("Can't get an input name");
										g.push(v), h.push(o.UTF8ToString(v))
									}
									for (m = 0; m < d; m++) {
										var _ = o._OrtGetOutputName(s, m);
										if (0 === _) throw new Error("Can't get an output name");
										y.push(_), b.push(o.UTF8ToString(_))
									}
									return c.push([s, g, y]), [c.length - 1, h, b]
								}, t.releaseSession = function(e) {
									var t = u.getInstance(),
										n = c[e];
									...
									var r = n[0],
										o = n[1],
										i = n[2];
									o.forEach(t._OrtFree), i.forEach(t._OrtFree), t._OrtReleaseSession(r), c[e] = void 0
								};
								var l = function(e) {
										switch (e) {
											case 3:
								...
								t.run = function(e, t, n, o, a) {
									var p, d = u.getInstance(),
										h = c[e];
									if (!h) throw new Error("invalid session id");
									var g = h[0],
										b = h[1],
										y = h[2],
										m = t.length,
										...
										T = [];
									try {
										_ = (p = r(i.setRunOptions(a), 2))[0], w = p[1];
										for (var S = function(e) {
												var t = n[e][0],
													...
													a = void 0;
												if (Array.isArray(o)) {
													a = 4 * o.length, i = d._malloc(a), T.push(i);
													for (var u = i / 4, c = 0; c < o.length; c++) {
														if ("string" != typeof o[c]) throw new TypeError("tensor data at index " + c + " is not a string");
														d.HEAPU32[u++] = s.allocWasmString(o[c], T)
													}
												} else a = o.byteLength, i = d._malloc(a), T.push(i), d.HEAPU8.set(new Uint8Array(o.buffer, o.byteOffset, a), i);
												var l = d.stackSave(),
													f = d.stackAlloc(4 * r.length);
												try {
													var p = f / 4;
													r.forEach((function(e) {
														return d.HEAP32[p++] = e
													}));
													var h = d._OrtCreateTensor(function(e) {
														switch (e) {
															case "int8":
																return 3;
															case "uint8":
										...
										try {
											var k = E / 4,
												...
												C = P / 4,
												R = D / 4;
											for (O = 0; O < m; O++) d.HEAPU32[k++] = x[O], d.HEAPU32[N++] = b[t[O]];
											for (O = 0; O < v; O++) d.HEAPU32[C++] = 0, d.HEAPU32[R++] = y[o[O]];
											var F = d._OrtRun(g, I, E, m, D, v, P, _),
												L = [];
											if (0 === F)
												for (O = 0; O < v; O++) {
													var M = d.HEAPU32[P / 4 + O],
														j = d.stackSave(),
														U = d.stackAlloc(16),
														B = void 0,
														V = 0;
													try {
														if (0 !== (F = d._OrtGetTensorData(M, U, U + 4, U + 8, U + 12))) throw new Error("Can't get a tensor data. error code = " + F);
														var z = U / 4,
															G = d.HEAPU32[z++];
														V = d.HEAPU32[z++];
														for (var H = d.HEAPU32[z++], W = d.HEAPU32[z++], q = [], Y = 0; Y < W; Y++) q.push(d.HEAPU32[H / 4 + Y]);
														d._OrtFree(H);
														var X = 0 === q.length ? 1 : q.reduce((function(e, t) {
															return e * t
														}));
														if ("string" === (B = l(G))) {
															for (var K = [], $ = V / 4, Z = 0; Z < X; Z++) {
																var J = d.HEAPU32[$++],
																	Q = Z === X - 1 ? void 0 : d.HEAPU32[$] - J;
																K.push(d.UTF8ToString(J, Q))
															}
															L.push([B, q, K])
														} else {
															var ee = new(f(B))(X);
															new Uint8Array(ee.buffer, ee.byteOffset, ee.byteLength).set(d.HEAPU8.subarray(V, V + ee.byteLength)), L.push([B, q, ee])
														}
													} finally {
														d.stackRestore(j), "string" === B && V && d._free(V), d._OrtReleaseTensor(M)
													}
												}
											if (0 === F) return L;
											throw new Error("failed to call OrtRun(). error code = " + F + ".")
										} finally {
											d.stackRestore(A)
										}
									} finally {
										x.forEach(d._OrtReleaseTensor), T.forEach(d._free), d._OrtReleaseRunOptions(_), w.forEach(d._free)
									}
								}, t.endProfiling = function(e) {
									var t = u.getInstance(),
										n = c[e];
									...
									if (0 === o) throw new Error("Can't get an profile file name");
									t._OrtFree(o)
								}, t.extractTransferableBuffers = function(e) {
									var t, n, r = [];
									try {
										for (var i = o(e), a = i.next(); !a.done; a = i.next()) {
											var s = a.value[2];
											!Array.isArray(s) && s.buffer && r.push(s.buffer)
										}
									} catch (e) {
										t = {
											error: e
							...
							6361: function(e, t, n) {
								...
								var c, l = i(n(6449)),
									...
									g = !1,
									b = function(e, t) {
										return t ? e ? "ort-wasm-simd-threaded.wasm" : "ort-wasm-threaded.wasm" : e ? "ort-wasm-simd.wasm" : "ort-wasm.wasm"
									};
								t.initializeWebAssembly = function(e) {
									return a(void 0, void 0, void 0, (function() {
										var t, r, o, i, a, u, y, m, v, _, w;
										return s(this, (function(s) {
											switch (s.label) {
												case 0:
													if (d) return [2, Promise.resolve()];
													if (h) throw new Error("multiple calls to 'initializeWebAssembly()' detected.");
													if (g) throw new Error("previous call to 'initializeWebAssembly()' failed.");
													return h = !0, t = e.initTimeout, r = e.numThreads, o = e.simd, i = r > 1 && function() {
														try {
													...
													}(), u = "string" == typeof e.wasmPaths ? e.wasmPaths : void 0, y = b(!1, i), m = b(a, i), v = "object" == typeof e.wasmPaths ? e.wasmPaths[m] : void 0, _ = !1, w = [], t > 0 && w.push(new Promise((function(e) {
														setTimeout((function() {
															_ = !0, e()
														}), t)
													}))), w.push(new Promise((function(e, t) {
														var r = i ? f.default : p.default,
															o = {
																locateFile: function(e, t) {
																	return e.endsWith(".worker.js") && "undefined" != typeof Blob ? URL.createObjectURL(new Blob([n(5118)], {
																		type: "text/javascript"
																	})) : e === y ? null != v ? v : (null != u ? u : t) + m : t + e
																}
															};
														if (i)
															if ("undefined" == typeof Blob) o.mainScriptUrlOrBlob = l.join("/", "ort-wasm-threaded.js");
															else {
																var a = "var ortWasmThreaded=(function(){var _scriptDir;return " + f.default.toString() + "})();";
																o.mainScriptUrlOrBlob = new Blob([a], {
																	type: "text/javascript"
																})
															} r(o).then((function(t) {
															h = !1, d = !0, c = t, e()
												...
												case 1:
													if (s.sent(), _) throw new Error("WebAssembly backend initializing failed due to timeout: " + t + "ms");
													return [2]
											}
										}))
									}))
									...
									var e;
									!d || h || g || (h = !0, null === (e = c.PThread) || void 0 === e || e.terminateAllThreads(), c = void 0, h = !1, d = !1, g = !0)
								}
							},
							9710: function(e, t, n) {
								n.d(t, {
		...
		constants = createCommonjsModule((function(e, t) {
			Object.defineProperty(t, "__esModule", {
				value: !0
			}), t.EN_BLANK_INDEX = 28, t.EN_CHARS = " abcdefghijklmnopqrstuvwxyz'", t.EN_CHAR_MAP = {}, t.EPSILON = 1e-5, t.IS_NODE = "undefined" == typeof window;
			for (var n = 0, r = t.EN_CHARS.length; n < r; n++) t.EN_CHAR_MAP[t.EN_CHARS.charAt(n)] = n
		})),
		Vocabulary = function() {
			function e(e, t) {
				this._charToIndex = {}, this._indexToChar = {}, this._blankIndex = t;
				for (var n = 0, r = Object.entries(e); n < r.length; n++) {
					var o = r[n],
						i = o[0],
						a = o[1];
					this._charToIndex[i] = a, this._indexToChar[a] = i
				}
			}
			return Object.defineProperty(e.prototype, "charToIndex", {
				get: function() {
					return this._charToIndex
				},
				enumerable: !0,
				configurable: !0
			}), Object.defineProperty(e.prototype, "indexToChar", {
				get: function() {
					return this._indexToChar
				},
				enumerable: !0,
				configurable: !0
			}), Object.defineProperty(e.prototype, "blankIndex", {
				get: function() {
		...
		EN_VOCABULARY = new Vocabulary(constants.EN_CHAR_MAP, constants.EN_BLANK_INDEX),
		logSumExp = function(e, t) {
			return 0 === e ? t : 0 === t ? e : e > t ? e + Math.log1p(Math.exp(t - e)) : t + Math.log1p(Math.exp(e - t))
		},
		BeamEntry = function() {
			function e(e, t) {
				this.seq = e, this.pTotal = 0, this.pBlank = 0, this.pNonBlank = 0, this._last = -1, t ? this._last = t : this._calculateLast()
			}
			return e.prototype._calculateLast = function() {
				this.seq.length > 0 && (this._last = this.seq[this.seq.length - 1])
			}, e.prototype.convertToStr = function(e) {
				return void 0 === this._string && (this._string = this.seq.map((function(t) {
					return e.indexToChar[t]
				})).join("")), this._string
			}, e.prototype.copy = function(t, n) {
				if (-1 !== this._last) {
					var r = new e(this.seq, this._last);
					return this._parent && this._parent._last === this._last ? r.pBlank = this.pTotal + n : r.pBlank = this.pNonBlank + n, r.pNonBlank = this.pNonBlank + t[this._last], r.pTotal = logSumExp(r.pNonBlank, r.pBlank), r._parent = this, r
				}
			}, e.prototype.extend = function(t, n, r) {
				var o = 0,
					i = [],
					a = 0,
					s = t;
				if (-1 === this._last && 0 === t) a = this.pTotal + logSumExp(n, r), s = -1;
				else if (t === this._last) {
					if (0 === this.pBlank) return;
					a = o = this.pBlank + n, i = this.seq.concat([t])
				} else a = o = this.pTotal + n, i = this.seq.concat([t]);
				var u = new e(i, s);
				return u.pNonBlank = o, u.pTotal = a, u._parent = this, u
			}, e.prototype.toString = function(e) {
				return this.convertToStr(e) + ", (" + this.pTotal + ")"
			}, e
		}(),
		BeamList = function() {
			function e(e) {
				this._size = e, this._beamList = [], this._beams = {}
			}
			return e.prototype.add = function(e, t) {
				if (void 0 !== e) {
					var n = e.convertToStr(t),
						r = this._beams[n];
					r ? (r.pBlank = logSumExp(e.pBlank, r.pBlank), r.pNonBlank = logSumExp(e.pNonBlank, r.pNonBlank), r.pTotal = logSumExp(e.pTotal, r.pTotal)) : (this._beams[n] = e, this._beamList.push(e))
				}
			}, e.prototype.sort = function() {
				var e = this._beamList.sort((function(e, t) {
					return t.pTotal - e.pTotal
				}));
				return e.length = this._size, e
		...
		CTCBeamSearch = function() {
			function e(e) {
				this._vocabulary = e, this._vocabSize = Object.keys(e.charToIndex).length, this._blankIndex = e.blankIndex
			}
			return e.prototype.search = function(e, t) {
				var n = this,
					r = [new BeamEntry([])];
				return e.forEach((function(e) {
					var o = new BeamList(t);
					r.forEach((function(t) {
						o.add(t.copy(e, e[n._blankIndex]), n._vocabulary);
						for (var r = 0, i = e.length; r < i; r++) r !== n._blankIndex && o.add(t.extend(r, e[r], e[n._blankIndex]), n._vocabulary)
					})), r = o.sort()
				})), r
			}, Object.defineProperty(e.prototype, "vocabulary", {
				get: function() {
		...
		CTCBeamSearch_1 = CTCBeamSearch,
		ctc_beam_search = Object.defineProperty({
			Vocabulary: Vocabulary_1,
			EN_VOCABULARY: EN_VOCABULARY,
			CTCBeamSearch: CTCBeamSearch_1
		}, "__esModule", {
			value: !0
		}),
		dist = createCommonjsModule((function(e, t) {
			function n(e) {
				for (var n in e) t.hasOwnProperty(n) || (t[n] = e[n])
			}
			Object.defineProperty(t, "__esModule", {
				value: !0
			}), n(constants), n(ctc_beam_search)
		}));
	class Predictor {
		constructor(e, t, n, r = !1) {
			this.session = e, this.voc = t, this.cheatMap = n || {}, this.isDebug = r, this.voclen = Object.keys(t.indexToChar).length
		}
		static async load(e, t, n = 0, r, o = !1) {
			const i = await ortWeb_min.InferenceSession.create(e),
				a = await (await fetch(t)).json(),
				s = new dist.Vocabulary(a, n),
				u = {};
			if (void 0 !== r) {
				const e = await (await fetch(r)).text();
				let t = 0;
				for (const n of e.split("\n")) {
					const [e, r] = n.trim().split("\t").map((e => e.trim()));
					void 0 !== e && void 0 !== r && (u[r] = e, t += 1)
				}
				for (const [e, t] of Object.entries(u)) {
					const n = e.replace("́", "");
					e !== n && n.length > 2 && (u[n] = t)
				}
				console.log(`Loaded ${t} cheat map entries`)
			}
			return new Predictor(i, s, u, o)
		}
		async predict(e) {
			if (void 0 !== this.cheatMap[e] && !this.isDebug) return this.cheatMap[e];
			e.length > 32 && (e = e.slice(0, 32));
			const t = new Int32Array(32);
			t.fill(0);
			const n = new Int32Array(32);
			n.fill(0);
			const r = (e = e.replace(/'/g, "́")).indexOf("́");
			e = (e = e.replace(/\u0301/g, "")).replace("э", "е"), r > 0 && (n[r - 1] = 1);
			for (let n = 0; n < e.length; n++) {
				const r = e[n],
					o = this.voc.charToIndex[r];
				if (void 0 === o) throw new Error("input text contains unsupported character " + r);
				t[n] = o
			}
			const o = new ortWeb_min.Tensor(t, [1, 32]),
				i = new ortWeb_min.Tensor(n, [1, 32]),
				a = await this.session.run({
					inputs: o,
					accents: i
				}),
				s = [];
			for (let e = 0; e < 64; e++) s.push(a.logits.data.slice(e * this.voclen, e * this.voclen + this.voclen));
			return decode(new dist.CTCBeamSearch(this.voc).search(s, 10)[0], this.voc)
		}
	}

	function decode(e, t) {
		return e.seq.filter((e => e != t.blankIndex)).map((e => t.indexToChar[e])).join("")
	}
	class Debounce {
		constructor(e) {
			this.engine = e, this.pending = [], this.idle = new EventDispatcher, this.call = this.call.bind(this)
		}
		async call() {
			if (this.pending.push(arguments), 1 === this.pending.length) {
				for (this.idle.dispatchEvent({
						idle: !1
					}); this.pending.length > 0;) {
					this.pending.length > 1 && this.pending.splice(0, this.pending.length - 1);
					try {
				...
				this.idle.dispatchEvent({
					idle: !0
				})
			}
		}
		addIdleStateListener(e) {
			return this.idle.addEventListener(e)
		}
	}
	class EventDispatcher {
		constructor() {
			this.id = 0, this.listeners = {}
		}
		addEventListener(e) {
			this.id += 1;
			const t = "" + this.id;
		...
		dispatchEvent(e) {
			for (const t of Object.keys(this.listeners)) try {
				this.listeners[t](e)
			} catch (e) {
				console.error(e)
			}
	...
	const CU_THOUSAND = "҂",
		...
		CU_800 = "ѿ",
		CU_NBSP = " ",
		CU_NUMBER = new Map(Object.entries({
			"ц": 900,
			"ѿ": 800,
			"ѱ": 700,
			"х": 600,
	...
	function invertMap(e) {
		return new Map([...e.entries()].map((([e, t]) => [t, e])))
	}
	const CU_DIGIT = invertMap(CU_NUMBER);

	function cu_format_int(e, t = {}) {
		const {
			add_titlo: n = !0,
			dialect: r = "standard"
		} = t;
		if ("standard" !== r && "old" !== r) throw new Error(`unknown dialect "${r}", expected one of: ["old", "standard"]`);
		if (e < 0) return "-" + cu_format_int(-e, {
			add_titlo: n,
			dialect: r
		});
		if (0 === e) return n ? "0" + CU_TITLO : "0";
		let o = _format_thousand_groups(e);
		o.length > 1 && (1 === o[o.length - 2].length ? (o[o.length - 2] = o[o.length - 2] + o[o.length - 1], o[o.length - 1] = "") : o[o.length - 2].length > 1 && (0 == o[o.length - 1].length || "old" == r) && (o[o.length - 2] = _insert_thousand_before_each_digit(o[o.length - 2]), "old" === r && (o[o.length - 2] += o[o.length - 1], o[o.length - 1] = ""))), n && (o = o.map((e => _place_titlo(e))));
		return o.map(((e, t) => e.length > 0 ? Array(o.length - 1 - t).fill(CU_THOUSAND).concat(e).join("") : "")).filter((e => "" !== e)).join(CU_NBSP)
	}

	function _format_small_number(e) {
		if (e < 0 || e >= 1e3) throw new Error("Bad input: " + e);
		const t = 100 * Math.floor(e / 100);
		e -= t;
		const n = 10 * Math.floor(e / 10);
		e -= n;
		const r = [];
		return t > 0 && r.push(CU_DIGIT.get(t)), 10 === n ? (e > 0 && r.push(CU_DIGIT.get(e)), r.push(CU_DIGIT.get(n))) : (n > 0 && r.push(CU_DIGIT.get(n)), e > 0 && r.push(CU_DIGIT.get(e))), r.join("")
	}

	function _format_thousand_groups(e) {
		if (e < 0) throw new Error("Bad input: " + e);
		const t = [];
		for (; e > 0;) t.push(_format_small_number(e % 1e3)), e = Math.floor(e / 1e3);
		return t.reverse()
	}

	function _insert_thousand_before_each_digit(e) {
		return [...e].join(CU_THOUSAND)
	}

	function _place_titlo(e) {
		if (0 === e.length) return e;
		if (e.length > 1)
			if (e[e.length - 2] !== CU_THOUSAND) {
				if (e[e.length - 2] !== CU_800) return e.slice(0, e.length - 1) + CU_TITLO + e[e.length - 1]
			} else if (e.length > 2 && e[e.length - 3] !== CU_THOUSAND && e[e.length - 3] !== CU_800) return e.slice(0, e.length - 2) + CU_TITLO + e.slice(e.length - 2);
		return e + CU_TITLO
	}
	...
	function create_each_block(e) {
		...
		return {
			c() {
				t = element("span"), n = text(r)
			},
			m(e, r) {
				insert(e, t, r), append(t, n)
			},
			p(e, t) {
				16 & t && r !== (r = e[23] + "") && set_data(n, r)
			},
			d(e) {
				e && detach(t)
			}
	...
	function create_else_block(e) {
		...
		return {
			c() {
				t = element("textarea"), attr(t, "placeholder", e[6]), attr(t, "spellcheck", "false"), attr(t, "class", "svelte-1nithne")
			},
			m(o, i) {
				insert(o, t, i), set_input_value(t, e[0]), n || (r = listen(t, "input", e[13]), n = !0)
			},
			p(e, n) {
				1 & n && set_input_value(t, e[0])
			},
			d(e) {
				e && detach(t), n = !1, r()
			}
	...
	function create_if_block(e) {
		...
		return {
			c() {
				t = element("div"), t.textContent = "Подождите, идёт загрузка...", n = space(), r = element("div"), r.innerHTML = '<div class="circle svelte-1nithne" style="animation: 2.1s ease-in-out 1s infinite normal none running none;"></div> \n                <div class="circle svelte-1nithne" style="animation: 2.1s ease-in-out 0s infinite normal none running none;"></div>', attr(t, "class", "center svelte-1nithne"), attr(r, "class", "wrapper svelte-1nithne"), set_style(r, "--size", "60px"), set_style(r, "--color", "#FF3E00")
			},
			m(e, o) {
				insert(e, t, o), insert(e, n, o), insert(e, r, o)
			},
			p: noop,
			d(e) {
				e && detach(t), e && detach(n), e && detach(r)
			}
		}
	}

	function create_fragment(e) {
		let t, n, r, o, i, a, s, u, c, l, f, p, d, h, g, b, y, m, v, _, w, x, T, S = e[4],
			O = [];
		for (let t = 0; t < S.length; t += 1) O[t] = create_each_block(get_each_context(e, S, t));

		function A(e, t) {
			return void 0 === e[3] ? create_if_block : create_else_block
		}
		let E = A(e),
			I = E(e);
		return {
			c() {
				t = element("main"), n = element("div"), r = element("h1"), r.textContent = "Переводилка", o = space(), i = element("h2"), i.textContent = "(из гражданской в церковнославянскую орфографию)", a = space(), s = element("div"), u = text("Регистр:\n            "), c = element("input"), l = text(" тот же\n            "), f = element("input"), p = text(" нижний\n            "), d = element("input"), h = text(" верхний\n            "), g = element("input"), b = text(" цифирь\n            "), y = element("a"), y.textContent = "github.com/slavonic/translator", m = space(), v = element("div");
				for (let e = 0; e < O.length; e += 1) O[e].c();
				_ = space(), w = element("div"), I.c(), attr(r, "class", "svelte-1nithne"), attr(i, "class", "svelte-1nithne"), attr(c, "type", "radio"), c.__value = "match", c.value = c.__value, attr(c, "class", "svelte-1nithne"), e[8][0].push(c), attr(f, "type", "radio"), f.__value = "lower", f.value = f.__value, attr(f, "class", "svelte-1nithne"), e[8][0].push(f), attr(d, "type", "radio"), d.__value = "upper", d.value = d.__value, attr(d, "class", "svelte-1nithne"), e[8][0].push(d), attr(g, "type", "checkbox"), attr(g, "class", "svelte-1nithne"), attr(y, "class", "src svelte-1nithne"), attr(y, "href", "https://github.com/slavonic/translator"), attr(s, "class", "notes svelte-1nithne"), attr(v, "class", "slavonic border svelte-1nithne"), attr(t, "class", "svelte-1nithne")
			},
			m(S, A) {
				insert(S, t, A), append(t, n), append(n, r), append(n, o), append(n, i), append(n, a), append(n, s), append(s, u), append(s, c), c.checked = c.__value === e[1], append(s, l), append(s, f), f.checked = f.__value === e[1], append(s, p), append(s, d), d.checked = d.__value === e[1], append(s, h), append(s, g), g.checked = e[2], append(s, b), append(s, y), append(t, m), append(t, v);
				for (let e = 0; e < O.length; e += 1) O[e].m(v, null);
				e[12](v), append(t, _), append(t, w), I.m(w, null), x || (T = [listen(c, "change", e[7]), listen(f, "change", e[9]), listen(d, "change", e[10]), listen(g, "change", e[11])], x = !0)
			},
			p(e, [t]) {
				if (2 & t && (c.checked = c.__value === e[1]), 2 & t && (f.checked = f.__value === e[1]), 2 & t && (d.checked = d.__value === e[1]), 4 & t && (g.checked = e[2]), 16 & t) {
					let n;
					for (S = e[4], n = 0; n < S.length; n += 1) {
						const r = get_each_context(e, S, n);
						O[n] ? O[n].p(r, t) : (O[n] = create_each_block(r), O[n].c(), O[n].m(v, null))
					}
					for (; n < O.length; n += 1) O[n].d(1);
					O.length = S.length
				}
				E === (E = A(e)) && I ? I.p(e, t) : (I.d(1), I = E(e), I && (I.c(), I.m(w, null)))
			},
			i: noop,
			o: noop,
			d(n) {
				n && detach(t), e[8][0].splice(e[8][0].indexOf(c), 1), e[8][0].splice(e[8][0].indexOf(f), 1), e[8][0].splice(e[8][0].indexOf(d), 1), destroy_each(O, n), e[12](null), I.d(), x = !1, run_all(T)
			}
		}
	}
	...
	function maybeRestoreCaps(e, t) {
		return e.toLowerCase() === e ? t : e.toUpperCase() == e ? t.toUpperCase() : e[0].toUpperCase() == e[0] && e.slice(1).toLowerCase() == e.slice(1) ? t[0].toUpperCase() + t.slice(1) : (console.log("Donno..", e, t), t)
	}
	...
	function instance(e, t, n) {
		...
		let o;
		onMount((async () => {
			n(3, o = await Predictor.load("build/model.onnx", "build/vocab.json", 0, "build/cu-words-civic-dedup.txt", r)), console.log("Predictor loaded!")
		}));
		let i, a = [];
		const s = {};
		const u = new RegExp(`(${RU_TEXT})`, "i"),
			c = new RegExp(`^${RU_TEXT}$`, "i");

		function l(e, t) {
			if (e = (e = (e = (e = (e = e.replace(/\/\//g, " *")).replace(/\//g, " *")).replace(/;/g, ".")).replace(/\?/g, ";")).replace(/\s+/g, " "), !t) return e;
			return e.split(NUM_SPLITTER).map((e => /^\d+$/.test(e) ? cu_format_int(+e) : e)).join("")
		}
		const f = new Debounce((async function(e, t, r) {
			await tick();
			const f = e.split(u);
			n(4, a.length = 0, a), n(4, a);
			for (const e of f) {
				const u = e.toLowerCase();
				let f;
				c.test(e) ? void 0 !== s[u] ? f = s[u] : (await sleep(0), f = await o.predict(u), s[u] = f) : f = l(e, r), "match" === t ? f = maybeRestoreCaps(e, f) : "lower" === t ? f = f.toLowerCase() : "upper" === t && (f = f.toUpperCase()), a.push(f), n(4, a), n(5, i.scrollTop = i.scrollHeight, i)
			}
		}));
		let p = "",
			d = "match",
